package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      public static var var_363:int = 3;
      
      private static var var_1697:int = 2;
      ...
      private var var_2199:TriggerConfs;
      
      private var var_2198:ActionTypes;
      
      private var var_2200:ConditionTypes;
      
      private var var_312:Dictionary;
      
      private var var_37:Triggerable;
      
      private var var_922:RoomObjectHightLighter;
      
      private var var_202:UserDefinedRoomEventsHelp;
      
      private var var_1395:SliderWindowController;
      
      public function UserDefinedRoomEventsCtrl(param1:HabboUserDefinedRoomEvents)
      {
         this.var_2199 = new TriggerConfs();
         this.var_2198 = new ActionTypes();
         this.var_2200 = new ConditionTypes();
         this.var_312 = new Dictionary();
         super();
         this.var_95 = param1;
         this.var_922 = new RoomObjectHightLighter(param1);
      ...
      public function stuffSelected(param1:int, param2:String) : void
      {
         ...
         if(this.var_312[param1])
         {
            ...
            this.var_922.hide(param1);
         }
         else if(this.getStuffIds().length < this.var_37.furniLimit)
         {
            this.var_312[param1] = param2;
            this.var_922.show(param1);
         }
         this.refresh();
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1395 = new SliderWindowController(this.var_95,IWindowContainer(this.find(this.var_56,"delay_slider_container")),this.var_95.assets,0,20,1);
         this.var_1395.addEventListener(Event.CHANGE,this.onDelaySliderChange);
         this.var_1395.setValue(0);
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_922.hideAll(this.var_312);
         }
      }
      ...
      private function prepareStuffSelectionForUpdate() : void
      {
         ...
         if(this.var_37.stuffTypeSelectionEnabled)
         {
            ...
            else if(_loc2_.requiresFurni == var_363)
            {
      ...
      public function getActionDelay() : int
      {
         ...
         return !!_loc1_.allowDelaying ? int(this.var_1395.getValue()) : 0;
      }
      ...
      private function onDecStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_37.stuffTypeSelectionCode = this.var_37.stuffTypeSelectionCode < 1 ? int(var_1697) : int(this.var_37.stuffTypeSelectionCode - 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function onIncStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_37.stuffTypeSelectionCode = (this.var_37.stuffTypeSelectionCode + 1) % (var_1697 + 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function resolveStuffSelectionType() : int
      {
         ...
         if(_loc1_.requiresFurni == var_363)
         {
      ...
      private function refresh() : void
      {
         ...
         this.refreshConfigureElement(this.var_2199);
         this.refreshConfigureElement(this.var_2198);
         this.refreshConfigureElement(this.var_2200);
