package com.sulake.habbo.roomevents.userdefinedroomevents.conditions
{
   ...
   public class UserCountIn implements ConditionType
   {
      ...
      private var var_1292:SliderWindowController;
      ...
      {
         return ConditionCodes.var_2227;
      }
      ...
      public function readIntParamsFromForm(param1:IWindowContainer) : Array
      {
         ...
         _loc2_.push(this.var_1292.getValue());
      ...
      {
         this.var_95 = param2;
         this.var_1292 = new SliderWindowController(param2,this.getMinInput(param1),param2.assets,1,50,1);
         this.var_1292.addEventListener(Event.CHANGE,this.onMinSliderChange);
         this.var_1292.setValue(1);
         this.var_1291 = new SliderWindowController(param2,this.getMaxInput(param1),param2.assets,1,50,1);
         this.var_1291.addEventListener(Event.CHANGE,this.onMaxSliderChange);
         this.var_1291.setValue(50);
      }
