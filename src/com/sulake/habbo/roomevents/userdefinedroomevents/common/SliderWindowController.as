package com.sulake.habbo.roomevents.userdefinedroomevents.common
{
   ...
   public class SliderWindowController extends EventDispatcher
   {
      ...
      public function setValue(param1:Number, param2:Boolean = true) : void
      {
         ...
         param1 = Math.min(this.var_1334,param1);
      ...
      private function sliderProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_1087)
         {
            if(param1.type == WindowMouseEvent.const_54 || param1.type == WindowMouseEvent.const_303)
            {
               this.var_1087 = false;
            }
         }
         if(!this.var_1087 || param1.type != WindowEvent.const_417)
         {
            return;
         }
         if(this.var_716 != 0)
      ...
      private function sliderButtonRightProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            if(this.var_716 != 0)
            {
               _loc3_ = this.var_1086 + this.var_716;
      ...
      private function displaySlider() : void
      {
         ...
         if(_loc2_ != null && this.var_851 != null)
         {
            _loc2_.bitmap = new BitmapData(this.var_851.width,this.var_851.height,true,16777215);
            _loc2_.bitmap.copyPixels(this.var_851,this.var_851.rect,new Point(0,0),null,null,true);
         }
         _loc1_ = this._sliderContainer.findChildByName("slider_movement_area") as IWindowContainer;
         if(_loc1_ != null)
         {
            _loc2_ = _loc1_.findChildByName("slider_button") as IBitmapWrapperWindow;
            if(_loc2_ != null && this.var_850 != null)
            {
               _loc2_.bitmap = new BitmapData(this.var_850.width,this.var_850.height,true,16777215);
               _loc2_.bitmap.copyPixels(this.var_850,this.var_850.rect,new Point(0,0),null,null,true);
               _loc2_.procedure = this.sliderProcedure;
               this.var_2036 = _loc1_.width - _loc2_.width;
            }
         }
