package com.sulake.habbo.roomevents.userdefinedroomevents.help
{
   ...
   public class UserDefinedRoomEventsHelp
   {
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1933 = IWindowContainer(this.find(this._window,"help_container"));
         this.var_1265 = this.var_1933.findChildByName("button_previous") as IContainerButtonWindow;
         if(this.var_1265)
         {
            this.var_1265.procedure = this.onButtonClick;
         }
         this.var_1266 = this.var_1933.findChildByName("button_next") as IContainerButtonWindow;
         if(this.var_1266)
         {
            this.var_1266.procedure = this.onButtonClick;
         }
      ...
      private function checkButtons() : void
      {
         ...
         {
            this.var_1266.enable();
         }
         if(this.var_284 <= 0)
         {
            this.var_1265.disable();
         }
         else
         {
            this.var_1265.enable();
         }
      }
