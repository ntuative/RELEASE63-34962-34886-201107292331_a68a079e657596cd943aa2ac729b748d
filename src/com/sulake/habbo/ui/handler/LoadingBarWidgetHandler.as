package com.sulake.habbo.ui.handler
{
   ...
   public class LoadingBarWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function getProcessedEvents() : Array
      {
         ...
         _loc1_.push(InterstitialEvent.const_604);
         _loc1_.push(RoomWidgetLoadingBarUpdateEvent.const_108);
         _loc1_.push(RoomWidgetLoadingBarUpdateEvent.const_331);
         return _loc1_;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case InterstitialEvent.const_649:
               ...
               break;
            case InterstitialEvent.const_604:
            ...
            case RoomWidgetLoadingBarUpdateEvent.const_108:
               ...
               break;
            case RoomWidgetLoadingBarUpdateEvent.const_331:
               this._container.events.dispatchEvent(param1);
         }
      }
