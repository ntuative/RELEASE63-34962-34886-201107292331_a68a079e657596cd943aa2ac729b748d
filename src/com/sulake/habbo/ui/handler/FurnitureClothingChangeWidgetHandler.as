package com.sulake.habbo.ui.handler
{
   ...
   public class FurnitureClothingChangeWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver
   {
      ...
      private static const const_1448:String = "hd-99999-99999.lg-270-62";
      
      private static const const_1449:String = "hd-99999-99999.ch-630-62.lg-695-62";
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_937,RoomWidgetClothingChangeMessage.const_1003,RoomWidgetAvatarEditorMessage.const_661];
      }
            ...
            case RoomWidgetFurniToWidgetMessage.const_937:
               ...
               if(_loc2_ != null)
               {
                  ...
                  if(_loc3_ != null)
                  {
                     ...
                     if(_loc7_)
                     {
                        _loc4_ = new RoomWidgetClothingChangeUpdateEvent(RoomWidgetClothingChangeUpdateEvent.const_461,_loc5_.id,_loc5_.category,_loc5_.roomId,_loc5_.roomCategory);
                        this._container.events.dispatchEvent(_loc4_);
                     }
                  }
               }
               break;
            case RoomWidgetClothingChangeMessage.const_1003:
               ...
               if(_loc2_ != null)
               {
                  ...
                  if(_loc3_ != null)
                  {
                     ...
                     _loc8_ = "null";
                     _loc9_ = _loc3_.getString(RoomObjectVariableEnum.const_1287);
                     ...
                     {
                        _loc8_ = "null";
                        _loc9_ = _loc3_.getString(RoomObjectVariableEnum.const_1335);
                        if(_loc9_ == null || _loc9_ == "")
                        {
                           _loc9_ = const_1449;
                        }
                     }
                     if(this._container.avatarEditor.openEditor(AvatarEditorInstanceId.const_450,this,[AvatarEditorFigureCategory.const_313,AvatarEditorFigureCategory.const_873],false,"${widget.furni.clothingchange.editor.title}"))
                     {
                        this._container.avatarEditor.loadAvatarInEditor(AvatarEditorInstanceId.const_450,_loc9_,_loc8_,HabboClubLevelEnum.const_52);
                        _loc4_ = new RoomWidgetClothingChangeUpdateEvent(RoomWidgetClothingChangeUpdateEvent.const_461,_loc6_.objectId,_loc6_.objectCategory,_loc6_.roomId,_loc6_.roomCategory);
                        this._container.events.dispatchEvent(_loc4_);
                     }
                  }
               }
