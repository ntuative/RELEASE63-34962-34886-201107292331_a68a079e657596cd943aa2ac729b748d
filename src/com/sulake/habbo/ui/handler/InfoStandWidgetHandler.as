   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function InfoStandWidgetHandler(param1:IHabboMusicController)
      {
         ...
         if(this.var_244 != null)
         {
            ...
            this.var_244.events.addEventListener(SongInfoReceivedEvent.const_97,this.onSongInfoReceivedEvent);
         }
      }
      ...
      {
         return RoomWidgetEnum.const_655;
      }
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            if(this._container.sessionDataManager != null)
            {
               ...
               this._container.sessionDataManager.events.removeEventListener(BadgeImageReadyEvent.const_216,this.onBadgeImage);
            }
            if(this._container.roomSessionManager != null)
            {
               this._container.roomSessionManager.events.removeEventListener(RoomSessionUserFigureUpdateEvent.const_180,this.onFigureUpdate);
         ...
         if(this._container.sessionDataManager != null)
         {
            ...
            this._container.sessionDataManager.events.addEventListener(BadgeImageReadyEvent.const_216,this.onBadgeImage);
         }
         if(this._container.roomSessionManager != null)
         {
            this._container.roomSessionManager.events.addEventListener(RoomSessionUserFigureUpdateEvent.const_180,this.onFigureUpdate);
      ...
      public function dispose() : void
      {
         ...
         if(this.var_244 != null)
         {
            ...
            this.var_244.events.removeEventListener(SongInfoReceivedEvent.const_97,this.onSongInfoReceivedEvent);
            this.var_244 = null;
         }
         this.var_1157 = true;
         this.container = null;
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomObjectMessage.const_631);
         _loc1_.push(RoomWidgetRoomObjectMessage.const_742);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_420);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_856);
         _loc1_.push(RoomWidgetFurniActionMessage.const_297);
         _loc1_.push(RoomWidgetFurniActionMessage.const_968);
         _loc1_.push(RoomWidgetFurniActionMessage.const_877);
         _loc1_.push(RoomWidgetFurniActionMessage.const_995);
         _loc1_.push(RoomWidgetFurniActionMessage.const_1387);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_1032);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_956);
         _loc1_.push(RoomWidgetGetBadgeImageMessage.const_747);
         _loc1_.push(RoomWidgetUserActionMessage.const_504);
         _loc1_.push(RoomWidgetUserActionMessage.const_590);
         _loc1_.push(RoomWidgetUserActionMessage.const_608);
         _loc1_.push(RoomWidgetUserActionMessage.const_1977);
         _loc1_.push(RoomWidgetPetCommandMessage.const_652);
         _loc1_.push(RoomWidgetPetCommandMessage.const_862);
         _loc1_.push(RoomWidgetUserActionMessage.const_657);
         _loc1_.push(RoomWidgetUserActionMessage.const_264);
         _loc1_.push(RoomWidgetChangeMottoMessage.const_844);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            else if(param1.type == RoomWidgetUserActionMessage.const_264 || param1.type == RoomWidgetUserActionMessage.const_657 || param1.type == RoomWidgetUserActionMessage.const_608)
            {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectMessage.const_631:
               return this.handleGetObjectInfoMessage(param1 as RoomWidgetRoomObjectMessage);
            case RoomWidgetRoomObjectMessage.const_742:
            ...
            case RoomWidgetUserActionMessage.const_573:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_1355,_loc3_.name);
            ...
            case RoomWidgetUserActionMessage.const_628:
               ...
               break;
            case RoomWidgetUserActionMessage.const_420:
            ...
            case RoomWidgetUserActionMessage.const_493:
               ...
               break;
            case RoomWidgetUserActionMessage.const_856:
            ...
            case RoomWidgetFurniActionMessage.const_1387:
               ...
               break;
            case RoomWidgetUserActionMessage.const_264:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_1032:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_956:
               ...
               break;
            case RoomWidgetGetBadgeImageMessage.const_747:
            ...
            case RoomWidgetUserActionMessage.const_504:
               ...
               break;
            case RoomWidgetUserActionMessage.const_590:
      ...
      private function handleGetObjectNameMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               {
                  _loc11_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_275);
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_372);
               _loc6_.id = param1.id;
               _loc6_.category = param1.category;
               _loc7_ = this._container.roomEngine.getRoomObject(_loc2_,_loc3_,param1.id,param1.category);
               _loc8_ = _loc7_.getModel();
               if(_loc8_.getString(RoomWidgetInfostandExtraParamEnum.const_436) != null)
               {
                  _loc6_.extraParam = _loc8_.getString(RoomWidgetInfostandExtraParamEnum.const_436);
               }
               else if(_loc8_.getNumber(RoomObjectVariableEnum.const_938) == 1)
               {
                  _loc6_.extraParam = RoomWidgetInfostandExtraParamEnum.const_1217;
               }
               ...
               {
                  _loc24_ = _loc8_.getNumber(RoomObjectVariableEnum.const_275);
                  if(param1.category == RoomObjectCategoryEnum.const_27)
                  {
               ...
               _loc10_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1396);
               _loc11_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1190);
               ...
               if(_loc6_.extraParam != null && _loc6_.extraParam.length > 0)
               {
                  ...
                  _loc28_ = "";
                  _loc29_ = "";
                  if(_loc6_.extraParam == RoomWidgetInfostandExtraParamEnum.const_533)
                  {
                  ...
                  else if(_loc6_.extraParam.indexOf(RoomWidgetInfostandExtraParamEnum.const_427) == 0)
                  {
                     _loc31_ = _loc6_.extraParam.substr(RoomWidgetInfostandExtraParamEnum.const_427.length);
            ...
            case RoomObjectCategoryEnum.OBJECT_CATEGORY_USER:
               ...
               if(_loc12_.type == RoomObjectTypeEnum.const_206)
               {
                  this._container.roomSession.userDataManager.requestPetInfo(_loc12_.webID);
                  return null;
               }
               if(_loc12_.type == RoomObjectTypeEnum.const_134)
               {
                  _loc13_ = "null";
               ...
               {
                  if(_loc12_.type != RoomObjectTypeEnum.const_676)
                  {
                     return null;
                  }
                  _loc13_ = "null";
               ...
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.const_163)
               {
                  ...
                  if(_loc17_ != null)
                  {
                     _loc38_ = _loc17_.getModel().getString(RoomObjectVariableEnum.const_739);
                  ...
                  if(!_loc34_)
                  {
                     _loc14_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1027;
                  }
                  if(!_loc35_)
                  {
                     _loc14_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1031;
                  }
               ...
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc15_.push(RoomWidgetUserInfoUpdateEvent.const_1890);
               }
               else
               {
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         if(this._container != null && this._container.events != null)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_739);
