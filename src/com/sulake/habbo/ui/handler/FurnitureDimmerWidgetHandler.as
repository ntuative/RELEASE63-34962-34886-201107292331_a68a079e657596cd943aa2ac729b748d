package com.sulake.habbo.ui.handler
{
   ...
   public class FurnitureDimmerWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_958,RoomWidgetDimmerSavePresetMessage.const_935,RoomWidgetDimmerChangeStateMessage.const_922,RoomWidgetDimmerPreviewMessage.const_806];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_958:
            ...
            case RoomWidgetDimmerSavePresetMessage.const_935:
               ...
               break;
            case RoomWidgetDimmerChangeStateMessage.const_922:
               if(this.validateRights())
               {
                  this._container.roomSession.sendRoomDimmerChangeStateMessage();
               }
               break;
            case RoomWidgetDimmerPreviewMessage.const_806:
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomSessionDimmerPresetsEvent.const_529);
         _loc1_.push(RoomEngineDimmerStateEvent.const_67);
         _loc1_.push(RoomEngineObjectEvent.const_116);
         return _loc1_;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionDimmerPresetsEvent.const_529:
               _loc2_ = param1 as RoomSessionDimmerPresetsEvent;
               _loc3_ = new RoomWidgetDimmerUpdateEvent(RoomWidgetDimmerUpdateEvent.const_830);
            ...
            case RoomEngineObjectEvent.const_116:
               this._container.events.dispatchEvent(new RoomWidgetDimmerUpdateEvent(RoomWidgetDimmerUpdateEvent.const_999));
         }
      }
