package com.sulake.habbo.ui.handler
{
   ...
   public class PlayListEditorWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private var var_1543:IMessageEvent;
      
      private var var_1927:IMessageEvent;
      
      private var var_1928:IMessageEvent;
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         ...
         if(this._container.soundManager)
         {
            ...
            this._container.soundManager.events.addEventListener(NowPlayingEvent.const_139,this.processSoundManagerEvent);
         }
      }
      
      public function set connection(param1:IConnection) : void
      {
         this.var_1543 = new FurniListUpdateEvent(this.onFurniListUpdated);
         this.var_1927 = new FurniListRemoveEvent(this.onFurniListUpdated);
         this.var_1928 = new FurniListInsertEvent(this.onFurniListUpdated);
         this._connection = param1;
         this._connection.addMessageEvent(this.var_1543);
         this._connection.addMessageEvent(this.var_1927);
         this._connection.addMessageEvent(this.var_1928);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._connection)
            {
               this._connection.removeMessageEvent(this.var_1543);
               this._connection.removeMessageEvent(this.var_1927);
               this._connection.removeMessageEvent(this.var_1928);
            }
            ...
            if(this._container)
            {
               if(this._container.soundManager)
               {
                  if(this._container.soundManager.events)
                  {
                     ...
                     this._container.soundManager.events.removeEventListener(NowPlayingEvent.const_139,this.processSoundManagerEvent);
                  }
               }
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_1018,RoomWidgetPlayListModificationMessage.const_879,RoomWidgetPlayListModificationMessage.const_997,RoomWidgetPlayListPlayStateMessage.const_855,RoomWidgetPlayListUserActionMessage.const_1006];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_1018:
               ...
               break;
            case RoomWidgetPlayListModificationMessage.const_879:
               ...
               break;
            case RoomWidgetPlayListModificationMessage.const_997:
               ...
               break;
            case RoomWidgetPlayListPlayStateMessage.const_855:
               ...
               break;
            case RoomWidgetPlayListUserActionMessage.const_1006:
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineSoundMachineEvent.const_258:
               ...
               _loc3_ = new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_924,_loc2_.objectId);
      ...
      private function onFurniListUpdated(param1:IMessageEvent) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.events.dispatchEvent(new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_1016,-1));
            }
         }
      }
      ...
      private function processSoundManagerEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case SongDiskInventoryReceivedEvent.SONG_DISK_INVENTORY_RECEIVED:
               this._container.events.dispatchEvent(new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_925));
               break;
            ...
            case NowPlayingEvent.const_129:
               ...
               break;
            case NowPlayingEvent.const_139:
               _loc2_ = param1 as NowPlayingEvent;
               this._container.events.dispatchEvent(new RoomWidgetPlayListEditorNowPlayingEvent(RoomWidgetPlayListEditorNowPlayingEvent.const_139,_loc2_.id,_loc2_.position,_loc2_.priority));
         }
      }
   }
}
