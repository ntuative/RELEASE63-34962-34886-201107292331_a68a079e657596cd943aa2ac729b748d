package com.sulake.habbo.ui.widget
{
   ...
   public class RoomWidgetFactory extends Component implements IRoomWidgetFactory
   {
      ...
      private var var_3085:IAssetLibrary;
      ...
      public function RoomWidgetFactory(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_3085 = param1.root.assets;
      ...
      public function createWidget(param1:String, param2:IRoomWidgetHandler) : IRoomWidget
      {
         ...
         switch(param1)
         {
            case RoomWidgetEnum.const_408:
               _loc3_ = new RoomChatWidget(param2,this._windowManager,assets,this.var_73,this.var_161,this.var_2359++,this);
               break;
            case RoomWidgetEnum.const_383:
               _loc3_ = new RoomChatInputWidget(param2,this._windowManager,assets,this.var_73,this.var_161,this);
               break;
            case RoomWidgetEnum.const_655:
               _loc3_ = new InfostandWidget(param2,this._windowManager,assets,this.var_73,this.var_161,this._catalog);
               break;
            case RoomWidgetEnum.const_646:
               _loc3_ = new MeMenuWidget(param2,this._windowManager,assets,this.var_73,events,this.var_161);
               break;
            ...
            case RoomWidgetEnum.const_572:
               _loc3_ = new TeaserFurniWidget(param2,this._windowManager,assets,this.var_73,this.var_161,this.var_12);
               break;
            ...
            case RoomWidgetEnum.const_602:
               _loc3_ = new LoadingBarWidget(param2,this._windowManager,assets,this.var_73,this.var_161);
               break;
            case RoomWidgetEnum.const_542:
               _loc3_ = new RoomQueueWidget(param2,this._windowManager,assets,this.var_73,this.var_161);
               break;
            case RoomWidgetEnum.const_132:
               _loc3_ = new VoteWidget(param2,this._windowManager,assets,this.var_73,this.var_161);
               break;
            ...
            case RoomWidgetEnum.const_124:
               _loc3_ = new AvatarInfoWidget(param2,this._windowManager,assets,this.var_161,this.var_73,this);
               break;
            ...
            case RoomWidgetEnum.const_633:
               _loc3_ = new PlayListEditorWidget(param2,this._windowManager,this._soundManager,assets,this.var_73,this.var_161,this._catalog);
               break;
