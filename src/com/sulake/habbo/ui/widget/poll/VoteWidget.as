package com.sulake.habbo.ui.widget.poll
{
   ...
   public class VoteWidget extends RoomWidgetBase
   {
      ...
      private var var_1525:int = 30000;
      ...
      public function VoteWidget(param1:IRoomWidgetHandler, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IHabboConfigurationManager)
      {
         ...
         {
            this.var_1525 = int(this._config.getKey("vote.time.limit","30000"));
         }
      }
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_190.reset();
            this.var_190.removeEventListener(TimerEvent.TIMER,this.updateEvent);
            this.var_190 = null;
         }
         this._config = null;
         super.dispose();
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetVoteUpdateEvent.const_167,this.showVoteResult);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetVoteUpdateEvent.const_167,this.showVoteResult);
      }
      ...
      private function showVoteQuestion(param1:RoomWidgetVoteUpdateEvent) : void
      {
         ...
         {
            _loc6_ = this.method_5(_loc7_,_loc5_[_loc7_]);
            if(_loc6_ == null)
            {
               return;
            }
         ...
         if(this.var_190 == null)
         {
            ...
            this.var_190.addEventListener(TimerEvent.TIMER,this.updateEvent);
         }
         this.var_1894 = getTimer();
         this.var_190.reset();
         this.var_190.start();
      ...
      private function method_5(param1:int, param2:String) : IWindow
      {
      ...
      private function updateTimerView() : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc6_ = Math.max((this.var_1525 - _loc1_) / 1000,0);
      ...
      {
         var _loc2_:int = getTimer() - this.var_1894;
         if(_loc2_ > this.var_1525)
         {
            this.vote();
            return;
         }
