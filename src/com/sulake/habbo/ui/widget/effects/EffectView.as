package com.sulake.habbo.ui.widget.effects
{
   ...
   public class EffectView
   {
      ...
      private const const_2373:int = 1000;
      
      private var _widget:EffectsWidget;
      
      private var _window:IWindowContainer;
      
      private var var_113:IWidgetAvatarEffect;
      
      private var var_668:IWindow;
      
      private var var_327:Number;
      
      private var var_391:ITextWindow;
      
      private var var_223:Timer;
      
      private var var_667:IWindow;
      ...
      public function EffectView(param1:EffectsWidget, param2:IWidgetAvatarEffect)
      {
         ...
         this.var_113 = param2;
         this._widget = param1;
         this.var_223 = new Timer(this.const_2373);
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         if(this.var_113.isActive)
         {
            _loc2_ = this.var_113.secondsLeft / Number(this.var_113.duration);
            this.var_668.width = _loc2_ * this.var_327;
         }
         else
         {
            this.var_668.width = 0;
            this.var_223.stop();
         }
         this.setTimeLeft();
      }
      ...
      private function setTimeLeft() : void
      {
         ...
         {
            this.var_391 = this._window.findChildByName("time_left") as ITextWindow;
            if(this.var_391 == null)
            {
               return;
            }
         ...
         if(!this.var_113.isActive)
         {
            this.var_391.caption = "${widgets.memenu.effects.activate}";
            return;
         }
         if(this.var_113.secondsLeft > 86400)
         {
            this.var_391.caption = "${widgets.memenu.effects.active.daysleft}";
            _loc1_ = this.var_391.text;
            _loc2_ = Math.floor(this.var_113.secondsLeft / 86400);
            _loc1_ = _loc1_.replace("%days_left%",_loc2_);
         }
         else
         {
            this.var_391.caption = "${widgets.memenu.effects.active.timeleft}";
            _loc1_ = this.var_391.text;
            _loc3_ = this.var_113.secondsLeft;
      ...
      public function update() : void
      {
         ...
         if(!this._window)
         {
            this._window = this._widget.windowManager.createWindow("","",HabboWindowType.const_72,HabboWindowStyle.const_29,HabboWindowParam.const_64) as IWindowContainer;
         }
         ...
         this.var_391 = null;
         var _loc2_:String = "";
         if(this.var_113.isInUse)
         {
            _loc2_ = "memenu_effect_selected";
         }
         else if(this.var_113.isActive)
         {
         ...
         else
         {
            ...
            this.var_667 = this._window.findChildByName("effect_hilite");
            this.var_667.visible = false;
         }
         this.setTimeLeft();
         this.var_668 = this._window.findChildByName("loader_bar");
         if(this.var_668 != null)
         {
            this.var_327 = this.var_668.width;
            this.var_223.start();
            this.onUpdate();
         }
         if(this.var_113.icon)
         {
            this.setElementBitmap("effect_icon",this.var_113.icon);
         }
      ...
      private function onMouseEvent(param1:WindowMouseEvent) : void
      {
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK:
               this._widget.selectEffect(this.var_113.type,this.var_113.isInUse);
         }
      }
