package com.sulake.habbo.ui.widget.furniture.welcomegift
{
   ...
   public class WelcomeGiftWidget extends RoomWidgetBase
   {
      ...
      private const const_693:String = "welcome_gift_email_unverified";
      
      private const const_1083:String = "welcome_gift_email_verified";
      
      private const const_1530:String = "welcome_gift_email_change";
      
      private const const_2372:int = 4;
      ...
      private function createMainView() : void
      {
         ...
         if(this.var_1248)
         {
            this.setViewState(this.const_1083);
         }
         else
         {
            this.setViewState(this.const_693);
         }
      }
      ...
      private function setViewState(param1:String) : void
      {
         ...
         switch(param1)
         {
            case this.const_693:
               ...
               this._view.findChildByName("edit_text").visible = this.var_1021;
               this._view.findChildByName("edit").setParamFlag(WindowParam.const_30,this.var_1021);
               break;
            case this.const_1083:
            ...
            case this.const_1530:
               ...
               this.setBitmap("email_icon","email_icon");
               this.setButtonState("save_email",this.var_1021);
               _loc6_ = this._view.findChildByName("email_input") as ITextFieldWindow;
               _loc6_.caption = this.var_1528;
               _loc6_.focus();
      ...
      {
         this.setViewState(this.const_1530);
      }
      ...
      {
         this.setViewState(!!this.var_1248 ? this.const_1083 : this.const_693);
      }
      ...
      private function saveEmail(param1:WindowMouseEvent) : void
      {
         ...
         this.var_1529 = _loc2_.text;
         messageListener.processWidgetMessage(new RoomWidgetChangeEmailMessage(this.var_1529));
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetWelcomeGiftUpdateEvent.const_609,this.updateEventHandler);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetWelcomeGiftUpdateEvent.const_609,this.updateEventHandler);
      ...
      private function updateEventHandler(param1:RoomWidgetWelcomeGiftUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetWelcomeGiftUpdateEvent.const_609:
               this.var_1528 = param1.email;
               this.var_1248 = param1.isVerified;
               this.var_1021 = param1.allowEmailChange;
      ...
      private function emailChangeHandler(param1:RoomWidgetChangeEmailResultEvent) : void
      {
         if(param1.result == 0)
         {
            this.var_1528 = this.var_1529;
            this.setViewState(this.const_693);
         }
         else
         {
            if(param1.result == this.const_2372)
            {
               this.var_1021 = false;
            }
      ...
      private function showEmailChangeError(param1:int) : void
      {
         ...
         this.setCaption("email_input",this.var_1529);
