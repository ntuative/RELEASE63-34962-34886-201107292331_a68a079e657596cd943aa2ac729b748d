package com.sulake.habbo.ui.widget.memenu
{
   ...
   public class MeMenuWidget extends RoomWidgetBase
   {
      ...
      public static const const_607:String = "me_menu_my_clothes_view";
      
      public static const const_1343:String = "me_menu_dance_moves_view";
      
      public static const const_882:String = "me_menu_settings_view";
      
      public static const const_854:String = "me_menu_sound_settings";
      
      private static const const_1117:Point = new Point(95,440);
      ...
      public function MeMenuWidget(param1:IRoomWidgetHandler, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IEventDispatcher, param6:IHabboConfigurationManager)
      {
         ...
         if(false)
         {
            this.var_2777 = param6.getBoolean("client.news.embed.enabled",false);
         }
         this.var_2133 = this._config.getBoolean("menu.own_avatar.enabled",false);
      ...
      {
         return var_940 as MeMenuWidgetHandler;
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetDanceUpdateEvent.const_754,this.onDanceEvent);
         param1.addEventListener(RoomWidgetUpdateEffectsUpdateEvent.const_838,this.onUpdateEffects);
         param1.addEventListener(RoomWidgetToolbarClickedUpdateEvent.const_743,this.onToolbarClicked);
         param1.addEventListener(RoomWidgetAvatarEditorUpdateEvent.const_1191,this.onAvatarEditorClosed);
         param1.addEventListener(RoomWidgetAvatarEditorUpdateEvent.const_1245,this.onHideAvatarEditor);
         ...
         param1.addEventListener(RoomWidgetSettingsUpdateEvent.const_405,this.onSettingsUpdate);
         ...
         param1.addEventListener(RoomWidgetPurseUpdateEvent.const_133,this.onCreditBalance);
         param1.addEventListener(RoomWidgetRoomEngineUpdateEvent.const_98,this.onNormalMode);
         param1.addEventListener(RoomWidgetRoomEngineUpdateEvent.const_404,this.onGameMode);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetDanceUpdateEvent.const_754,this.onDanceEvent);
         param1.removeEventListener(RoomWidgetUpdateEffectsUpdateEvent.const_838,this.onUpdateEffects);
         param1.removeEventListener(RoomWidgetToolbarClickedUpdateEvent.const_743,this.onToolbarClicked);
         ...
         param1.removeEventListener(RoomWidgetAvatarEditorUpdateEvent.const_1245,this.onAvatarEditorClosed);
         param1.removeEventListener(RoomWidgetUserInfoUpdateEvent.const_115,this.onUserInfo);
         param1.removeEventListener(RoomWidgetSettingsUpdateEvent.const_405,this.onSettingsUpdate);
         ...
         param1.removeEventListener(RoomWidgetPurseUpdateEvent.const_133,this.onCreditBalance);
      ...
      private function onUserInfo(param1:RoomWidgetUserInfoUpdateEvent) : void
      {
         ...
         if(!(this.var_580 && this.var_53.window.name == const_607))
         {
            _loc2_ = new RoomWidgetRequestWidgetMessage(RoomWidgetRequestWidgetMessage.const_885);
      ...
      private function onSettingsUpdate(param1:RoomWidgetSettingsUpdateEvent) : void
      {
         ...
         if(this.var_53.window.name == const_854)
         {
      ...
      private function onTutorialEvent(param1:RoomWidgetTutorialEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetTutorialEvent.const_515:
               Logger.log("* MeMenuWidget: onHighlightClothesIcon " + this.var_580 + " view: " + this.var_53.window.name);
               if(this.var_580 != true || this.var_53.window.name != const_192)
               {
                  return;
               }
               (this.var_53 as MeMenuMainView).setIconAssets("clothes_icon",const_192,"clothes_highlighter_blue");
               break;
      ...
      private function onToolbarClicked(param1:RoomWidgetToolbarClickedUpdateEvent) : void
      {
         ...
         if(this.var_580)
         {
            _loc2_ = new RoomWidgetMeMenuMessage(RoomWidgetMeMenuMessage.const_1036);
            if(messageListener != null)
            {
               messageListener.processWidgetMessage(_loc2_);
            }
      ...
      {
         if(this.var_53 != null && this.var_53.window.name != const_607)
         {
            this.hide();
         }
      }
      ...
      private function onHabboClubEvent(param1:RoomWidgetHabboClubUpdateEvent) : void
      {
         ...
         this.var_2778 = param1.periodsLeft;
         this.var_3110 = param1.pastPeriods;
         this.var_2779 = param1.allowClubDances;
         _loc2_ = Boolean(_loc2_ || param1.clubLevel != this.var_2045);
         this.var_2045 = param1.clubLevel;
         if(_loc2_)
         {
            if(this.var_53 != null)
            {
