package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class MusicInventoryGridView
   {
      ...
      public function setPreviewIconToPause() : void
      {
         ...
         {
            this.var_114.playButtonState = MusicInventoryGridItem.const_1394;
         }
      }
      ...
      public function setPreviewIconToPlay() : void
      {
         if(this.var_114 != null)
         {
            this.var_114.playButtonState = MusicInventoryGridItem.const_656;
         }
      }
      ...
      private function gridItemEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         var _loc4_:int = 0;
         var _loc5_:* = null;
         var _loc3_:* = param1.type == WindowMouseEvent.const_179;
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK || _loc3_)
         {
            ...
            {
               if(this.var_114.playButtonState == MusicInventoryGridItem.const_656)
               {
                  this.var_114.playButtonState = MusicInventoryGridItem.const_1241;
