package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class PlayListStatusView
   {
      ...
      public static const const_842:String = "PLSV_ADD_SONGS";
      
      public static const const_1315:String = "PLSV_START_PLAYBACK";
      
      public static const const_629:String = "PLSV_NOW_PLAYING";
      ...
      {
         if(this.var_53 != const_629)
         {
            return;
         }
         var _loc2_:IWindowContainer = this.var_486[this.var_53];
      ...
      public function set addSongsBackgroundImage(param1:BitmapData) : void
      {
         ...
         var _loc2_:IWindowContainer = this.var_486[const_842];
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_486.add(const_629,_loc1_);
