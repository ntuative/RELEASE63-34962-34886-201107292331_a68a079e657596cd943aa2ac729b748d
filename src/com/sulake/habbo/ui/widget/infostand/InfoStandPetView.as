package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private static const const_1689:int = 162;
      
      private static const const_1687:int = 16;
      
      private static const const_723:int = 4;
      
      private static const const_1686:uint = 14342874;
      
      private static const const_1684:uint = 3815994;
      
      private static const const_1685:uint = 2085362;
      
      private static const const_1682:uint = 39616;
      
      private static const const_1677:uint = 10513106;
      
      private static const const_1688:uint = 8734654;
      
      private static const const_1676:uint = 9094430;
      
      private static const const_1683:uint = 6200576;
      
      private static const const_1681:String = "happiness";
      
      private static const const_1680:String = "experience";
      
      private static const const_1678:String = "energy";
      
      private static const const_1679:int = 250;
      
      private static const const_1154:int = 25;
      
      private static const const_1155:int = 5;
      ...
      {
         if(this.var_55 == null || this.var_48 == null || this.var_109 == null)
         {
            return;
         }
         ...
         this._window.width = Math.max(this.var_48.width,this.var_109.width);
         this._window.height = this._window.scrollableRegion.height;
         if(this.var_48.width < this.var_109.width)
         {
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(const_1681,param1.nutrition,param1.nutritionMax,const_1682,const_1685);
         this.updateStateElement(const_1680,param1.experience,param1.experienceMax,const_1688,const_1677);
         this.updateStateElement(const_1678,param1.energy,param1.energyMax,const_1683,const_1676);
      ...
      private function createPercentageBar(param1:int, param2:int, param3:uint, param4:uint) : BitmapData
      {
         ...
         var _loc7_:BitmapData = new BitmapData(const_1689,const_1687,false);
         _loc7_.fillRect(new Rectangle(0,0,_loc7_.width,_loc7_.height),const_1686);
         var _loc8_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,_loc7_.height - 2);
         _loc7_.fillRect(_loc8_,const_1684);
         var _loc9_:Rectangle = new Rectangle(1,1 + const_723,_loc7_.width - 2,_loc7_.height - 2 - const_723);
         _loc9_.width = _loc5_ * _loc9_.width;
         _loc7_.fillRect(_loc9_,param3);
         var _loc10_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,const_723);
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_235 && this.var_235.getPetId() == this.var_528)
               {
            ...
            case "btn_buy_food":
               if(this._catalog)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_1782,true);
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_420,this._widget.petData.ownerId);
      ...
      private function arrangeButtons() : void
      {
         ...
         for each(_loc5_ in _loc2_)
         {
            if(_loc5_.visible)
            {
               ...
               {
                  _loc3_ = _loc1_;
                  _loc4_ += const_1154 + const_1155;
               }
               _loc5_.x = _loc3_ - _loc5_.width;
               _loc5_.y = _loc4_;
               _loc3_ = _loc5_.x - const_1155;
            }
         }
         this.var_109.height = _loc4_ + const_1154;
         this.updateWindow();
      }
   }
}
