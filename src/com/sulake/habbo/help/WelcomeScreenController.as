   ...
   public class WelcomeScreenController implements IUpdateReceiver
   {
      ...
      public function dispose() : void
      {
         if(this.var_202)
         {
            ...
            this.var_202.toolbar.events.removeEventListener(HabboToolbarEvent.const_48,this.onToolbarClicked);
            this.var_202 = null;
         }
      ...
      public function showWelcomeScreen(param1:WelcomeNotification) : void
      {
         ...
         this.var_70 = param1;
         this.var_202.toolbar.events.addEventListener(HabboToolbarEvent.const_48,this.onToolbarClicked);
         ...
         this.var_230.y = this.var_202.toolbar.getIconVerticalLocation(param1.targetIconId) - this._window.height / 2;
      ...
      private function initializeWindow() : void
      {
         ...
         _loc4_.content.setParamFlag(WindowParam.const_307,false);
         _loc4_.height -= 20;
