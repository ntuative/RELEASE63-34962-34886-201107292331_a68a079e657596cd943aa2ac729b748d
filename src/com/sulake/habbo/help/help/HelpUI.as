package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager)
      {
         ...
         this._windowManager.registerLocalizationParameter("info.client.version","version",new String(201107292309));
         this.var_128 = new Map();
         this.var_128.add(HabboHelpViewEnum.const_1869,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         this.var_128.add(HabboHelpViewEnum.const_229,IHelpViewController(new HelpMainView(this,this._windowManager,this._assetLibrary)));
         this.var_128.add(HabboHelpViewEnum.const_545,IHelpViewController(new FaqBrowseTopView(this,this._windowManager,this._assetLibrary)));
         this.var_128.add(HabboHelpViewEnum.const_333,IHelpViewController(new FaqBrowseCategoryView(this,this._windowManager,this._assetLibrary)));
         this.var_128.add(HabboHelpViewEnum.const_261,IHelpViewController(new FaqBrowseEntry(this,this._windowManager,this._assetLibrary)));
         this.var_128.add(HabboHelpViewEnum.const_422,IHelpViewController(new CallForHelpTopicSelection(this,this._windowManager,this._assetLibrary)));
         this.var_128.add(HabboHelpViewEnum.const_897,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         this.var_128.add(HabboHelpViewEnum.const_246,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_thanks")));
         ...
         this.var_128.add(HabboHelpViewEnum.const_1244,IHelpViewController(new CallForHelpPendingItemView(this,this._windowManager,this._assetLibrary)));
         this.var_128.add(HabboHelpViewEnum.const_904,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         {
            if(this.var_531.length == 0 || param1 != this.var_373)
            {
               this.var_531.push(this.var_373);
            }
         }
         this.var_373 = param1;
         ...
         if(_loc3_ == null)
         {
            Logger.log("* No view controller found for " + this.var_373);
            return;
         }
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_246:
               ...
               break;
            case CallForHelpResultEnum.const_1230:
               this.showUI(HabboHelpViewEnum.const_1244);
               break;
            case CallForHelpResultEnum.const_1414:
      ...
      public function updateCallForGuideBotUI(param1:Boolean) : void
      {
         ...
         var _loc2_:IHelpViewController = this.var_128.getValue(HabboHelpViewEnum.const_229) as IHelpViewController;
      ...
      public function handleCallGuideBot() : void
      {
         ...
         this.hideUI();
         this.var_22.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_551));
      }
      ...
      {
         return this.var_128.getValue(this.var_373);
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_2431 = this._window.width - _loc3_.width;
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.height = _loc1_.height + this.var_2429;
         this._window.width = _loc1_.width + this.var_2431;
      }
      ...
      {
         var _loc3_:* = null;
         if(this.var_373 == HabboHelpViewEnum.const_229)
         {
            return;
         }
         if(this.var_629.length < 2)
         {
            _loc3_ = this._assetLibrary.getAssetByName("back_png") as BitmapDataAsset;
            this.var_629.push(_loc3_.content as BitmapData);
            _loc3_ = this._assetLibrary.getAssetByName("back_hi_png") as BitmapDataAsset;
            this.var_629.push(_loc3_.content as BitmapData);
         }
         var _loc2_:IBitmapWrapperWindow = this.var_374.findChildByName("back_image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(this.var_629[1],this.var_629[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(this.var_629[0],this.var_629[0].rect,new Point(0,0));
         }
      }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:* = null;
         if(this.var_373 == HabboHelpViewEnum.const_229 || this.var_531.length == 0)
         {
            return;
         }
         if(this.var_374 == null)
         {
            ...
            this.var_374 = this._windowManager.buildFromXML(XML(_loc2_.content)) as IWindowContainer;
            _loc3_ = this.var_374.findChildByName("back_image");
            if(_loc3_ != null)
            {
            ...
            _loc4_ = this.var_374.findChildByName("back_text");
            if(_loc4_ != null)
            {
         ...
         var _loc1_:IItemListWindow = this._window.findChildByName("content_list") as IItemListWindow;
         if(_loc1_ == null || this.var_374 == null)
         {
            return;
         }
         if(_loc1_.getListItemIndex(this.var_374 as IWindow) > -1)
         {
            return;
         }
         _loc1_.addListItem(this.var_374 as IWindow);
         this.setBackButtonActiveState(false);
      }
   }
}
