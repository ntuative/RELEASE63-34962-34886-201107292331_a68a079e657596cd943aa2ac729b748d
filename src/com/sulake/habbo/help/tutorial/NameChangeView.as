package com.sulake.habbo.help.tutorial
{
   ...
   public class NameChangeView
   {
      ...
      private function showSelectionView() : void
      {
         if(!this.var_838)
         {
            this.var_838 = this.var_27.buildXmlWindow("welcome_name_selection") as IWindowContainer;
            if(!this.var_838)
            {
               return;
            }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_839)
         {
            this.var_839 = this.var_27.buildXmlWindow("welcome_name_confirmation") as IWindowContainer;
            if(!this.var_839)
            {
               return;
            }
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            ...
            case "header_button_close":
               this.var_27.showView(TutorialUI.const_95);
         }
      }
