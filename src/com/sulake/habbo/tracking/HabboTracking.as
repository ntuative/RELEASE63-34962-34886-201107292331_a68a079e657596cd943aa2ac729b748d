package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_1092:uint = 11;
      ...
      private var var_222:IHabboFriendList;
      
      private var var_1267:IHabboWindowManager;
      ...
      private var var_474:FramerateTracker = null;
      
      private var var_286:LatencyTracker = null;
      
      private var var_673:LagWarningLogger = null;
      
      private var var_473:ToolbarClickTracker = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_474 = new FramerateTracker();
         this.var_286 = new LatencyTracker();
         this.var_673 = new LagWarningLogger();
         this.var_473 = new ToolbarClickTracker(this);
         this.var_1552 = new Array(const_1092);
         var _loc4_:int = 0;
         while(_loc4_ < const_1092)
         {
            this.var_1552[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1827,new Date().getTime().toString());
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1789,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1903,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_965,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1261,String(0));
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_1267)
            {
               this.var_1267.release(new IIDHabboWindowManager());
               this.var_1267 = null;
            }
            if(this.var_354)
            {
            ...
            if(this._navigator)
            {
               if(!this._navigator.disposed)
               {
                  ...
                  this._navigator.events.removeEventListener(HabboNavigatorEvent.const_345,this.onZoomToggle);
               }
            ...
            if(this.var_222)
            {
               if(!this.var_222.disposed)
               {
                  Component(this.var_222).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,this.onFriendlistTrackingEvent);
                  Component(this.var_222).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,this.onFriendlistTrackingEvent);
                  Component(this.var_222).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,this.onFriendlistTrackingEvent);
                  Component(this.var_222).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,this.onFriendlistTrackingEvent);
                  Component(this.var_222).events.removeEventListener(HabboFriendListTrackingEvent.const_612,this.onFriendlistTrackingEvent);
               }
               this.var_222.release(new IIDHabboFriendList());
               this.var_222 = null;
            }
            if(this.var_202)
            {
            ...
            if(this._roomEngine)
            {
               if(!this._roomEngine.disposed)
               {
                  ...
                  this._roomEngine.events.removeEventListener(RoomEngineEvent.const_371,this.onRoomAction);
               }
            ...
            {
               this.var_340.stop();
               this.var_340.removeEventListener(TimerEvent.TIMER,this.onRoomActionTimerEvent);
               this.var_340 = null;
            }
      ...
      {
         this.var_1552[param2] = param1;
      }
      
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_159 = IHabboConfigurationManager(param2);
         if(this.var_159)
         {
            if(this.var_286 != null)
            {
               this.var_286.configuration = this.var_159;
            }
            if(this.var_285 != null)
            {
               this.var_285.configuration = this.var_159;
            }
            this.setErrorContextFlag(1,0);
            this.trackLoginStep(HabboLoginTrackingStep.const_1953);
            if(this.var_159)
            {
               if(this.var_673 != null)
               {
                  this.var_673.configure(this.var_159);
               }
               if(this.var_474 != null)
               {
                  this.var_474.configure(this.var_159);
               }
               if(this.var_473 != null)
               {
                  this.var_473.configure(this.var_159);
               }
            }
         }
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_989,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_284,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_218,this.onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_581,this.onHotelViewEvent);
      }
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_673 != null)
            {
               this.var_673.connection = param1;
            }
         }
      }
      ...
      private function onHotelViewEvent(param1:Event) : void
      {
         ...
         else if(param1.type == HabboHotelViewEvent.const_581)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_2055);
         }
         else if(param1.type == HabboHotelViewEvent.const_74)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1971);
         }
      }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               this.trackLoginStep(HabboLoginTrackingStep.const_1762);
               break;
            case HabboCommunicationEvent.const_989:
               this.trackLoginStep(HabboLoginTrackingStep.const_1925,String(this._communication.port));
               break;
            case HabboCommunicationEvent.const_284:
               this.trackLoginStep(HabboLoginTrackingStep.const_284);
               break;
            ...
            case HabboCommunicationEvent.const_218:
               ...
               this.trackLoginStep(HabboLoginTrackingStep.const_218);
               break;
      ...
      {
         this.var_1267 = IHabboWindowManager(param2);
         if(this.var_1267)
         {
      ...
      private function onError(param1:ErrorEvent) : void
      {
         ...
         if(param1.critical && !this._crashed)
         {
            ...
            if(this.var_159)
            {
               if(this.var_159.keyExists("client.fatal.error.url"))
               {
                  _loc2_ = this.var_159.getKey("client.fatal.error.url");
                  ...
                  _loc8_ = "";
                  for each(_loc9_ in this.var_1552)
                  {
      ...
      private function onNavigatorReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this._navigator.events.addEventListener(HabboNavigatorEvent.const_345,this.onZoomToggle);
      }
      ...
      {
         this.var_222 = param2 as IHabboFriendList;
         Component(this.var_222).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,this.onFriendlistTrackingEvent);
         Component(this.var_222).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,this.onFriendlistTrackingEvent);
         Component(this.var_222).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,this.onFriendlistTrackingEvent);
         Component(this.var_222).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,this.onFriendlistTrackingEvent);
         Component(this.var_222).events.addEventListener(HabboFriendListTrackingEvent.const_612,this.onFriendlistTrackingEvent);
      }
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_612:
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1261,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_965,String(true));
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(this._roomEngine).events.addEventListener(RoomEngineEvent.const_371,this.onRoomAction);
      }
      
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_354 = param2 as IAdManager;
         this.var_354.events.addEventListener(AdEvent.const_557,this.onRoomAdLoad);
      }
      ...
      private function onRoomAction(param1:RoomEngineEvent) : void
      {
         if(param1.type == RoomEngineEvent.const_198)
         {
            if(this.var_1935 < 1)
            {
               if(!this.var_340)
               {
                  this.var_340 = new Timer(60000,1);
                  this.var_340.addEventListener(TimerEvent.TIMER,this.onRoomActionTimerEvent);
                  this.var_340.start();
               }
            }
         }
         else if(param1.type == RoomEngineEvent.const_371)
         {
            if(this.var_340)
            {
               this.var_340.removeEventListener(TimerEvent.TIMER,this.onRoomActionTimerEvent);
         ...
         if(!disposed)
         {
            if(this._connection)
            {
               if(this.var_474)
               {
                  ...
                  this.trackEventLog("Performance","fps",String(this.var_474.frameRate),_loc2_);
                  ++this.var_1935;
               }
            }
         }
      ...
      private function onToolbarClick(param1:HabboToolbarEvent) : void
      {
         if(this.var_473)
         {
            this.var_473.track(param1.iconName);
         }
      }
      ...
      private function onZoomToggle(param1:HabboNavigatorEvent) : void
      {
         if(this.var_473)
         {
            this.var_473.track(param1.type);
         }
      }
      ...
      {
         if(this.var_159 != null && !Boolean(this.var_159.getKey("processlog.enabled")))
         {
            return;
         }
      ...
      {
         this.var_673.chatLagDetected(param1);
      }
      
      public function update(param1:uint) : void
      {
         var _loc2_:int = getTimer();
         if(this.var_557 > -1 && _loc2_ < this.var_557)
         {
            ++this.var_1936;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_1936);
         }
         if(this.var_557 > -1 && _loc2_ - this.var_557 > 15000)
         {
            ++this.var_1934;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + this.var_1934);
         }
         this.var_557 = _loc2_;
         if(this.var_285 != null)
         {
            this.var_285.update(param1,this.var_557);
         }
         if(this.var_286 != null)
         {
            this.var_286.update(param1,this.var_557);
         }
         if(this.var_474 != null)
         {
            this.var_474.trackUpdate(param1,this,this.var_557);
         }
         if(this.var_673 != null)
         {
            this.var_673.update(this.var_557);
         }
      }
   }
}
