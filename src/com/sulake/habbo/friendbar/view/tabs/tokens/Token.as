package com.sulake.habbo.friendbar.view.tabs.tokens
{
   ...
   public class Token implements IDisposable
   {
      ...
      protected static var var_1439:IHabboWindowManager;
      
      protected static var var_1440:IAssetLibrary;
      
      protected static const ICON:String = "icon";
      
      protected static const const_1064:String = "title";
      ...
      protected var var_1437:FriendNotification;
      
      protected var var_1163:DropAnimation;
      ...
      {
         return this.var_1437.typeCode;
      }
      
      public function get viewOnce() : Boolean
      {
         return this.var_1437.viewOnce;
      }
      ...
      {
         var _loc7_:* = null;
         this._window = var_1439.buildFromXML(var_1440.getAssetByName(param3).content as XML) as IWindowContainer;
         this._window.findChildByName(const_1064).caption = param1;
         this._window.findChildByName(const_1063).caption = !!param2 ? param2 : "";
         _loc7_ = var_1440.getAssetByName(param5) as BitmapDataAsset;
         if(_loc7_)
         {
            IBitmapWrapperWindow(this._window.findChildByName(ICON)).bitmap = _loc7_.content as BitmapData;
         }
         this._icon = var_1439.create("ICON_" + this.typeCode,WindowType.const_327,WindowStyle.const_104,WindowParam.const_30,Token.ICON_RECTANGLE) as IRegionWindow;
         this._icon.mouseThreshold = 0;
         var _loc8_:IBitmapWrapperWindow = var_1439.create("BITMAP_" + this.typeCode,WindowType.const_454,WindowStyle.const_104,WindowParam.const_184,Token.ICON_RECTANGLE) as IBitmapWrapperWindow;
         _loc8_.disposesBitmap = false;
         _loc7_ = var_1440.getAssetByName(param4) as BitmapDataAsset;
         if(_loc7_)
         {
         ...
         if(param6)
         {
            this.var_1163 = new DropAnimation(this._icon,600,32);
         }
      }
   }
}
