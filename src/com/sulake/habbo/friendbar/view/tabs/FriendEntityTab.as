package com.sulake.habbo.friendbar.view.tabs
{
   ...
   public class FriendEntityTab extends Tab
   {
      ...
      private static const const_1445:String = "entity_xml";
      
      private static const const_1442:String = "facebook_piece_xml";
      
      private static const const_1444:String = "controls_piece_xml";
      ...
      protected static const const_1423:String = "facebook";
      
      protected static const const_1424:String = "controls";
      
      protected static const const_316:String = "canvas";
      
      protected static const const_701:String = "name";
      
      protected static const const_1063:String = "btn_message";
      
      protected static const const_1041:String = "icon_message";
      
      protected static const const_1425:String = "btn_visit";
      
      protected static const ICON:String = "icon";
      
      protected static const const_1043:String = "label";
      
      protected static const const_640:String = "notification";
      
      private static const const_78:uint = 10338138;
      
      private static const const_1055:uint = 13891476;
      
      private static const const_1056:String = null;
      
      private static const const_683:String = "icon_tag_notify";
      
      private static const const_1443:String = "icon_tag_message";
      
      private static const POOL:Vector.<FriendEntityTab> = new Vector.<FriendEntityTab>();
      
      private static const const_469:Vector.<IWindowContainer> = new Vector.<IWindowContainer>();
      ...
      private static function purgeEntityPieces(param1:IWindowContainer) : void
      {
         ...
         _loc3_ = _loc2_.getListItemByName(const_1423) as IWindowContainer;
         if(_loc3_)
         {
            _loc3_.dispose();
         }
         _loc3_ = _loc2_.getListItemByName(const_1424) as IWindowContainer;
         if(_loc3_)
         {
            _loc3_.dispose();
         }
         var _loc4_:* = [];
         _loc2_.groupListItemsWithTag(const_640,_loc4_);
         if(_loc4_.length > 0)
         {
      ...
      override public function select(param1:Boolean) : void
      {
         ...
         if(!selected)
         {
            ...
            {
               _loc3_ = WINDOWING.buildFromXML(ASSETS.getAssetByName(const_1442).content as XML) as IWindowContainer;
               _loc3_.name = const_1423;
               _loc6_ = _loc3_.getChildByName(const_701) as ITextWindow;
               _loc6_.caption = this.friend.realName;
               if(!_loc6_.wordWrap)
               {
                  var_2240.crop(_loc6_);
               }
            ...
            {
               _loc3_ = WINDOWING.buildFromXML(ASSETS.getAssetByName(const_1444).content as XML) as IWindowContainer;
               _loc3_.name = const_1424;
               _loc8_ = _loc3_.getChildByName(const_1063);
               if(_loc8_)
               {
                  _loc8_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onButtonClick);
               }
               _loc8_ = _loc3_.getChildByName(const_1425);
               if(_loc8_)
               {
      ...
      protected function refresh() : void
      {
         ...
         if(this.var_166)
         {
            ...
            _loc1_ = IItemListWindow(_window.getChildByName(const_1042)).getListItemByName(const_463) as IWindowContainer;
            _loc1_.findChildByName(const_701).caption = this.var_166.name;
            var_2240.crop(_loc1_.getChildByName(const_701) as ITextWindow);
            _loc2_ = IBitmapWrapperWindow(_loc1_.findChildByName(const_316));
            _loc2_.bitmap = var_510.getAvatarFaceBitmap(this.var_166.figure);
      ...
      {
         var _loc1_:IWindowContainer = false ? const_469.pop() : WINDOWING.buildFromXML(ASSETS.getAssetByName(const_1445).content as XML) as IWindowContainer;
      ...
      private function onButtonClick(param1:WindowMouseEvent) : void
      {
         if(!disposed && !recycled)
         {
            switch(param1.window.name)
            {
               case const_1063:
               case const_1041:
                  this.removeNotificationToken(FriendNotification.const_421,true);
                  if(var_362 && this.var_166)
                  {
                     var_362.startConversation(this.var_166.id);
                     this.deselect(true);
               ...
               case const_1425:
                  if(var_362 && this.var_166)
                  {
                     var_362.followToRoom(this.var_166.id);
                     this.deselect(true);
                  }
            }
         }
      ...
      public function addNotificationToken(param1:FriendNotification, param2:Boolean) : void
      {
         ...
         var _loc5_:String = const_1056;
         switch(param1.typeCode)
         {
            case FriendNotification.const_1413:
            ...
            case FriendNotification.TYPE_ACHIEVEMENT:
               _loc4_ = new AchievementToken(this.friend,param1,param2,var_2253);
               _loc4_.iconElement.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onMouseClick);
               _loc5_ = const_683;
               break;
            case FriendNotification.const_1262:
               _loc4_ = new QuestToken(this.friend,param1,param2,var_2253);
               _loc4_.iconElement.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onMouseClick);
               _loc5_ = const_683;
               break;
            case FriendNotification.const_421:
