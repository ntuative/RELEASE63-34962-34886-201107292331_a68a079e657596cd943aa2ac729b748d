package com.sulake.habbo.friendbar.stream
{
   ...
   public class EventStreamEntity implements IDisposable
   {
      ...
      private static const const_1064:String = "title";
      ...
      private static const const_1460:String = "minutes";
      
      private static const const_1462:String = "hours";
      
      private static const const_1459:String = "days";
      ...
      private var var_1062:LinkTarget;
      ...
      {
         return !!this._window ? this._window.findChildByName(const_1064).caption : null;
      }
      
      public function set message(param1:String) : void
      {
         this._window.findChildByName(const_1063).caption = param1;
      }
      
      public function get message() : String
      {
         return !!this._window ? this._window.findChildByName(const_1063).caption : null;
      }
      ...
      public function set linkTarget(param1:LinkTarget) : void
      {
         ...
         if(this.var_1062.type == LinkTarget.NONE)
         {
      ...
      public function set minutesElapsed(param1:int) : void
      {
         ...
         var _loc2_:String = const_1460;
         if(this.var_1464 >= 1440)
         {
            _loc2_ = const_1459;
            param1 /= 1440;
         }
         else if(this.var_1464 >= 60)
         {
            _loc2_ = const_1462;
            param1 /= 60;
         }
      ...
      {
         var _loc2_:* = null;
         if(LinkResolver.open(this.var_1062))
         {
      ...
      private function onImageFileLoaded(param1:AssetLoaderEvent) : void
      {
         ...
         {
            this.image = ASSETS.getAssetByName(this.var_1773).content as BitmapData;
         }
      }
   }
}
