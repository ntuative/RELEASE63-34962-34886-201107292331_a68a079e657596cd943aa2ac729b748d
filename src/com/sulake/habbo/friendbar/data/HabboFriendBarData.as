package com.sulake.habbo.friendbar.data
{
   ...
   public class HabboFriendBarData extends Component implements IHabboFriendBarData
   {
      ...
      private static const const_1165:Boolean = false;
      
      private static const const_727:String = "Navigation";
      
      private static const const_726:String = "Friend Bar";
      
      private static const const_1699:String = "go.friendbar";
      
      private static const const_1700:String = "chat_btn_click";
      
      private static const const_1701:String = "find_friends_btn_click";
      
      private static const const_1162:String = "Toolbar";
      
      private static const const_1163:String = "open";
      
      private static const const_1164:String = "close";
      
      private static const const_1698:String = "FRIENDLIST";
      
      private static const const_1702:String = "MESSENGER";
       
      
      private var var_1131:IHabboConfigurationManager;
      ...
      private var var_426:IHabboEventStream;
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            if(this.var_1131)
            {
               this.var_1131.release(new IIDHabboConfigurationManager());
               this.var_1131 = null;
            }
            if(this.var_94)
            {
            ...
            if(this.var_91)
            {
               ...
               {
                  this.var_91.events.removeEventListener(FriendRequestEvent.const_58,this.onFriendRequestEvent);
                  this.var_91.events.removeEventListener(FriendRequestEvent.const_226,this.onFriendRequestEvent);
               }
            ...
            if(this.var_426)
            {
               this.var_426.release(new IIDHabboEventStream());
               this.var_426 = null;
            }
            this.var_118 = null;
      ...
      {
         return this.var_352.getValue(param1);
      }
      ...
      public function followToRoom(param1:int) : void
      {
         if(this.var_94)
         {
            ...
            this.var_94.getHabboMainConnection(null).send(new EventLogMessageComposer(const_727,const_726,const_1699));
         }
      }
      ...
      public function startConversation(param1:int) : void
      {
         if(this.var_236)
         {
            ...
            if(this.var_94)
            {
               this.var_94.getHabboMainConnection(null).send(new EventLogMessageComposer(const_727,const_726,const_1700));
            }
         }
      }
      ...
      public function findNewFriends() : void
      {
         if(this.var_94)
         {
            ...
            this.var_94.getHabboMainConnection(null).send(new EventLogMessageComposer(const_727,const_726,const_1701));
         }
      }
      ...
      public function toggleFriendList() : void
      {
         ...
         if(this.var_91)
         {
            if(!this.var_91.disposed)
            {
               ...
               if(this.var_94)
               {
                  this.var_94.getHabboMainConnection(null).send(new EventLogMessageComposer(const_1162,const_1698,!!this.var_91.isOpen() ? const_1163 : const_1164));
               }
            }
         }
      }
      ...
      public function toggleMessenger() : void
      {
         if(this.var_236)
         {
            if(!this.var_236.disposed)
            {
               ...
               if(this.var_94)
               {
                  this.var_94.getHabboMainConnection(null).send(new EventLogMessageComposer(const_1162,const_1702,!!this.var_236.isOpen() ? const_1163 : const_1164));
               }
            }
         }
      }
      ...
      public function toggleOfflineStream() : void
      {
         if(this.var_426)
         {
            ...
            {
               this.var_426.visible = !this.var_426.visible;
            }
         }
      }
      ...
      public function method_11() : void
      {
         if(this.var_426)
         {
            if(!this.var_426.disposed)
            {
               this.var_426.refreshEventStream();
            }
         }
      }
      ...
      {
         this.var_1131 = param2 as IHabboConfigurationManager;
         this.var_2984 = this.var_1131.getBoolean("friendbar.notifications.enabled",false);
         this.var_2173 = this.var_1131.getBoolean("friendbar.requests.enabled",false);
      }
      ...
      {
         this.var_426 = param2 as IHabboEventStream;
      }
      
      private function onFriendListComponentAvailable(param1:IID, param2:IUnknown) : void
      {
         this.var_91 = param2 as IHabboFriendList;
         this.var_91.events.addEventListener(FriendRequestEvent.const_58,this.onFriendRequestEvent);
         this.var_91.events.addEventListener(FriendRequestEvent.const_226,this.onFriendRequestEvent);
      }
      ...
      private function onFriendListUpdate(param1:IMessageEvent) : void
      {
         ...
         {
            _loc3_ = this.var_352.getValue(_loc8_);
            if(_loc3_)
            {
               this.var_352.remove(_loc8_);
               this.var_118.splice(this.var_118.indexOf(_loc3_),1);
            }
         }
         for each(_loc4_ in _loc6_)
         {
            _loc3_ = this.var_352.getValue(_loc4_.id);
            if(_loc3_)
            {
            ...
            else if(_loc4_.online || const_319)
            {
               ...
               this.var_352.add(_loc3_.id,_loc3_);
            }
         }
         for each(_loc4_ in _loc7_)
         {
            if(_loc4_.online || const_319)
            {
               if(this.var_352.getValue(_loc4_.id) == null)
               {
                  _loc3_ = new FriendEntity(_loc4_.id,_loc4_.name,_loc4_.realName,_loc4_.motto,_loc4_.gender,_loc4_.online,_loc4_.followingAllowed,_loc4_.figure,_loc4_.categoryId,_loc4_.lastAccess);
         ...
         {
            this.var_118 = !!const_319 ? this.sortByNameAndOnlineStatus(this.var_118) : this.sortByName(this.var_118);
         }
         events.dispatchEvent(new FriendBarUpdateEvent());
      }
      ...
      private function onNewConsoleMessage(param1:NewConsoleMessageEvent) : void
      {
         ...
         if(_loc3_)
         {
            events.dispatchEvent(new NewMessageEvent(true,this.var_917));
            this.makeNotification(String(this.var_917),FriendNotification.const_421,null,false,false);
         }
      }
      ...
      private function onRoomInvite(param1:RoomInviteEvent) : void
      {
         ...
         {
            events.dispatchEvent(new NewMessageEvent(true,this.var_917));
            this.makeNotification(String(this.var_917),FriendNotification.const_421,null,true,false);
         }
      }
