package com.sulake.habbo.friendlist.domain
{
   ...
   public class Friend implements IFriend, IDisposable
   {
      ...
      public static const const_2199:int = "F".charCodeAt(0);
      
      public static const const_2289:int = "M".charCodeAt(0);
      ...
      public function Friend(param1:FriendData)
      {
         ...
         this.var_1028 = param1.gender;
         this.var_809 = param1.online;
         this.var_1856 = param1.followingAllowed && param1.online;
         this.var_666 = param1.figure;
         this.var_1858 = param1.motto;
         this.var_1857 = param1.lastAccess;
         this.var_1470 = param1.categoryId;
         this.var_1859 = param1.realName;
