package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      private var var_154:IHabboMessenger;
      ...
      private var var_791:ISessionDataManager;
      
      private var var_2461:FriendListLookAndFeel;
      
      private var var_506:FriendListTabs;
      
      private var _view:FriendListView;
      
      private var var_1827:OpenedToWebPopup;
      
      private var var_2338:int;
      
      var var_119:FriendCategories;
      
      private var var_125:FriendRequests;
      
      private var var_1826:AvatarSearchResults;
      ...
      {
         this.var_2461 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         this.var_119 = new FriendCategories(new FriendCategoriesDeps(this));
         this.var_1826 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_640.stop();
            this.var_640.removeEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_640 = null;
         }
         ...
         if(this.var_154)
         {
            this.var_154.release(new IIDHabboMessenger());
            this.var_154 = null;
         }
         if(this.var_159)
         {
         ...
         if(this.var_791)
         {
            this.var_791.release(new IIDSessionDataManager());
            this.var_791 = null;
         }
         super.dispose();
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_1827 = new OpenedToWebPopup(this);
         }
         this.var_1827.show(x,y);
      }
      ...
      {
         this.openFriendListWithTab(FriendListTab.const_401);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_376,HabboWindowStyle.const_46,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_616.createAvatarImage(param1,AvatarScaleType.const_117,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      {
         var _loc1_:String = this.var_159.getKey("client.minimail.embed.enabled");
         return _loc1_ == "true";
      }
      
      private function getVariable(param1:String, param2:Dictionary) : String
      {
         return this.var_159.getKey(param1,param1,param2);
      }
      ...
      private function onMessengerComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_154 = param2 as IHabboMessenger;
      ...
      {
         this.var_1081 = param2 as IHabboNotifications;
      ...
      {
         this.var_791 = param2 as ISessionDataManager;
      }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_125 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit,_loc2_.evenMoreExtendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            this.var_119.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         this.var_119.addCategory(new FriendCategory(FriendCategory.const_1297,this.getText("friendlist.friends")));
         this.var_119.addCategory(new FriendCategory(FriendCategory.const_398,this.getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in this.getSortedFriends(_loc2_.friends))
         {
            this.var_119.addFriend(new Friend(_loc4_));
         }
         this.var_506 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!this.var_640)
         {
            this.var_640 = new Timer(120000);
            this.var_640.addEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_640.start();
         }
         ...
         {
            _loc5_ = this.var_119.findCategory(FriendCategory.const_398);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         this.var_125.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            this.var_125.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            this.var_506.findTab(FriendListTab.const_92).setNewMessageArrived(true);
         }
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         this.var_125.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = this.var_506.findTab(FriendListTab.const_92);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_1826.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         var _loc2_:FriendListTab = this.var_506.findTab(FriendListTab.const_92);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         var _loc1_:FriendListTab = this.var_506.findTab(FriendListTab.const_92);
         if(!_loc1_)
         {
            return;
         }
      ...
      {
         if(!this.var_791 || !this.var_125)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_791.hasUserRight("fuse_super_extended_buddylist",HabboClubLevelEnum.const_37))
         {
            _loc2_ = this.var_125.vipLimit;
         }
         else if(this.var_791.hasUserRight("fuse_extended_buddylist",HabboClubLevelEnum.const_34))
         {
            _loc2_ = this.var_125.clubLimit;
         }
         if(_loc2_ > this.var_125.limit)
         {
            this.var_125.limit = _loc2_;
         }
      }
