package com.sulake.habbo.friendlist
{
   ...
   public class SearchView implements ITabView, ISearchView
   {
      ...
      {
         this.var_885 = ITextFieldWindow(param1.findChildByName("search_str"));
         this.var_885.procedure = this.onSearchInput;
         this.var_885.addEventListener(WindowKeyboardEvent.const_194,this.onSearchStrInput);
      ...
      private function refreshShading() : void
      {
         ...
         {
            this.var_67.getListItemAt(_loc1_).color = this._friendList.laf.method_2(FriendListTab.const_401,_loc1_ % 2 == 1);
            _loc1_++;
         }
      }
      ...
      private function onSearchEntry(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            this.var_676.setData(_loc3_.isAvatarOnline,_loc3_.avatarName,_loc3_.avatarMotto,_loc3_.avatarFigure,_loc3_.lastOnlineDate,_loc3_.realName);
            this.var_676.showPopup(this._friendList.view.mainWindow,IWindowContainer(param2));
         }
