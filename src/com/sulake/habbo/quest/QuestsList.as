package com.sulake.habbo.quest
{
   ...
   public class QuestsList implements IDisposable
   {
      ...
      private static const const_1692:int = 5;
      
      private static const const_1695:int = 10;
      
      private static const const_1693:int = 10;
      
      private static const const_1694:int = 30;
      ...
      private var var_2163:Boolean = true;
      ...
      public function onToolbarClick() : void
      {
         ...
         {
            this.var_878 = new WindowToggle(this._window,this._window.desktop,this.requestQuests,this.close);
         }
         this.var_878.toggle();
         this.var_2163 = false;
      }
      ...
      private function refresh(param1:Boolean) : void
      {
         ...
         while(true)
         {
            if(_loc2_ < this.var_1671.length)
            {
               this.refreshEntry(true,_loc2_,this.var_1671[_loc2_],param1);
            }
            else
            {
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_610 = IScrollbarWindow(this._window.findChildByName("scroller"));
         this._window.center();
         this.var_67.spacing = const_1695;
      }
      ...
      public function createListEntry() : IWindowContainer
      {
         ...
         _loc6_.x = _loc3_.width - _loc6_.width - const_1693;
         ...
         _loc3_.x = _loc2_.x + _loc2_.width + const_1692;
      ...
      public function setEntryHeight(param1:IWindowContainer) : void
      {
         ...
         _loc2_.findChildByName("completion_txt").y = _loc2_.height - const_1694;
      ...
      private function onWindowClose(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            if(_loc3_ && this.var_2163 && !this.var_2162)
            {
               this.var_2163 = false;
      ...
      public function update(param1:uint) : void
      {
         ...
         this.var_1442 = NextQuestTimer.const_772;
         this.refresh(true);
      }
   }
}
