package com.sulake.habbo.quest
{
   ...
   public class AchievementController implements IDisposable, IUpdateReceiver
   {
      ...
      private static const const_1548:int = 246;
      
      private static const const_1540:int = 45;
      
      private static const const_1538:Point = new Point(115,93);
      
      private static const const_1543:Point = new Point(72,1);
      
      private static const const_1087:int = 40;
      
      private static const const_1539:int = 20;
      ...
      private var var_466:IWindowContainer;
      ...
      private var var_661:ProgressBar;
      
      private var var_821:ProgressBar;
      
      private var var_1252:Matrix;
      
      private var var_1907:ColorMatrixFilter;
      
      private var var_1533:AchievementData;
      
      private var var_822:Timer;
      
      private var var_662:Dictionary;
      
      private var var_823:AchievementLevelUp;
      ...
      public function AchievementController(param1:HabboQuestEngine)
      {
         ...
         super();
         this.var_51 = param1;
         this.var_550 = new Timer(100,1);
         this.var_550.addEventListener(TimerEvent.TIMER,this.doBadgeRefresh);
         this.var_822 = new Timer(2000,1);
         this.var_822.addEventListener(TimerEvent.TIMER,this.switchIntoPendingLevel);
         this.var_823 = new AchievementLevelUp(this.var_51);
         this.var_1252 = new Matrix();
         this.var_1907 = this.createGrayscaleFilter();
         this.var_662[16] = 1;
         this.var_662[28] = 6;
         this.var_662[38] = 4;
         this.var_662[39] = 3;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_550)
         {
            this.var_550.removeEventListener(TimerEvent.TIMER,this.doBadgeRefresh);
            this.var_550.reset();
            this.var_550 = null;
         }
         if(this.var_822)
         {
            this.var_822.removeEventListener(TimerEvent.TIMER,this.switchIntoPendingLevel);
            this.var_822.reset();
            this.var_822 = null;
         }
         if(this.var_661)
      ...
      private function refresh() : void
      {
         ...
         this._window.height = getLowestPoint(this._window.content) + const_1540;
      }
      ...
      private function refreshCategoryList() : void
      {
         ...
         this.var_466.height = getLowestPoint(this.var_466);
      }
      ...
      private function refreshCategoryListFooter() : void
      {
         ...
         this.var_821.refresh(this.var_119.getProgress(),this.var_119.getMaxProgress(),0);
      }
      ...
      private function refreshAchievementList() : void
      {
         ...
         this.var_820.height = getLowestPoint(this.var_820);
      }
      ...
      private function refreshAchievementsHeader() : void
      {
         if(this._category == null)
         {
            this.var_1026.visible = false;
            return;
         }
         this.var_1026.visible = true;
         this.var_1026.findChildByName("category_name_txt").caption = this.var_51.getAchievementCategoryName(this._category.code);
         ...
         this.var_51.setupAchievementCategoryImage(this.var_1026,this._category,false);
      }
      ...
      private function refreshAchievementsFooter() : void
      {
         if(this._category == null)
         {
            this.var_1534.visible = false;
            return;
         }
         this.var_1534.visible = true;
      }
      ...
      private function refreshAchievementDetails() : void
      {
         ...
         this.var_467.findChildByName("achievement_name_txt").caption = this.var_51.localization.getBadgeName(_loc1_);
         var _loc2_:String = this.var_51.localization.getBadgeDesc(_loc1_);
         this.var_467.findChildByName("achievement_desc_txt").caption = _loc2_ == null ? "" : _loc2_;
         ...
         this.var_51.refreshReward(!this.var_74.finalLevel,this.var_467,this.var_74.levelRewardPointType,this.var_74.levelRewardPoints);
         this.refreshBadgeImageLarge(this.var_467,this.var_74);
         this.var_661.refresh(this.var_74.currentPoints,this.var_74.scoreLimit,this.var_74.type * 10000 + this.var_74.level);
         this.var_661.visible = !this.var_74.finalLevel;
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this._window.center();
         this._window.y = const_1539;
         this.var_466 = IWindowContainer(this._window.findChildByName("categories_cont"));
         this.var_1026 = IWindowContainer(this._window.findChildByName("achievements_header_cont"));
         this.var_820 = IWindowContainer(this._window.findChildByName("achievements_cont"));
         this.var_467 = IWindowContainer(this._window.findChildByName("achievement_cont"));
         this.var_1534 = IWindowContainer(this._window.findChildByName("achievements_footer_cont"));
         this.var_1251 = IWindowContainer(this._window.findChildByName("categories_footer_cont"));
         this.var_661 = new ProgressBar(this.var_51,this.var_467,const_1545,"achievements.details.progress",true,const_1538);
         this.var_821 = new ProgressBar(this.var_51,this.var_1251,const_1548,"achievements.categories.totalprogress",true,const_1543);
      }
      
      private function refreshCategoryEntry(param1:int, param2:AchievementCategory) : Boolean
      {
         var _loc3_:IWindowContainer = IWindowContainer(this.var_466.getChildByName("" + param1));
         var _loc4_:int = Math.floor(param1 / const_696);
         ...
         if(_loc3_ == null)
         {
            ...
            _loc3_.x = (_loc3_.width + const_1546) * (param1 % const_696);
            _loc3_.y = (_loc3_.height + const_1544) * Math.floor(param1 / const_696) + const_1549;
         }
      ...
      {
         var _loc9_:* = null;
         var _loc3_:IWindowContainer = IWindowContainer(this.var_820.getChildByName("" + param1));
         var _loc4_:int = Math.floor(param1 / const_1088);
         var _loc5_:* = _loc4_ < const_1550;
         if(_loc3_ == null)
         {
            if(param2 == null && !_loc5_)
            {
            ...
            _loc3_.y = _loc3_.height * _loc4_ + const_1547;
      ...
      private function refreshMouseOver(param1:int) : void
      {
         ...
         var _loc5_:* = null;
         var _loc2_:int = 0;
         while(_loc2_ < this.var_466.numChildren)
         {
            _loc3_ = _loc2_ == param1;
            _loc4_ = IWindowContainer(this.var_466.getChildAt(_loc2_));
      ...
      private function refreshBadgeImage(param1:IWindowContainer, param2:AchievementData) : void
      {
         ...
         var _loc5_:BitmapData = this.var_824[_loc4_];
         ...
         if(_loc5_ == null)
         {
            ...
            this.var_824[_loc4_] = _loc5_;
         }
         var _loc7_:int = const_1087 - _loc5_.height + this.getPositionFix(param2.type);
         var _loc8_:Point = new Point((_loc3_.width - _loc5_.width) / 2,!!_loc6_ ? Number(const_1541) : Number(_loc7_));
         ...
         {
            _loc3_.bitmap.applyFilter(_loc5_,_loc5_.rect,_loc8_,this.var_1907);
         }
         _loc3_.visible = false;
         _loc3_.visible = true;
      }
      ...
      private function refreshBadgeImageLarge(param1:IWindowContainer, param2:AchievementData) : void
      {
         ...
         this.var_1252.identity();
         this.var_1252.scale(2,2);
         this.var_1252.translate((_loc3_.width - _loc5_.width * 2) / 2,_loc6_);
         _loc3_.bitmap.fillRect(_loc3_.bitmap.rect,16777215);
         _loc3_.bitmap.draw(_loc5_,this.var_1252);
         if(!param2.firstLevelAchieved)
         {
            _loc3_.bitmap.applyFilter(_loc3_.bitmap,_loc3_.bitmap.rect,new Point(0,0),this.var_1907);
         }
         _loc3_.visible = false;
         _loc3_.visible = true;
      }
      ...
      {
         this.var_74 = this.var_1533;
         this.var_119.update(this.var_1533);
         this.var_1533 = null;
         this.refresh();
      }
      ...
      public function onBadgeImageReady(param1:BadgeImageReadyEvent) : void
      {
         ...
         this.var_824[param1.badgeId] = param1.badgeImage;
         if(!this.var_550.running)
         {
            this.var_550.start();
         }
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            this.var_661.updateView();
         }
         if(this.var_821 != null)
         {
            this.var_821.updateView();
         }
         if(this.var_823 != null)
         {
            this.var_823.update(param1);
         }
      }
