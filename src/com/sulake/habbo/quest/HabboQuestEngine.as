package com.sulake.habbo.quest
{
   ...
   public class HabboQuestEngine extends Component implements IHabboQuestEngine, IUpdateReceiver
   {
      ...
      private static const const_1526:int = 800;
      
      private static const const_1527:int = 15;
      
      private static const const_1524:int = 300;
      ...
      private var var_1244:QuestController;
      
      private var var_658:AchievementController;
      ...
      public function HabboQuestEngine(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_1244 = new QuestController(this);
         this.var_658 = new AchievementController(this);
         ...
         registerUpdateReceiver(this,const_1525);
      }
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_404.events.removeEventListener(BadgeImageReadyEvent.const_216,this.var_658.onBadgeImageReady);
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_404.events.addEventListener(BadgeImageReadyEvent.const_216,this.var_658.onBadgeImageReady);
      }
      ...
      {
         return this.var_1244.questTracker.isVisible();
      }
