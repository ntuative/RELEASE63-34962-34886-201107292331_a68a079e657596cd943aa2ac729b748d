package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, IUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1514:String = "pixelbalance";
      
      private static const const_1518:String = "badges";
      
      private static const const_1512:String = "selectbadge";
      
      private static const const_1516:String = "inventory";
      
      private static const const_1519:String = "selectfurni";
      
      private static const UILINK_CREDITS:String = "credits";
      
      private static const const_1513:String = "friendlist";
      
      private static const const_1517:String = "pet_inventory";
      
      private static const const_1515:String = "go_to_room";
      ...
      private var var_1881:IHabboToolbar;
      ...
      private var var_812:ParkBusDialogManager;
      
      private var var_2554:Boolean;
      
      private var var_1013:ClubGiftNotification;
      
      private var var_1012:ClubEndingNotification;
      
      private var var_1015:ClubPromoNotification;
      
      private var var_3097:Dictionary;
      ...
      public function HabboNotifications(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_1882 = false;
         this.var_3097 = new Dictionary();
         var _loc4_:IAsset = this._assetLibrary.getAssetByName("habbo_notifications_config_xml");
         var _loc5_:XmlAsset = XmlAsset(_loc4_);
         if(_loc5_ != null)
         {
            XMLVariableParser.parseVariableList(XML(_loc5_.content).children(),this.var_1014);
         }
         var _loc6_:Map = this.var_1014["styles"];
         if(_loc6_ != null)
         {
            _loc7_ = 0;
      ...
      private function addItem(param1:String, param2:String, param3:BitmapData, param4:String = null) : int
      {
         ...
         var _loc5_:Map = this.var_1014["styles"];
         if(_loc5_ == null)
         {
            return 0;
         }
         ...
         this.var_1240.push(_loc8_);
         return this.var_1240.length;
      }
      
      private function getNextItemFromQueue() : HabboNotificationItem
      {
         var _loc1_:Array = this.var_1240.splice(0,1);
      ...
      {
         this.var_1881 = param2 as IHabboToolbar;
      }
      ...
      {
         this.var_544 = new HabboNotificationViewManager(this._assetLibrary,this._windowManager,this._config,this.var_1881,this.var_1014["styles"],this.var_1014["view"]);
         ...
         this.var_404.events.addEventListener(BadgeImageReadyEvent.const_216,this.onBadgeImage);
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_404.userId == _loc2_.userId)
         {
            ...
            if(_loc3_)
            {
               this.addItem(_loc3_.value,NotificationType.const_1215,null);
            }
            if(_loc4_)
            {
               this.addItem(_loc4_.value,NotificationType.const_1215,null);
            }
         }
      }
      ...
      {
         this.addItem(param1,NotificationType.const_994,null);
      }
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         for each(_loc6_ in _loc4_.products)
         {
            if(_loc6_)
            {
               if(_loc6_.productType == CatalogPageMessageProductData.const_73)
               {
               ...
               if(_loc8_)
               {
                  this.addItem(_loc8_.value,NotificationType.const_1996,_loc5_);
               }
            }
         }
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || _loc2_.recyclerFinishedStatus != RecyclerFinishedMessageEvent.const_1271)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_1987,null);
         }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         else
         {
            ...
            if(_loc2_.isShowBasicPromo)
            {
               ...
               this.var_1015 = new ClubPromoNotification(_loc2_.basicNormalPrice,_loc2_.basicPromoPrice,assets,this._windowManager,this._catalog,this._localization);
            }
         }
      }
      ...
      private function checkClubEndingNotification(param1:ScrSendUserInfoMessageParser) : void
      {
         ...
         if(_loc2_ > 0 && param1.daysToPeriodEnd > 0 && param1.daysToPeriodEnd <= _loc2_ && param1.periodsSubscribedAhead == 0)
         {
            ...
            this.var_1012 = new ClubEndingNotification(param1.daysToPeriodEnd,param1.isVIP,assets,this._windowManager,this._catalog,this._localization);
         }
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_544.isSpaceAvailable() && this.var_1240.length > 0)
         {
      ...
      public function onExecuteLink(param1:String) : void
      {
         switch(param1)
         {
            ...
            case const_1517:
               if(this.var_12 != null && this.var_12.hasRoomSession)
               {
                  this.var_12.toggleInventoryPage(InventoryCategory.const_127);
               }
               break;
            case const_1519:
               break;
      ...
      private function onModMessageEvent(param1:IMessageEvent) : void
      {
         ...
         this.var_245.method_16(_loc2_.message,_loc2_.url);
      }
      ...
      private function onParkBusMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_812 == null)
         {
            this.var_812 = new ParkBusDialogManager(this._windowManager,assets,this._localization);
         }
         if(_loc2_ != null || this.var_812 != null)
         {
            this.var_812.handleParkBusCannotEnter(_loc2_.reason);
         }
      }
      ...
      private function onPetLevelNotification(param1:PetLevelNotificationEvent) : void
      {
         ...
         if(_loc3_)
         {
            ...
            this.addItem(_loc3_.value,NotificationType.const_1421,_loc4_);
         }
      }
      ...
      private function onPetReceived(param1:PetReceivedMessageEvent) : void
      {
         ...
         if(_loc3_)
         {
            ...
            this.addItem(_loc3_.value,NotificationType.const_1421,_loc5_);
         }
      }
      ...
      private function getPetImage(param1:int, param2:int, param3:String) : BitmapData
      {
         ...
         if(param1 < 8)
         {
            ...
            _loc6_ = this.var_1047.createPetImage(param1,param2,_loc5_,AvatarScaleType.const_60);
            if(_loc6_ != null)
            {
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(!this.var_2554)
         {
            ...
            this.addItem(_loc2_,NotificationType.const_994,null);
            this.var_2554 = true;
      ...
      {
         if(param2.type == WindowEvent.const_156 || param2.type == WindowEvent.const_634)
         {
            param1.dispose();
         }
      }
      ...
      private function onClubGiftNotification(param1:ClubGiftNotificationEvent) : void
      {
         ...
         if(this.var_1013 && this.var_1013.visible)
         {
            return;
         }
         this.var_1013 = new ClubGiftNotification(_loc2_.numGifts,assets,this._windowManager,this._catalog,this.var_1881);
      }
      ...
      private function onClubGiftSelected(param1:ClubGiftSelectedEvent) : void
      {
         ...
         this.addItem(_loc5_,NotificationType.const_994,_loc6_);
      }
   }
}
