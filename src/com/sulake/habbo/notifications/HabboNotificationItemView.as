package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationItemView implements IUpdateReceiver
   {
      ...
      public static const const_1968:int = 5;
      ...
      private var var_242:HabboNotificationItem;
      ...
      public function HabboNotificationItemView(param1:IAsset, param2:IHabboWindowManager, param3:Map, param4:Map, param5:HabboNotificationItem)
      {
         ...
         if(_loc7_ != null)
         {
            this.var_1760 = this._window.height - _loc7_.rectangle.bottom;
         }
         else
         {
            this.var_1760 = 15;
         }
         this.var_1759 = this._window.height;
         this.var_1456 = 4;
         this._blend = 0;
         this._state = name_4;
      ...
      {
         if(param1.badgeId != this.var_242.style.iconSrc)
         {
            return;
         }
      ...
      public function update(param1:uint) : void
      {
         ...
         switch(this._state)
         {
            ...
            case const_499:
               ...
               _loc2_ = Number(this.var_1180) / Number(this.var_968["time_fade_in"]);
               if(this.var_1180 > int(this.var_968["time_fade_in"]))
               {
                  this.startDisplay();
               }
            ...
            case const_1059:
               ...
               if(this.var_1455 > int(this.var_968["time_display"]) && !this.var_1758)
               {
                  this.startFadeOut();
               }
               break;
            case const_1060:
               ...
               _loc3_ = 1 - Number(this.var_1181) / Number(this.var_968["time_fade_out"]);
               this.adjustBlend(_loc3_);
               if(this.var_1181 > int(this.var_968["time_fade_in"]))
               {
                  this.startIdling();
               }
         }
      ...
      private function setNotificationText(param1:String) : void
      {
         ...
         _loc2_.text = param1;
         _loc2_.height = _loc2_.textHeight + this.var_1760;
         if(this._window.height < this.var_1759)
         {
            this._window.height = this.var_1759;
         }
      }
      ...
      {
         this.var_1181 = 0;
         this._state = const_1060;
      }
      
      private function startDisplay() : void
      {
         this.var_1455 = 0;
         this._state = const_1059;
      }
      ...
      public function reposition(param1:int = -1) : void
      {
         ...
         this._window.x = _loc2_.width - this._window.width - const_1968;
         this._window.y = this.var_1456;
      }
