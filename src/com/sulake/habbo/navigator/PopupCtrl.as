package com.sulake.habbo.navigator
{
   ...
   public class PopupCtrl
   {
      ...
      {
         this.var_500 = new Timer(500,1);
         this.var_416 = new Timer(100,1);
         super();
         this._navigator = param1;
         this.var_1150 = param4;
         this.var_2648 = param2;
         this._popupIndentLeft = param3;
         this.var_500.addEventListener(TimerEvent.TIMER,this.onDisplayTimer);
         this.var_416.addEventListener(TimerEvent.TIMER,this.onHideTimer);
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_500)
         {
            this.var_500.removeEventListener(TimerEvent.TIMER,this.onDisplayTimer);
            this.var_500.reset();
            this.var_500 = null;
         }
         if(this.var_416)
         {
            this.var_416.removeEventListener(TimerEvent.TIMER,this.onHideTimer);
            this.var_416.reset();
            this.var_416 = null;
         }
      }
      ...
      public function showPopup(param1:IWindow) : void
      {
         if(this.var_60 == null)
         {
            this.var_60 = IWindowContainer(this._navigator.getXmlWindow(this.var_1150));
            this.var_60.visible = false;
            this.var_60.setParamFlag(HabboWindowParam.const_43,true);
         ...
         this.var_60.x = _loc2_.x + this.var_2648 + param1.width;
