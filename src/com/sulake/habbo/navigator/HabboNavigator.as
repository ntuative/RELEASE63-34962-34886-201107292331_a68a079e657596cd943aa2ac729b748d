package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_652:RoomInfoViewCtrl;
      
      private var var_1225:RoomCreateViewCtrl;
      
      private var _data:NavigatorData;
      
      private var var_506:Tabs;
      ...
      private var var_1142:GuestRoomPasswordInput;
      
      private var var_343:GuestRoomDoorbell;
      
      private var var_1226:OfficialRoomEntryManager;
      
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         this.var_2512 = new Array();
         ...
         this.var_652 = new RoomInfoViewCtrl(this);
         this.var_1225 = new RoomCreateViewCtrl(this);
         this.var_2513 = new RoomThumbnailRenderer(this);
         this.var_1142 = new GuestRoomPasswordInput(this);
         this.var_343 = new GuestRoomDoorbell(this);
         this.var_506 = new Tabs(this);
         this.var_1226 = new OfficialRoomEntryManager(this);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = IBitmapWrapperWindow(this._windowManager.createWindow(param1,"",HabboWindowType.const_376,HabboWindowStyle.const_46,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6));
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var _loc3_:String = this.var_159.getKey("navigator.default_tab");
         switch(_loc3_)
         {
            case "popular":
               _loc4_ = 0;
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_334.startSearch(Tabs.const_282,Tabs.const_555,param1);
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_334.startSearch(Tabs.const_266,Tabs.const_311);
         this.var_506.getTab(Tabs.const_266).tabPageDecorator.tabSelected();
      }
