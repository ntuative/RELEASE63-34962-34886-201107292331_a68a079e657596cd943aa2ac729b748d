package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_1405:TextFieldManager;
      ...
      private var var_1409:TextFieldManager;
      ...
      private var var_2212:ITextWindow;
      
      private var var_1144:IDropMenuWindow;
      
      private var var_1143:IDropMenuWindow;
      
      private var var_3031:IWindowContainer;
      ...
      {
         this.var_430 = param1;
         this._navigator.send(new GetRoomSettingsMessageComposer(this.var_430));
         if(this.var_1410 != null)
         {
            this.var_1410.visible = false;
         }
      }
      
      public function onRoomSettings(param1:RoomSettingsData) : void
      {
         if(param1.roomId != this.var_430)
         {
            return;
         }
         this.var_57 = param1;
      ...
      {
         if(param1 != this.var_430 || this.var_1408 < 1)
         {
            return;
         }
         this.close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         this.var_1408 = 0;
         if(param2 == RoomSettingsSaveErrorMessageParser.const_1929)
         {
            this.var_928.displayError("${navigator.roomsettings.roomnameismandatory}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1805)
         {
            this.var_928.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1844)
         {
            this.var_1405.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1944)
         {
            this.setTagError(this.var_1110,param3,"${navigator.roomsettings.unacceptablewords}");
            this.setTagError(this.var_1111,param3,"${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1966)
         {
            this.setTagError(this.var_1110,param3,"${navigator.roomsettings.nonuserchoosabletag}");
            this.setTagError(this.var_1111,param3,"${navigator.roomsettings.nonuserchoosabletag}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_2053)
         {
            this.var_1142.displayError("${navigator.roomsettings.passwordismandatory}");
         }
         else
         {
            this.var_928.displayError("Update failed: error " + param2);
         }
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_340,this.onDoorModePasswordSelect);
         _loc2_.addEventListener(WindowEvent.const_624,this.onDoorModePasswordUnselect);
         ...
         this.var_928 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("room_name")),60);
         this.var_1405 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("description")),255);
         this.var_1110 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag1")),30);
         this.var_1111 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag2")),30);
         this.var_1142 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password")),30);
         this.var_1409 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password_confirm")),30);
         this.var_1411 = ICheckBoxWindow(this._window.findChildByName("allow_pets_checkbox"));
         this.var_1403 = ICheckBoxWindow(this._window.findChildByName("allow_foodconsume_checkbox"));
         this.var_1406 = ICheckBoxWindow(this._window.findChildByName("allow_walk_through_checkbox"));
         this.var_927 = ICheckBoxWindow(this._window.findChildByName("hide_walls_checkbox"));
         this.var_2212 = this._window.findChildByName("hide_walls_text") as ITextWindow;
         this.var_1144 = IDropMenuWindow(this._window.findChildByName("wall_thickness"));
         this.var_1143 = IDropMenuWindow(this._window.findChildByName("floor_thickness"));
         this.var_3031 = IWindowContainer(this._window.findChildByName("thumbnail_container"));
         this.var_1404 = IWindowContainer(this._window.findChildByName("basic_settings_container"));
         this.var_1407 = IWindowContainer(this._window.findChildByName("advanced_settings_container"));
         this.var_2214 = IWindowContainer(this._window.findChildByName("switch_view_container"));
         this.var_1703 = IWindowContainer(this._window.findChildByName("footer_container"));
         this.var_266 = IWindowContainer(this._window.findChildByName("flat_controllers_container"));
         this.var_1410 = IWindowContainer(this._window.findChildByName("password_container"));
         this.var_1702 = ITextWindow(this._window.findChildByName("switch_view_text"));
         this.var_1702.mouseThreshold = 0;
         this.var_1702.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onSwitchView);
         this.var_1410.visible = false;
         if(!this.var_1704)
         {
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         this.var_2214.visible = this.var_1704;
         this.populateForm();
         if(this.var_926)
         {
            ...
            this.var_1407.height = Util.getLowestPoint(this.var_1407) + 4;
         }
         else
         {
            this.var_1404.visible = true;
            this.var_1703.visible = true;
            this.var_3031.visible = this.var_1704;
            this.var_1404.height = Util.getLowestPoint(this.var_1404) + 4;
         }
         this.var_1702.text = !!this.var_926 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(this._window,[this.var_1404.name,this.var_1407.name,this.var_1703.name,this.var_2214.name],0,0);
      ...
      private function populateForm() : void
      {
         ...
         this.var_928.setText(_loc1_.name);
         this.var_1405.setText(_loc1_.description);
         this.var_1142.setText("");
         this.var_1409.setText("");
         ...
         {
            case RoomSettingsData.const_234:
         ...
         this.setTag(this.var_1110,_loc1_.tags[0]);
         this.setTag(this.var_1111,_loc1_.tags[1]);
         if(this.var_1411)
         {
            if(_loc1_.allowPets)
            {
         ...
         if(this.var_1406)
         {
            ...
            {
               this.var_1406.select();
            }
            else
            {
               this.var_1406.unselect();
            }
         }
         if(!this.VIPFeaturesAllowed())
         {
            this.disableWindow(this.var_927);
            this.disableWindow(this.var_1144);
            this.disableWindow(this.var_1143);
            this.disableWindow(this.var_2212);
         }
         else
         {
            this.enableWindow(this.var_927);
            this.enableWindow(this.var_1144);
            this.enableWindow(this.var_1143);
            this.enableWindow(this.var_2212);
         }
         if(this.var_927)
         {
            if(_loc1_.hideWalls)
            ...
            {
               this.var_927.unselect();
            }
         }
         if(this.var_1144)
         {
            this.var_1144.selection = this.getThicknessSelectionIndex(_loc1_.wallThickness);
         }
         if(this.var_1143)
         {
            this.var_1143.selection = this.getThicknessSelectionIndex(_loc1_.floorThickness);
         }
         this.clearErrors();
      }
      ...
      {
         return this._navigator.sessionData.hasUserRight("fuse_hide_room_walls",HabboClubLevelEnum.const_37);
      }
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         _loc2_.name = this.var_928.getText();
         _loc2_.description = this.var_1405.getText();
         var _loc3_:ISelectorWindow = this._window.findChildByName("doormode") as ISelectorWindow;
         var _loc4_:IWindow = _loc3_.getSelected();
         switch(_loc4_.name)
         {
            case "doormode_doorbell":
               _loc2_.doorMode = RoomSettingsFlatInfo.const_234;
               break;
            case "doormode_password":
               _loc2_.doorMode = RoomSettingsFlatInfo.const_135;
               break;
            default:
               _loc2_.doorMode = RoomSettingsFlatInfo.const_619;
         }
         if(_loc2_.doorMode == RoomSettingsFlatInfo.const_135)
         {
            _loc8_ = this.var_1142.getText();
            _loc9_ = this.var_1409.getText();
            if(_loc8_ != _loc9_)
            {
               this.var_1142.clearErrors();
               this.var_1409.displayError("${navigator.roomsettings.invalidconfirm}");
               return;
            }
            if(_loc8_ != "")
            {
         ...
         _loc2_.allowPets = this.var_1411.isSelected;
         _loc2_.allowFoodConsume = this.var_1403.isSelected;
         _loc2_.allowWalkThrough = this.var_1406.isSelected;
         _loc2_.hideWalls = this.var_927.isSelected;
         _loc2_.wallThickness = this.var_1144.selection - 2;
         _loc2_.floorThickness = this.var_1143.selection - 2;
         _loc2_.tags = new Array();
         this.addTag(this.var_1110,_loc2_.tags);
         this.addTag(this.var_1111,_loc2_.tags);
         this.clearErrors();
         this.var_1408 = _loc2_.roomId;
      ...
      {
         Logger.log("[RoomSettingsCtrl.onDeleteButtonClick] " + this.var_430);
         if(this.var_57 == null)
         {
            return;
         }
         this._navigator.registerParameter("navigator.roomsettings.deleteroom.confirm.message","room_name",this.var_57.name);
         var _loc2_:ConfirmDialogView = new ConfirmDialogView(IFrameWindow(this._navigator.getXmlWindow("ros_room_delete_confirm")),this,this.onConfirmRoomDelete,[this.var_430]);
         _loc2_.show();
      }
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow(param1,"",HabboWindowType.const_72,HabboWindowStyle.const_29,HabboWindowParam.const_64,new Rectangle(0,0,100,20)));
      }
      ...
      private function onRemoveAllFlatCtrlsClick(param1:WindowEvent) : void
      {
         ...
         this._navigator.send(new RemoveAllRightsMessageComposer(this.var_430));
      }
