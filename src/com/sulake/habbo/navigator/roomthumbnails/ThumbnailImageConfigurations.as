package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class ThumbnailImageConfigurations
   {
      ...
      {
         this.var_2203 = new Dictionary();
         this.var_2202 = new Dictionary();
         super();
         this._navigator = param1;
         this.var_1852 = this._navigator.getButtonImage("rico_selected");
      ...
      {
         var _loc4_:ThumbnailImageConfiguration = new ThumbnailImageConfiguration(this._navigator,param1,param2,param3,this.var_1852);
      ...
      {
         var _loc2_:Dictionary = this.var_2202[param1];
         if(_loc2_ == null)
         {
            _loc2_ = new Dictionary();
            this.var_2202[param1] = _loc2_;
         }
         return _loc2_;
      }
      ...
      {
         var _loc2_:Array = this.var_2203[param1];
         if(_loc2_ == null)
         {
            _loc2_ = new Array();
            this.var_2203[param1] = _loc2_;
         }
         return _loc2_;
      }
   }
