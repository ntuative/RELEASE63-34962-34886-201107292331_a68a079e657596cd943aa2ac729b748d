package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1193:IDropMenuWindow;
      ...
      public function show() : void
      {
         ...
         this.var_36.connection.send(new GetModeratorRoomInfoMessageComposer(this.var_430));
         Logger.log("BEGINNING TO SHOW: " + this.var_430);
      }
      
      public function getType() : int
      {
         return WindowTracker.const_1769;
      }
      ...
      {
         Logger.log("GOT ROOM INFO: " + param1.flatId + ", " + this.var_430);
         if(param1.flatId != this.var_430)
         {
            Logger.log("NOT THE SAME FLAT: " + param1.flatId + ", " + this.var_430);
            return;
         }
         this._data = param1;
         this.populate();
      ...
      public function populate() : void
      {
         ...
         this.var_1193 = IDropMenuWindow(this._frame.findChildByName("msgTemplatesSelect"));
         this.prepareMsgSelect(this.var_1193);
         this.var_1193.procedure = this.onSelectTemplate;
         this.var_983 = ICheckBoxWindow(this._frame.findChildByName("kick_check"));
         this.var_1480 = ICheckBoxWindow(this._frame.findChildByName("lock_check"));
         this.var_1479 = ICheckBoxWindow(this._frame.findChildByName("changename_check"));
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,this._data.flatId),this.var_36,WindowTracker.const_960,this._data.flatId),this._frame,false,false,true);
      }
      ...
      private function act(param1:Boolean) : void
      {
         ...
         var _loc2_:int = this.determineAction(param1,this.var_983.isSelected);
         this.var_36.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1785,_loc2_,this.var_541.text,"",""));
         if(this.var_1480.isSelected || this.var_1479.isSelected || this.var_983.isSelected)
         {
            this.var_36.connection.send(new ModerateRoomMessageComposer(this._data.flatId,this.var_1480.isSelected,this.var_1479.isSelected,this.var_983.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1978);
         }
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1952);
      }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_36.initMsg.roomMessageTemplates[this.var_1193.selection];
         if(_loc3_ != null)
         {
            this.var_655 = false;
            this.var_541.text = _loc3_;
         }
      }
   }
}
