package com.sulake.habbo.moderation
{
   ...
   public class IssueManager
   {
      ...
      public static const const_1371:String = "issue_bundle_open";
      
      public static const const_1008:String = "issue_bundle_my";
      
      public static const const_1415:String = "issue_bundle_picked";
      
      public static const const_1836:int = 15000;
      ...
      public function IssueManager(param1:ModerationManager)
      {
         ...
         this.var_645 = new IssueBrowser(this,this.var_75.windowManager,this.var_75.assets);
         this.var_1216 = [];
         this.var_1217 = [];
         this.var_998 = new Map();
         this.var_2481 = parseInt(this.var_75.configuration.getKey("chf.score.updatefactor","60"));
         this.var_1843 = new Timer(const_1836,0);
         this.var_1843.addEventListener(TimerEvent.TIMER,this.updatePriorities);
         this.var_1843.start();
      }
      ...
      {
         var _loc4_:IssueBundle = this.var_122.getValue(param1) as IssueBundle;
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function autoPick(param1:Boolean = false, param2:int = 0) : void
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc3_:Array = this.var_122.getValues();
      ...
      public function releaseAll() : void
      {
         ...
         var _loc2_:* = [];
         for each(_loc3_ in this.var_122)
         {
      ...
      public function releaseBundle(param1:int) : void
      {
         ...
         var _loc2_:IssueBundle = this.var_122.getValue(param1) as IssueBundle;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      public function playSound(param1:IssueMessageData) : void
      {
         ...
         if(this.var_645 == null || !this.var_645.isOpen())
         {
            this.var_75.soundManager.playSound(HabboSoundTypesEnum.const_1247);
         }
      }
      ...
      public function updateIssue(param1:IssueMessageData) : void
      {
         ...
         if(_loc2_ != 0)
         {
            _loc3_ = this.var_122.getValue(_loc2_) as IssueBundle;
            if(_loc3_ != null)
            {
         ...
         if(param1.state == IssueMessageData.const_2002)
         {
            this._issues.remove(param1.issueId);
            return;
         }
         if(_loc3_ == null)
         {
            for each(_loc4_ in this.var_122)
            {
         ...
         {
            _loc6_ = this.getBundles(const_1008);
            _loc7_ = false;
      ...
      public function updatePriorities(param1:Event = null) : void
      {
         ...
         for each(_loc4_ in this._issues)
         {
            if(_loc4_ != null)
            {
               ...
               _loc4_.temporalPriority = int(_loc3_ / this.var_2481);
            }
         }
      ...
      {
         var _loc2_:IssueHandler = this.var_998.getValue(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.update();
         }
      ...
      {
         var _loc2_:* = this.var_998.remove(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            _loc2_ = null;
      ...
      public function handleBundle(param1:int) : void
      {
         ...
         this.var_998.add(param1,_loc3_);
      ...
      public function unhandleBundle(param1:int) : void
      {
         ...
         var _loc3_:IssueHandler = this.var_998.remove(param1);
         if(_loc3_ != null)
         {
            _loc3_.dispose();
         }
      ...
      {
         var _loc3_:IssueBundle = this.var_122.getValue(param1) as IssueBundle;
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function autoHandle(param1:int) : void
      {
         var _loc3_:* = null;
         var _loc5_:* = null;
         var _loc2_:Array = this.var_122.getValues();
      ...
      public function issuePickFailed(param1:Array) : Boolean
      {
         ...
         for each(_loc4_ in param1)
         {
            ...
            _loc8_ = null;
            for each(_loc9_ in this.var_122)
            {
            ...
            {
               _loc12_ = _loc8_.id;
               _loc13_ = this.var_998.getValue(_loc12_) as IssueHandler;
               if(_loc13_ != null)
               {
                  _loc13_.dispose();
               }
