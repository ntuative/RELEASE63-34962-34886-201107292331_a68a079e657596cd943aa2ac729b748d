package com.sulake.habbo.moderation
{
   ...
   public class IssueBundle
   {
      ...
      private var var_875:IssueMessageData = null;
      
      private var var_874:IssueMessageData = null;
      ...
      public function IssueBundle(param1:int, param2:IssueMessageData)
      {
         ...
         this.var_2842 = param2.pickerUserId;
         this.var_2868 = param2.pickerUserName;
         this.var_1561 = param2.reportedUserId;
      ...
      private function addIssue(param1:IssueMessageData) : void
      {
         ...
         this.var_1337 += param1.priority;
         if(param1.message != null && param1.message != "")
         {
            ++this.var_1336;
         }
         if(this.var_875 == null || param1.timeStamp < this.var_875.timeStamp)
         {
            this.var_875 = param1;
         }
         if(this.var_874 == null || param1.priority > this.var_874.timeStamp)
         {
            this.var_874 = param1;
         }
      }
      ...
      public function removeIssue(param1:int) : IssueMessageData
      {
         ...
         if(_loc2_ != null)
         {
            this.var_1337 -= _loc2_.priority;
            if(_loc2_.message != null && _loc2_.message != "")
            {
               --this.var_1336;
            }
            if(this.var_875 == _loc2_)
            {
               this.var_875 = null;
            }
            if(this.var_874 == _loc2_)
            {
               this.var_874 = null;
            }
         }
      ...
      public function getHighestPriorityIssue() : IssueMessageData
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         var _loc1_:IssueMessageData = this.var_874;
         if(_loc1_ == null)
         {
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IssueMessageData = this.var_875;
         if(_loc2_ == null)
         {
