package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_1017:Array = [];
      ...
      {
         this.var_815 = IWindowContainer(this.var_36.getXmlWindow("roomvisits_row"));
      ...
      {
         return WindowTracker.const_2054;
      }
      ...
      private function getRoomRowWindow() : IWindowContainer
      {
         if(false)
         {
            return var_1017.pop() as IWindowContainer;
         }
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_1524)
         {
