package com.sulake.habbo.moderation
{
   ...
   public class IssueListView
   {
      ...
      private static const const_700:int = 20;
      ...
      private var var_3128:BitmapData;
      
      private var var_3129:BitmapData;
      ...
      public function IssueListView(param1:IssueManager, param2:IssueBrowser, param3:IItemListWindow, param4:String)
      {
         ...
         this.var_1993 = this.var_645.createWindow(param4) as IWindowContainer;
      }
      ...
      public function update(param1:Array) : void
      {
         ...
         if(_loc4_ < _loc5_)
         {
            ...
            {
               _loc3_ = this.var_1993.clone() as IWindowContainer;
         ...
         for each(_loc7_ in param1)
         {
            ...
            if(_loc7_ == null || this.var_1993 == null)
            {
               return;
            }
            ...
            if(_loc11_ != null)
            {
               ...
               _loc13_ = this.var_645.assets.getAssetByName(_loc12_) as BitmapDataAsset;
