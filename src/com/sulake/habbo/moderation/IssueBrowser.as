package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_2379:String = "my_issues";
      
      private const const_2380:String = "open_issues";
      
      private const const_2378:String = "picked_issues";
      
      private const const_2402:String = "closed_issues";
      ...
      private var var_403:IIssueBrowserView;
      
      private var var_2055:IIssueBrowserView;
      
      private var var_2056:IIssueBrowserView;
      
      private var var_2054:PickedIssuesView;
      ...
      private function selectView(param1:String) : void
      {
         ...
         if(this.var_403 == _loc2_)
         {
            return;
         }
         if(this.var_403 != null)
         {
            this.var_403.visible = false;
         }
         this.var_403 = _loc2_;
         if(this.var_403 == null)
         {
         ...
         this.var_403.view.width = this.var_295.container.width;
         this.var_403.view.height = this.var_295.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_2379:
               if(this.var_2055 == null)
               {
                  this.var_2055 = new MyIssuesView(this.issueManager,this,this.var_295.container);
               }
               return this.var_2055;
            case this.const_2380:
               if(this.var_2056 == null)
               {
                  this.var_2056 = new OpenIssuesView(this.issueManager,this,this.var_295.container);
               }
               return this.var_2056;
            case this.const_2378:
               if(this.var_2054 == null)
               {
                  this.var_2054 = new PickedIssuesView(this.issueManager,this,this.var_295.container);
               }
