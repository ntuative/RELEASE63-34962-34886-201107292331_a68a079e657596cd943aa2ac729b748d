package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_429:AdImageRequest;
      
      private var var_1402:BitmapData = null;
      
      private var var_1400:BitmapData = null;
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_3028 = this._config.getKey("interstitial.enabled","com.sulake.habbo.communication.messages.incoming.inventory.furni") == "true";
         this.var_3030 = int(this._config.getKey("interstitial.interval","30000"));
         this.var_3029 = int(this._config.getKey("interstitial.show.time","5000"));
         this.var_2211 = int(this._config.getKey("interstitial.max.displays.flash","-1"));
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(this.var_265 != null && this.var_265.running)
         {
            this.var_265.reset();
            return false;
         }
         if(this.var_1401 == 0)
         {
            this.var_1401 = getTimer();
            return false;
         }
         if(this.var_2211 > 0 && this.var_2210 >= this.var_2211)
         {
            return false;
         }
         var _loc1_:int = getTimer() - this.var_1401;
         if(_loc1_ > this.var_3030)
         {
            ++this.var_2210;
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         this.var_1701 = _loc2_.imageUrl;
         this.var_3027 = _loc2_.clickUrl;
         this.var_1401 = getTimer();
         if(this.var_1701 != "")
         {
            _loc3_ = this.var_1701;
            ...
            {
               this.var_265 = new Timer(this.var_3029,1);
               this.var_265.addEventListener(TimerEvent.TIMER_COMPLETE,this.interstitialTimerComplete);
            }
            if(this.var_265.running)
            {
               this.var_265.reset();
            }
            this.var_265.start();
            _loc4_ = new URLRequest(this.var_1701);
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new InterstitialEvent(InterstitialEvent.const_649,param1.bitmapData,this.var_3027));
            this.var_1401 = getTimer();
         }
         else
         {
      ...
      private function stopInterstitial() : void
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new InterstitialEvent(InterstitialEvent.const_604));
         }
      }
      
      public function showRoomAd(param1:int, param2:int) : void
      {
         this.var_429 = new AdImageRequest(param1,param2);
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         if(this.var_429 != null && _loc2_.imageUrl != "" && _loc2_.clickUrl != "")
         {
            ...
            this.var_429 = new AdImageRequest(this.var_429.roomId,this.var_429.roomCategory,_loc2_.imageUrl,_loc2_.clickUrl);
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(this.isValidAdImage(_loc3_) && this.var_429 != null)
         {
            _loc4_ = this.emulateBackgroundTransparency(_loc3_.bitmapData);
            events.dispatchEvent(new AdEvent(AdEvent.const_557,this.var_429.roomId,this.var_429.roomCategory,_loc4_,_loc2_.assetName,this.var_429.clickURL,this.var_1402,this.var_1400));
            this.var_429 = null;
         }
      }
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            this.var_1402 = this.emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            this.var_1400 = this.emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      public function loadRoomAdImage(param1:int, param2:int, param3:int, param4:int, param5:String, param6:String) : void
      {
         ...
         var _loc8_:Array = this.var_747.getValue(_loc7_);
         if(_loc8_ == null)
         {
            _loc8_ = new Array();
            this.var_747.add(_loc7_,_loc8_);
         }
         if(_loc8_.length > 0)
         {
      ...
      private function onBillboardImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         var _loc2_:AssetLoaderStruct = param1.target as AssetLoaderStruct;
         var _loc3_:Bitmap = _loc2_.assetLoader.content as Bitmap;
         var _loc4_:Array = this.var_747.remove(_loc2_.assetName);
      ...
      private function dispatchImageAsset(param1:BitmapData, param2:int, param3:int, param4:int, param5:int, param6:String, param7:String) : void
      {
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_1021,param2,param3,param1,param6,param7,null,null,param4,param5));
         }
      }
      ...
      private function onBillboardImageLoadError(param1:AssetLoaderEvent) : void
      {
         var _loc4_:* = null;
         var _loc2_:AssetLoaderStruct = param1.target as AssetLoaderStruct;
         var _loc3_:Array = this.var_747.remove(_loc2_.assetName);
