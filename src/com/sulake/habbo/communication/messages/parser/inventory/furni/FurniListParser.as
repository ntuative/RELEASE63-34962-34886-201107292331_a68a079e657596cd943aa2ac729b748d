package com.sulake.habbo.communication.messages.parser.inventory.furni
{
   ...
   public class FurniListParser implements IMessageParser
   {
      ...
      protected var var_3074:String;
      
      protected var var_3075:int;
      
      protected var var_3073:int;
      
      protected var var_1714:Array;
      ...
      public function parse(param1:IMessageDataWrapper) : Boolean
      {
         ...
         this.var_3073 = param1.readInteger();
         this.var_1714 = new Array();
         var _loc2_:int = param1.readInteger();
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_)
         {
            this.var_1714.push(this.parseItem(param1));
            _loc3_++;
         }
         return true;
      }
