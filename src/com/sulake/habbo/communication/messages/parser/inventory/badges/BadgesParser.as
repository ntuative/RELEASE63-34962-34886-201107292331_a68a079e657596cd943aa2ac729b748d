   ...
   public class BadgesParser implements IMessageParser
   {
      ...
      public function parse(param1:IMessageDataWrapper) : Boolean
      {
         ...
         while(_loc5_ < _loc4_)
         {
            ...
            this.var_1389.add(_loc3_,_loc2_);
            this.var_2185.push(_loc3_);
            _loc5_++;
         }
         this.var_2184 = new Array();
      ...
      {
         return this.var_1389.getValue(param1);
      }
