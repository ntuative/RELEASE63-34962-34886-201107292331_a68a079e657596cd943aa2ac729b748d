package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private static const const_1565:String = "purse";
      
      private static const const_1564:String = "extra_tools";
      ...
      private var var_678:ExtraToolsExtension;
      
      private var _connection:IConnection;
      
      private var _catalog:IHabboCatalog;
      
      private var var_1271:PurseExtension;
      ...
      private var var_677:ExtensionView;
      ...
      private function onCommunicationManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this._connection = this.var_283.getHabboMainConnection(null);
         this.tryInitialize();
      }
      ...
      {
         if(this.var_283 && this._windowManager && this._config && this._localization && this.var_12 && this._catalog)
         {
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         if(this._config && this._config.getKey("client.logout.enabled","com.sulake.habbo.communication.messages.incoming.inventory.furni") == "true")
         {
            this.var_677 = new ExtensionView(this._windowManager,this._assetLibrary,this);
            if(this.var_677)
            {
               this.var_1271 = new PurseExtension(this._windowManager,this._assetLibrary,this._config,this._catalog,this.var_12,this._localization);
               this.var_678 = new ExtraToolsExtension(this,this._windowManager,this._assetLibrary,events,this._config);
               ...
               this.var_677.attachExtension(const_1565,this.var_1271.window,ExtensionFixedSlotsEnum.const_1861);
               this.var_677.attachExtension(const_1564,this.var_678.window,ExtensionFixedSlotsEnum.const_1854);
            }
         }
         if(this._view == null)
         {
      ...
      private function toolbarExtensionVisible(param1:Boolean) : void
      {
         ...
         if(param1)
         {
            this.var_678.showRoomInfo();
         }
         else
         {
            this.var_678.hideRoomInfo();
         }
      }
