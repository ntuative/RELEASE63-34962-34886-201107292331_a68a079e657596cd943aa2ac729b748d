package com.sulake.habbo.toolbar.extensions
{
   ...
   public class ClubDiscountPromoExtension
   {
      ...
      private static const const_699:String = "club_promo";
      
      private static const const_1567:int = 13;
      
      private static const const_1097:int = 14;
      
      private static const const_1566:uint = 16777215;
      
      private static const const_1568:uint = 12247545;
      ...
      private var var_677:IExtensionView;
      ...
      public function ClubDiscountPromoExtension(param1:HabboToolbar, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IEventDispatcher, param5:IHabboConfigurationManager, param6:ICoreLocalizationManager, param7:IHabboInventory, param8:IHabboCatalog, param9:IConnection)
      {
         ...
         this.var_677 = param1.extensionView;
         if(this.var_12)
         {
            this.var_12.events.addEventListener(HabboInventoryHabboClubEvent.const_323,this.onClubChanged);
         }
      }
      ...
      private function createWindow(param1:IAssetLibrary, param2:IHabboWindowManager) : IWindowContainer
      {
         ...
         if(_loc4_)
         {
            ...
            if(_loc3_)
            {
               this.var_86 = _loc3_.findChildByName("flashing_animation") as IBitmapWrapperWindow;
               if(this.var_86)
               {
                  _loc5_ = this._assets.getAssetByName("extend_hilite_png") as IAsset;
                  if(_loc5_)
                  {
                     this.var_833 = _loc5_.content as BitmapData;
                     if(this.var_833)
                     {
                        this.var_86.bitmap = this.var_833.clone();
                     }
                  }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            if(this.var_677)
            {
               this.var_677.detachExtension(const_699);
               this.var_677 = null;
            }
            this.animate(false);
            this.clearAnimation();
            ...
            if(this.var_12)
            {
               this.var_12.events.removeEventListener(HabboInventoryHabboClubEvent.const_323,this.onClubChanged);
               this.var_12 = null;
            }
            this._catalog = null;
      ...
      private function onTextRegionClicked(param1:WindowMouseEvent) : void
      {
         if(this._connection)
         {
            if(this.var_12.clubLevel == HabboClubLevelEnum.const_37)
            {
      ...
      private function onClubChanged(param1:HabboInventoryHabboClubEvent) : void
      {
         if(this.var_12.clubIsExpiring && !this._view && this.isExtensionEnabled())
         {
            ...
            this.assignState();
            this.var_677.attachExtension(const_699,this._view,ExtensionFixedSlotsEnum.const_2045);
         }
         else
         {
            this.var_677.detachExtension(const_699);
      ...
      {
         if(this.var_12.clubLevel == HabboClubLevelEnum.const_37 && this._config.getBoolean("club.membership.extend.vip.promotion.enabled",false))
         {
            return true;
         }
      ...
      private function animate(param1:Boolean) : void
      {
         if(param1)
         {
            ...
            this.var_680 = new Timer(15000);
            this.var_680.addEventListener(TimerEvent.TIMER,this.onTriggerTimer);
            this.var_680.start();
         }
         else
         {
      ...
      private function resetAnimationVariables() : void
      {
         ...
         this.var_86.y = 3;
         this.var_86.bitmap = this.var_833.clone();
         this.var_86.height = this._view.height - 6;
         this.var_86.width = this.var_86.bitmap.width;
         this.var_86.invalidate();
         this.var_1959 = this._view.width - 7 - this.var_86.bitmap.width;
         this.var_1558 = 0;
      }
      
      private function startAnimationTimer() : void
      {
         this.var_690 = new Timer(25,26);
      ...
      private function onAnimationTimer(param1:TimerEvent) : void
      {
         var _loc2_:int = 0;
         var _loc3_:* = null;
         this.var_86.x = 3 + this.var_1558 / 20 * this.var_1959;
         if(this.var_86.x > this.var_1959)
         {
            _loc2_ = this._view.width - 4 - this.var_86.x;
            _loc3_ = new BitmapData(_loc2_,this.var_833.height);
            _loc3_.copyPixels(this.var_833,new Rectangle(0,0,_loc2_,this.var_833.height),new Point(0,0));
            this.var_86.bitmap = _loc3_;
            this.var_86.width = _loc2_;
         }
         this.var_86.invalidate();
         ++this.var_1558;
      }
