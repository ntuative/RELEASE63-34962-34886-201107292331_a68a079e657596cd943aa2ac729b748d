package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private static const const_1465:Point = new Point(3,3);
      
      private static const const_1557:uint = 7433577;
      
      private static const const_1556:uint = 5723213;
      
      private static const const_479:String = "_hover";
      
      private static const const_477:String = "_normal";
      
      private static const const_478:int = 5;
      
      private static const const_1562:int = 600;
      
      private static const const_1555:int = 80;
      
      private static const const_1561:int = 74;
      
      private static const ICON_SPACING_NORMAL:int = 10;
      
      private static const const_1559:int = -2;
      
      private static const const_1558:int = 5;
      
      private static const const_1560:int = 10;
      ...
      public function ToolbarView(param1:HabboToolbar, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IConnection, param5:IHabboCatalog, param6:IEventDispatcher, param7:IHabboConfigurationManager)
      {
         ...
         this._window.position = const_1465;
         this._window.addEventListener(WindowEvent.const_569,this.onParentResized);
         ...
         {
            this.setIconHoverState(_loc11_,const_477);
         }
         ...
         this.var_220 = param2.buildFromXML(_loc12_.content as XML,2) as IWindowContainer;
         ...
         _loc13_.addChild(this.var_220);
         var _loc14_:ITextWindow = this.var_220.findChildByName("new_textfield") as ITextWindow;
         ...
         this.var_220.x = _loc13_.width - this.var_220.width - const_478;
         this.var_220.y = const_478;
         this.var_2614 = this.isNewItemsNotificationEnabled();
      ...
      private function checkSize(param1:Boolean = false) : void
      {
         ...
         var _loc2_:* = this._windowManager.getDesktop(2).height < const_1562;
         if(!param1 && _loc2_ == this.var_1548)
         {
            return;
         }
         this.var_1548 = _loc2_;
         var _loc3_:int = !!_loc2_ ? int(const_1561) : int(const_1555);
         var _loc4_:int = !!_loc2_ ? int(const_1559) : int(ICON_SPACING_NORMAL);
         ...
         while(_loc7_ < _loc5_.length)
         {
            ...
            _loc6_.y = const_1558 + _loc7_ * (_loc3_ + _loc4_);
            _loc7_++;
         }
         this._window.height = _loc6_.rectangle.bottom + const_1560;
      }
      ...
      private function onCatalogEvent(param1:CatalogEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case CatalogEvent.CATALOG_NEW_ITEMS_SHOW:
               if(this.var_220 != null && this.var_2614)
               {
      ...
      public function setToolbarState(param1:String) : void
      {
         ...
         switch(param1)
         {
            case HabboToolbarEnum.const_1025:
               _loc3_ = false;
               break;
            case HabboToolbarEnum.const_955:
               _loc3_ = true;
         }
      ...
      private function onIconHoverMouseEvent(param1:WindowMouseEvent) : void
      {
         ...
         switch(param1.type)
         {
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
               this.setIconHoverState(_loc4_,const_479);
               this.setIconBgHoverState(_loc3_,const_479);
               break;
      ...
      private function setIconHoverState(param1:IBitmapWrapperWindow, param2:String) : void
      {
         ...
         {
            _loc4_ = param2 == const_479 ? this.var_1546 : this.var_1547;
         }
         else
         {
      ...
      public function getIconVerticalLocation(param1:String) : int
      {
         switch(param1)
         {
            case HabboToolbarIconEnum.NAVIGATOR:
               return !!this.var_1548 ? 45 : 50;
            case HabboToolbarIconEnum.QUESTS:
               return !!this.var_1548 ? 125 : 140;
            default:
               return 0;
         }
      }
      ...
      private function setMeMenuIconBitmaps(param1:BitmapData) : void
      {
         ...
         this.var_1547 = this.addShadow(param1,new Point(2,3),4280426782);
         if(this.var_1546)
         {
            this.var_1546.dispose();
         }
         this.var_1546 = this.addShadow(param1,new Point(4,5),4281150249);
         param1.dispose();
      }
      ...
      public function getUnseenItemCounter(param1:String) : IWindowContainer
      {
         ...
         var _loc2_:IWindowContainer = this.var_1032.getValue(param1) as IWindowContainer;
         if(!_loc2_)
         {
            ...
            _loc2_.y = const_478;
            this.var_1032.add(param1,_loc2_);
         }
         return _loc2_;
      }
      ...
      {
         return this._config.getKey("toolbar.new_additions.notification.enabled","com.sulake.habbo.communication.messages.incoming.inventory.furni") == "true";
      }
   }
}
