package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener, IUpdateReceiver
   {
      ...
      private static const const_704:uint = 1;
      ...
      private var var_1264:IRoomSession;
      ...
      private var var_229:CatalogViewer;
      
      private var var_254:ICatalogNavigator;
      ...
      private var var_228:ChargeConfirmationDialog;
      ...
      private var var_2812:Boolean = true;
      
      private var var_2815:Boolean = true;
      
      private var var_2066:Boolean = false;
      
      private var var_2814:GiftWrappingConfiguration;
      
      private var var_1323:ClubGiftController;
      
      private var var_583:ClubBuyController;
      
      private var var_856:ClubExtendController;
      
      private var var_858:Map;
      
      private var var_1322:Boolean = false;
      
      private var var_857:IPurchasableOffer;
      
      private var var_1605:IDragAndDropDoneReceiver;
      ...
      private var var_710:RoomPreviewer;
      
      private const const_2106:Point = new Point(100,20);
      ...
      public function showPurchaseConfirmation(param1:IPurchasableOffer, param2:int, param3:String = "", param4:Boolean = true) : void
      {
         ...
         if(param1 is Offer)
         {
            ...
            {
               this.var_199 = new PurchaseConfirmationDialog(this._localization);
            }
            _loc5_ = [];
            ...
            this.var_199.showOffer(this,this._roomEngine,param1,param2,param3,_loc5_);
            if(param4)
            {
         ...
         {
            this.var_583.showConfirmation(param1 as ClubBuyOfferData,param2);
         }
      }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_2813 = this.isNewItemsNotificationEnabled();
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_145,this.onObjectPlaced);
         this.initializeRoomPreviewer();
      }
      ...
      {
         if(this._roomEngine != null && this.var_159 != null && this.var_159.getKey("catalog.furniture.animation","com.sulake.habbo.communication.messages.incoming.inventory.furni") == "true")
         {
            if(this.var_710 == null)
            {
               this.var_710 = new RoomPreviewer(this._roomEngine);
            }
         }
      }
      ...
      {
         return this.var_159.getBoolean("toolbar.new_additions.notification.enabled",false);
      }
      ...
      public function openCatalogPage(param1:String, param2:Boolean = false) : void
      {
         ...
         if(!this.var_841 || !this.var_254 || !this.var_254.isInitialized())
         {
            this.toggleCatalog(true);
            this.var_1076 = -1;
            this.var_855 = param1;
      ...
      public function openCatalogPageById(param1:int, param2:int) : void
      {
         ...
         {
            this.toggleCatalog(true);
            this.var_254.openPageById(param1,param2);
         }
         else
         {
            this.toggleCatalog();
      ...
      public function openCreditsHabblet() : void
      {
         ...
         var _loc1_:* = this.var_159.getKey("client.credits.embed.enabled","com.sulake.habbo.communication.messages.incoming.inventory.furni") == "true";
         if(false && _loc1_)
         {
         ...
         {
            _loc2_ = this.var_159.getKey("link.format.credits","/credits");
      ...
      {
         var _loc2_:Array = this.var_858.getValue(param1);
         if(_loc2_ != null)
         {
            return _loc2_.slice();
         }
      ...
      private function getCurrentLayoutCode() : String
      {
         ...
         return this.var_229.getCurrentLayoutCode();
      }
      ...
      private function createCatalogNavigator() : void
      {
         ...
         this.var_254 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      private function createCatalogViewer() : void
      {
         ...
         this.var_229 = new CatalogViewer(this,_loc1_,this._roomEngine);
         this.var_229.habboCatalog = this;
      }
      
      private function createMainWindow() : void
      {
         var _loc1_:String = "catalog";
         if(this.var_159.getBoolean("catalog.show.purse",false))
         {
            _loc1_ = "catalog_with_purse";
         }
         var _loc2_:XmlAsset = assets.getAssetByName(_loc1_) as XmlAsset;
         this._mainContainer = this._windowManager.buildFromXML(_loc2_.content as XML,const_704) as IWindowContainer;
         this._mainContainer.tags.push("habbo_catalog");
         this._mainContainer.position = this.const_2106;
         this.hideMainWindow();
         ...
         _loc4_.setParamFlag(WindowParam.const_255,false);
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_71:
               this.var_2066 = param1.session.isPrivateRoom;
               this.var_1264 = param1.session;
               if(this.var_106 != null)
               {
      ...
      private function createClubGiftController() : void
      {
         ...
         {
            this.var_1323 = new ClubGiftController(this);
         }
      }
      ...
      private function createClubBuyController() : void
      {
         if(this.var_583 == null)
         {
            this.var_583 = new ClubBuyController(this);
         }
      }
      ...
      private function createClubExtendController() : void
      {
         if(this.var_856 == null)
         {
            this.var_856 = new ClubExtendController(this);
         }
      }
      ...
      private function onWindowClose(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_229 != null)
         {
            this.var_229.catalogWindowClosed();
         }
         if(this.var_106 != null && this.getCurrentLayoutCode() == "recycler")
         {
            this.var_106.cancel();
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         this.var_1606 = (param1 as CatalogIndexMessageEvent).newAdditionsAvailable;
         this.var_254.buildCatalogIndex(_loc2_);
         if(this.var_855 && this.var_855 != "")
         {
            this.var_254.openPage(this.var_855);
            this.var_855 = "";
            this.var_1076 = -1;
         }
         else if(this.var_1076 > -1)
         {
            this.var_254.openPageById(this.var_1076,this.var_2065);
            this.var_1076 = -1;
            this.var_2065 = -1;
            this.var_855 = "";
         }
         else if(this.var_1606 && this.var_2813)
         {
            events.dispatchEvent(new CatalogEvent(CatalogEvent.CATALOG_NEW_ITEMS_SHOW));
            this.var_254.loadNewAdditionsPage(this.getLocalizedPageName(CatalogPageName.const_1874));
         }
         else
         {
            this.var_254.loadFrontPage();
         }
      }
      ...
      private function onCatalogPage(param1:IMessageEvent) : void
      {
         ...
         this.var_229.showCatalogPage(_loc4_,_loc5_,_loc8_,_loc3_.offers,_loc9_);
      }
      ...
      {
         if(param1 == null || this.var_229 == null)
         {
            return;
         }
         var _loc2_:ApproveNameMessageParser = param1.getParser();
         this.var_229.dispatchWidgetEvent(new CatalogWidgetApproveNameResultEvent(_loc2_.result,_loc2_.nameValidationInfo));
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2812 && this._soundManager != null)
         {
            this._soundManager.playSound(HabboSoundTypesEnum.const_1357);
         }
         this.var_2812 = false;
         if(this.var_228 != null && !this.var_228.disposed)
         {
            this.var_228.refresh();
         }
         events.dispatchEvent(new PurseEvent(PurseEvent.const_133,this.var_116.credits));
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2815 && this._soundManager != null)
         {
            this._soundManager.playSound(HabboSoundTypesEnum.const_1382);
         }
         this.var_2815 = false;
         if(this.var_228 != null && !this.var_228.disposed)
         {
         ...
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_361,_loc2_.amount));
         }
         if(_loc2_.type == ActivityPointTypeEnum.const_834)
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_326,_loc2_.amount));
         }
         events.dispatchEvent(new PurseUpdateEvent());
      }
      ...
      private function onActivityPoints(param1:IMessageEvent) : void
      {
         ...
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_361,_loc2_.points["null"]));
         }
         if(_loc2_.points["null"] != null)
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_326,_loc2_.points["null"]));
         }
         events.dispatchEvent(new PurseUpdateEvent());
      }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         this.var_116.isExpiring = _loc2_.responseType == ScrSendUserInfoMessageParser.const_1376 ? true : false;
         this.updatePurse();
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         this.var_1323.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         this.var_2814 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function onChargeInfo(param1:ChargeInfoMessageEvent) : void
      {
         ...
         if(this.var_228 == null || this.var_228.disposed)
         {
            this.var_228 = new ChargeConfirmationDialog(this,this._localization);
         }
         this.var_228.showChargeInfo(_loc2_);
      }
      ...
      private function onSellableBreeds(param1:SellablePetBreedsMessageEvent) : void
      {
         ...
         this.var_858.remove(_loc2_.productCode);
         var _loc3_:Array = _loc2_.sellableBreeds;
         if(_loc3_ != null)
         {
            this.var_858.add(_loc2_.productCode,_loc3_.slice());
            this.var_229.dispatchWidgetEvent(new CatalogWidgetSellablePetBreedsEvent(_loc2_.productCode,_loc3_.slice()));
         }
      }
      ...
      private function noCreditsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:WindowEvent) : void
      {
         ...
         {
            if(false && "true" == this.var_159.getKey("client.credits.embed.enabled"))
            {
               ExternalInterface.call("FlashExternalInterface.openHabblet","credits");
            }
            else
            {
               _loc3_ = this.var_159.getKey("link.format.credits");
               if(_loc3_ != "")
               {
                  this._windowManager.alert("${catalog.alert.external.link.title}","${catalog.alert.external.link.desc}",0,this.onExternalLink);
      ...
      private function noPixelsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:WindowEvent) : void
      {
         ...
         if(param2.type == WindowEvent.const_156)
         {
            _loc3_ = this.var_159.getKey("link.format.pixels");
            if(_loc3_ != "")
            {
               this._windowManager.alert("${catalog.alert.external.link.title}","${catalog.alert.external.link.desc}",0,this.onExternalLink);
               HabboWebTools.navigateToURL(_loc3_,"habboMain");
      ...
      {
         if(!this.var_159.keyExists("catalog.drag_and_drop") || this.var_159.getKey("catalog.drag_and_drop") != "true")
         {
            return false;
         }
         if(!this.var_1264 || !this.var_1264.isRoomOwner)
         {
            return false;
         }
      ...
      {
         var _loc3_:String = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_230);
         var _loc4_:String = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_231);
         var _loc5_:String = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_211);
      ...
      private function onObjectPlaced(param1:RoomEngineObjectPlacedEvent) : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         if(this.var_1322 && param1.type == RoomEngineObjectEvent.const_145)
         {
            this.resetPlacedOfferData(true);
            if(this.var_857 == null || this.var_857.disposed)
            {
               this.resetObjectMover();
               return;
            }
            _loc2_ = param1.category;
            _loc3_ = this.var_857.productContainer.firstProduct;
            _loc4_ = false;
            ...
            this.var_65 = new PlacedObjectPurchaseData(param1.roomId,param1.roomCategory,param1.objectId,param1.category,param1.wallLocation,param1.x,param1.y,param1.direction,this.var_857);
            _loc5_ = this.var_1605;
            if(_loc5_ != null)
            {
            ...
            if(_loc6_)
            {
               _loc6_.getModelController().setNumber(RoomObjectVariableEnum.const_351,0.5);
            }
         }
      }
            ...
            if(this.var_65.roomCategory == this._roomEngine.activeRoomCategory && this.var_65.roomId == this._roomEngine.activeRoomId)
            {
               ...
               switch(param1.category)
               {
                  case FurniCategory.const_357:
                     _loc8_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_231);
                  ...
                  case FurniCategory.const_365:
                     _loc9_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_230);
                  ...
                  case FurniCategory.const_375:
                     _loc10_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_211);
      ...
      private function retrievePreviewAsset(param1:String, param2:Function) : void
      {
         ...
         var _loc3_:String = this.var_159.getKey("image.library.catalogue.url");
      ...
      private function showMainWindow() : void
      {
         ...
         {
            _loc1_ = this._windowManager.getDesktop(const_704);
            if(_loc1_ != null)
            {
      ...
      public function update(param1:uint) : void
      {
         if(this.var_710 != null)
         {
            this.var_710.updatePreviewRoomView();
         }
      }
   }
}
