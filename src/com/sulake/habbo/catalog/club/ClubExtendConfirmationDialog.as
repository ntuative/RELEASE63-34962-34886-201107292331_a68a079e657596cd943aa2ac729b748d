package com.sulake.habbo.catalog.club
{
   ...
   public class ClubExtendConfirmationDialog
   {
      ...
      private static const const_1745:String = "your_price_icon";
      
      private static const const_1748:String = "http://images.habbo.com/c_images/catalogue/vip_extend_tsr.png";
      
      private static const const_1746:String = "image/png";
      
      private static const const_1749:int = 2000;
      
      private static const const_1750:int = 75;
      
      private static const const_1747:uint = 0;
      ...
      private var var_753:IRegionWindow;
      
      private var var_750:ITextWindow;
      
      private var var_431:IBitmapWrapperWindow;
      ...
      private var var_359:String = "catalog.club.extend.";
      ...
      public function ClubExtendConfirmationDialog(param1:ClubExtendController, param2:ClubOfferExtendData)
      {
         ...
         this.var_27 = param1;
         this.var_104 = param2;
         this.var_751 = new Vector.<BitmapData>(const_393);
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_753)
         {
            this.var_753.removeEventListener(WindowMouseEvent.const_25,this.onMouseOutLaterRegion);
            this.var_753.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER,this.onMouseOverLaterRegion);
            this.var_753 = null;
         }
         if(this.var_750)
         {
      ...
      public function showConfirmation() : void
      {
         ...
         if(!this.var_104.vip)
         {
            ...
            if(_loc9_)
            {
               _loc9_.style = HabboIconType.const_1386;
               _loc9_.x += 15;
            }
         }
         ...
         this._view.title.caption = _loc1_.getKey(this.var_359 + "confirm.caption");
         this._view.findChildByName("extend_title").caption = _loc1_.getKey(this.var_359 + "confirm.title");
         this._view.findChildByName("normal_price_label").caption = _loc1_.getKey(this.var_359 + "normal.label");
         this._view.findChildByName("you_save_label").caption = _loc1_.getKey(this.var_359 + "save.label");
         this._view.findChildByName("your_price_label").caption = _loc1_.getKey(this.var_359 + "price.label");
         this._view.findChildByName("buy_now_button").caption = _loc1_.getKey(this.var_359 + "buy.button");
         this._view.findChildByName("maybe_later_link").caption = _loc1_.getKey(this.var_359 + "later.link");
         if(this.var_104.subscriptionDaysLeft > 1)
         {
            _loc1_.registerParameter(this.var_359 + "expiration_days_left","day",this.var_104.subscriptionDaysLeft.toString());
            _loc2_ = _loc1_.getKey(this.var_359 + "expiration_days_left");
         }
         else
         {
            _loc2_ = _loc1_.getKey(this.var_359 + "expires_today");
         }
         this._view.findChildByName("offer_expiration").caption = _loc2_;
         this.var_753 = this._view.findChildByName("maybe_later_region") as IRegionWindow;
         this.var_750 = this._view.findChildByName("maybe_later_link") as ITextWindow;
         if(!this.var_753 || !this.var_750)
         {
            return;
         }
         this.var_753.addEventListener(WindowMouseEvent.const_25,this.onMouseOutLaterRegion);
         this.var_753.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER,this.onMouseOverLaterRegion);
         ...
         _loc4_.height = 144;
         _loc4_.width = 133;
         this.loadAssetFromUrl("club_teaser","club_teaser",const_1748,const_1746,this.onTeaserLoaded);
         ...
         this.var_431 = this._view.findChildByName(const_1745) as IBitmapWrapperWindow;
      ...
      private function onMouseOutLaterRegion(param1:WindowMouseEvent) : void
      {
         if(this.var_750)
         {
            this.var_750.textColor = const_1747;
         }
      }
      ...
      private function onMouseOverLaterRegion(param1:WindowMouseEvent) : void
      {
         if(this.var_750)
         {
            this.var_750.textColor = LINK_COLOR_HOVER;
         }
      }
      ...
      private function startAnimation() : void
      {
         ...
         this.var_931 = new Timer(const_1749);
         this.var_931.addEventListener(TimerEvent.TIMER,this.onAnimationTrigger);
         this.var_931.start();
      }
      ...
      private function setAnimationFrame() : void
      {
         ...
         if(this.var_431.bitmap)
         {
            this.var_431.bitmap.dispose();
         }
         if(this.var_752 < const_393)
         {
            this.var_431.bitmap = new BitmapData(this.var_431.width,this.var_431.height,true,0);
            this.var_431.bitmap.copyPixels(this.var_751[this.var_752],this.var_751[this.var_752].rect,new Point(0,0));
         }
         else
         {
            Logger.log("Animation frame " + this.var_752);
         }
      }
      
      private function startAnimationFrame() : void
      {
         this.var_508 = new Timer(const_1750,const_393 - 1);
         this.var_508.addEventListener(TimerEvent.TIMER,this.onAnimationFrame);
         this.var_508.addEventListener(TimerEvent.TIMER_COMPLETE,this.onAnimationFrameComplete);
         this.var_508.start();
      }
