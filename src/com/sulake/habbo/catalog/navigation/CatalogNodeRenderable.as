package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static const const_1509:Number = 4285716709;
      
      private static var _listSubItemWindowLayout:XML;
      
      private static var var_1513:XML;
      
      private static var var_1511:XML;
       
      
      private var var_1866:Number = 4.294967295E9;
      
      private var _icon:BitmapData;
      
      private var _window:IWindowContainer;
      
      private var var_3096:IWindowContainer;
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(this.var_1866 == 4294967295)
            {
               this.var_1866 = _loc1_.color;
            }
            _loc1_.color = const_1509;
         }
      }
      ...
      override public function open() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1949;
            }
         }
      }
      ...
      override public function close() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_2050;
            }
         }
      }
      ...
      {
         this.var_67 = navigator.catalog.windowManager.buildFromXML(var_1511) as IItemListWindow;
         if(this.var_67 == null)
         {
      ...
      private function createWindow() : void
      {
         if(depth == 1)
         {
            this._window = navigator.catalog.windowManager.buildFromXML(var_1513) as IWindowContainer;
         }
         else
         {
