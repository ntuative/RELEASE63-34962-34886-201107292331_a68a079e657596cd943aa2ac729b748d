package com.sulake.habbo.catalog.viewer
{
   ...
   public class RoomPreviewer
   {
      ...
      private static const const_236:int = 1;
      
      private static const const_65:int = 1;
      ...
      private static const const_1608:int = 64;
      
      private static const const_1607:int = 32;
      
      private static const const_1606:int = 2500;
      ...
      public function RoomPreviewer(param1:IRoomEngine)
      {
         ...
         {
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_197,this.onRoomObjectAdded);
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_796,this.onRoomObjectAdded);
      ...
      public function dispose() : void
      {
         ...
         {
            this._roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_197,this.onRoomObjectAdded);
            this._roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_796,this.onRoomObjectAdded);
      ...
      public function reset() : void
      {
         ...
         if(this._roomEngine != null)
         {
            ...
            this._roomEngine.disposeObjectFurniture(const_50,const_49,const_65);
            this._roomEngine.disposeObjectWallItem(const_50,const_49,const_65);
            this._roomEngine.disposeObjectUser(const_50,const_49,const_65);
            this.updatePreviewRoomView();
            this._roomEngine.setActiveRoom(_loc1_,_loc2_);
         }
         this.var_346 = RoomObjectCategoryEnum.const_155;
      }
      ...
      public function addFurnitureIntoRoom(param1:int, param2:IVector3d) : int
      {
         ...
         if(this._roomEngine != null)
         {
            if(this.var_346 == RoomObjectCategoryEnum.const_27 && this.var_1319 == param1)
            {
               return const_65;
            }
            this.reset();
            ...
            this._roomEngine.setActiveRoom(const_50,const_49);
            if(this._roomEngine.addObjectFurniture(const_50,const_49,const_65,param1,new Vector3d(const_702,const_703,0),param2,0,""))
            {
               this.var_1315 = getTimer();
               this.var_1317 = true;
               _loc3_ = const_65;
               this.updatePreviewRoomView();
            }
      ...
      public function addWallItemIntoRoom(param1:int, param2:IVector3d, param3:String) : int
      {
         if(this._roomEngine != null)
         {
            if(this.var_346 == RoomObjectCategoryEnum.const_26 && this.var_1319 == param1 && this.var_1602 == param3)
            {
               return const_65;
            }
            this.reset();
            ...
            if(this._roomEngine.addObjectWallItem(const_50,const_49,const_65,param1,new Vector3d(0.5,2.3,1.8),param2,0,param3))
            {
               this.var_1315 = getTimer();
               this.var_1317 = true;
               return const_65;
      ...
      public function addAvatarIntoRoom(param1:String, param2:int) : int
      {
         if(this._roomEngine != null)
         {
            ...
            if(this._roomEngine.addObjectUser(const_50,const_49,const_65,new Vector3d(const_702,const_703,0),new Vector3d(90,0,0),135,1,param1))
            {
               this.var_1315 = getTimer();
               this.var_1317 = true;
               this._roomEngine.updateObjectUserGesture(const_50,const_49,const_65,1);
               this._roomEngine.updateObjectUserEffect(const_50,const_49,const_65,param2);
               this._roomEngine.updateObjectUserPosture(const_50,const_49,const_65,"std");
            }
            return const_65;
         }
         return -1;
      ...
      public function changeRoomObjectState() : void
      {
         if(this._roomEngine != null)
         {
            ...
            {
               this._roomEngine.changeObjectState(const_50,const_49,const_65,this.var_346);
            }
         }
      }
      ...
      private function checkAutomaticRoomObjectStateChange() : void
      {
         ...
         {
            _loc1_ = getTimer();
            if(_loc1_ > this.var_1315 + const_1606)
            {
               this.var_1315 = _loc1_;
               if(this._roomEngine != null)
               {
                  this._roomEngine.changeObjectState(const_50,const_49,const_65,this.var_346);
               }
      ...
      public function getRoomCanvas(param1:int, param2:int) : DisplayObject
      {
         ...
         if(this._roomEngine != null)
         {
            _loc3_ = this._roomEngine.createRoomCanvas(const_50,const_49,const_236,param1,param2,this.var_1316);
            this._roomEngine.setRoomCanvasMask(const_50,const_49,const_236,true);
            _loc4_ = this._roomEngine.getRoomCanvasGeometry(const_50,const_49,const_236);
            if(_loc4_ != null)
            {
               _loc4_.adjustLocation(new Vector3d(const_702,const_703,0),30);
            }
      ...
      {
         var _loc3_:* = null;
         var _loc2_:Rectangle = this._roomEngine.getRoomObjectBoundingRectangle(const_50,const_49,const_65,this.var_346,const_236);
         if(_loc2_ != null && param1 != null)
         {
            _loc2_.offset(-(this.var_1318 >> 1),-(this.var_1074 >> 1));
            ...
            else
            {
               ...
               if(_loc3_.width - this.var_50.width > this.var_1318 - this.var_50.width >> 1 || _loc3_.height - this.var_50.height > this.var_1074 - this.var_50.height >> 1 || this.var_50.width < 1 || this.var_50.height < 1)
               {
                  this.var_50 = _loc3_;
               }
            }
      ...
      private function validatePreviewSize(param1:Point) : Point
      {
         ...
         var _loc2_:IRoomGeometry = this._roomEngine.getRoomCanvasGeometry(const_50,const_49,const_236);
         if(this.var_50.width > this.var_1318 * (1 + const_483) || this.var_50.height > this.var_1074 * (1 + const_483))
         {
            if(_loc2_.isZoomedIn())
            {
               _loc2_.performZoomOut();
               this.var_1316 = const_1607;
               this.var_2057 = true;
               param1.x >>= 1;
               param1.y >>= 1;
               this.var_50.left >>= 2;
         ...
         else if(this.var_50.width << 1 < this.var_1318 * (1 + const_483) - 5 && this.var_50.height << 1 < this.var_1074 * (1 + const_483) - 5)
         {
            if(!_loc2_.isZoomedIn() && !this.var_2057)
            {
               _loc2_.performZoomIn();
               this.var_1316 = const_1608;
               param1.x <<= 1;
               param1.y <<= 1;
            }
         }
      ...
      private function getCanvasOffset(param1:Point) : Point
      {
         ...
         var _loc4_:* = this.var_1074 - this.var_50.height >> 1;
         if(_loc4_ > 10)
         {
      ...
      public function updatePreviewRoomView() : void
      {
         ...
         if(this._roomEngine != null)
         {
            _loc1_ = this._roomEngine.getRoomCanvasScreenOffset(const_50,const_49,const_236);
            if(_loc1_ != null)
            {
               this.updatePreviewObjectBoundingRectangle(_loc1_);
               if(this.var_50 != null)
               {
                  _loc2_ = this.var_1316;
                  _loc1_ = this.validatePreviewSize(_loc1_);
                  _loc3_ = this.getCanvasOffset(_loc1_);
                  if(_loc3_ != null)
                  {
                     this._roomEngine.setRoomCanvasScreenOffset(const_50,const_49,const_236,_loc3_);
                  }
                  if(this.var_1316 != _loc2_)
                  {
                     this.var_50 = null;
                  }
               }
      ...
      private function onRoomObjectAdded(param1:RoomEngineObjectEvent) : void
      {
         ...
         if(param1.roomId == const_50 && param1.roomCategory == const_49 && param1.objectId == const_65 && param1.category == this.var_346)
         {
            this.var_50 = null;
            this.var_2057 = false;
            ...
            {
               _loc3_ = _loc2_.getModel().getNumber(RoomObjectVariableEnum.const_497);
               _loc4_ = _loc2_.getModel().getNumber(RoomObjectVariableEnum.const_853);
