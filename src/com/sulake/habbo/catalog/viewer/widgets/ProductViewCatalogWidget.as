package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_595:IDisplayObjectWrapper;
      
      private var var_2136:Point;
      
      private var var_594:IItemGridWindow;
      
      private var var_1654:IScrollbarWindow;
      
      protected var var_2154:XML;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_1115 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         this.var_1361 = _window.findChildByName("ctlg_description") as ITextWindow;
         ...
         if(this.var_206 != null)
         {
            ...
            this.var_595 = this.var_206.findChildByName("room_canvas") as IDisplayObjectWrapper;
            _loc3_ = (page.viewer.catalog as HabboCatalog).roomPreviewer;
            if(this.var_595 != null && _loc3_ != null)
            {
               this.var_206.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onClickRoomView);
               _loc3_.reset();
               _loc4_ = _loc3_.getRoomCanvas(this.var_595.width,this.var_595.height);
               if(_loc4_ != null)
               {
                  this.var_595.setDisplayObject(_loc4_);
               }
            }
            else
            {
         ...
         this.var_2136 = new Point(this.var_99.x,this.var_99.y);
         this.var_594 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         this.var_1654 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(this.var_594 == null)
         {
            Logger.log("[ProductViewCatalogWidget] Bundle Grid not initialized!");
         }
         var _loc1_:XmlAsset = page.viewer.catalog.assets.getAssetByName("gridItem") as XmlAsset;
         this.var_2154 = _loc1_.content as XML;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(this.var_594 != null)
         {
            this.var_594.visible = false;
            this.var_594.destroyGridItems();
         }
         ...
         this.var_1115.text = _loc4_;
         this.var_1361.text = _loc5_;
         this.var_1115.height = this.var_1115.textHeight + 5;
         this.var_1361.y = this.var_1115.y + this.var_1115.height;
         this.var_1361.height = Math.max(130,this.var_1361.textHeight + 5);
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_610:
                  ...
                  if(this.var_594 != null)
                  {
                     this.var_594.visible = true;
                     _loc11_ = _loc2_.productContainer as BundleProductContainer;
                     _loc11_.populateItemGrid(this.var_594,this.var_1654,this.var_2154);
                     this.var_594.scrollV = 0;
                  }
                  if(this.var_206 != null)
                  {
                     this.var_206.visible = false;
               ...
               case Offer.const_426:
                  ...
                  if(this.var_206 != null)
                  {
                     if(_loc9_.productType == ProductTypeEnum.const_73 || _loc9_.productType == ProductTypeEnum.const_63 || _loc9_.productType == ProductTypeEnum.const_193)
                     {
                  ...
                  switch(_loc9_.productType)
                  {
                     case ProductTypeEnum.const_73:
                        if(_loc8_ != null && this.var_595 != null)
                        {
                        ...
                        else
                        {
                           ...
                           if(_loc17_.avatarRenderManager != null)
                           {
                              ...
                              if(_loc18_ != null)
                              {
                                 ...
                                 _loc18_.appendAction(AvatarAction.const_346,AvatarAction.const_653);
                                 _loc18_.appendAction(AvatarAction.const_353,_loc9_.productClassId);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2923)
         {
            _window.removeChild(_loc1_);
            _loc1_.dispose();
            _loc1_ = null;
         }
         this.var_2923 = new Array();
      }
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_99 != null && true)
         {
            ...
            this.var_99.x = this.var_2136.x;
            this.var_99.y = this.var_2136.y;
            if(param3 != null)
            {
