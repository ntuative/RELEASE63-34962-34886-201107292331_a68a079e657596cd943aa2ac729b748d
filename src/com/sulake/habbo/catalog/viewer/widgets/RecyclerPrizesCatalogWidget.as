package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RecyclerPrizesCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private var var_2154:XML;
      
      private var var_2153:XML;
      
      private var var_240:IGridItem;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_731 = this.recycler.getPrizeTable();
         ...
         this.var_2153 = _loc1_.content as XML;
         this.populateItemGrid();
         if(this.var_731.length > 0 && this.var_731[0].prizes.length > 0)
         {
            this.select(this.var_731[0].prizes[0] as IGridItem);
         }
         return true;
      }
      ...
      private function populateItemGrid(param1:TimerEvent = null) : void
      {
         ...
         {
            this.createLevelItem(this.var_731[_loc2_]);
            _loc2_++;
         }
      }
      ...
      {
         var _loc6_:* = null;
         var _loc2_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(this.var_2153) as IWindowContainer;
      ...
      private function createPrizeItem(param1:PrizeContainer, param2:IItemGridWindow) : void
      {
         ...
         var _loc3_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(this.var_2154) as IWindowContainer;
