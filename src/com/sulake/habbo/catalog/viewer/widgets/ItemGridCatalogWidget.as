package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGridCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid, IDragAndDropDoneReceiver
   {
      ...
      protected var var_518:IItemGridWindow;
      
      protected var var_2154:XML;
      
      protected var var_240:IGridItem;
      ...
      public function ItemGridCatalogWidget(param1:IWindowContainer, param2:ISessionDataManager)
      {
         ...
         if(this._scrollBar != null)
         {
            ...
            this._scrollBar.addEventListener(WindowEvent.const_836,this.activateScrollbar);
            this._scrollBar.addEventListener(WindowEvent.const_288,this.activateScrollbar);
            this._scrollBar.addEventListener(WindowEvent.const_758,this.deActivateScrollbar);
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_223.stop();
            this.var_223.removeEventListener(TimerEvent.TIMER,this.loadItemGridGraphics);
            this.var_223 = null;
         }
         if(this.var_518 != null)
         {
            this.var_518.destroyGridItems();
            this.var_518 = null;
         }
         this.var_2154 = null;
         this.var_240 = null;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_518 = _window.findChildByName("itemGrid") as IItemGridWindow;
         var _loc1_:XmlAsset = page.viewer.catalog.assets.getAssetByName("gridItem") as XmlAsset;
         this.var_2154 = _loc1_.content as XML;
         this.populateItemGrid();
         if(this.var_219)
         {
            this.var_223 = new Timer(25);
            this.var_223.addEventListener(TimerEvent.TIMER,this.loadItemGridGraphics);
            this.var_223.start();
         }
         else
         {
      ...
      {
         var _loc2_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(this.var_2154) as IWindowContainer;
         this.var_518.addGridItem(_loc2_);
         ...
         if(param1.pricingModel == Offer.const_610)
         {
            ++this.var_2076;
