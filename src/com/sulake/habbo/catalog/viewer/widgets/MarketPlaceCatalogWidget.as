package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private const const_2368:int = 40;
      
      private const const_2367:int = 10;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_535)
         {
            this.var_535.removeEventListener(TimerEvent.TIMER,this.onPopulationTimer);
            this.var_535 = null;
         }
      }
      ...
      private function selectSearchCategory(param1:String) : void
      {
         ...
         switch(param1)
         {
            ...
            case "search_by_activity":
               _loc5_ = "marketplace_search_simple";
               this.var_792 = [3,4,5,6];
               break;
            case "search_advanced":
               _loc5_ = "marketplace_search_advanced";
               this.var_792 = [1,2,3,4,5,6];
               break;
            default:
               return;
         }
         ...
         if(_loc7_ != null)
         {
            _loc7_.populate(this.getSortKeys(this.var_792));
            _loc7_.selection = 0;
         }
      }
      ...
      private function updateList() : void
      {
         ...
         if(!this.var_641)
         {
            ...
            this.var_641 = _loc5_.buildFromXML(_loc4_) as IWindowContainer;
         }
         if(!this.var_641)
         {
            return;
         ...
         this.updateStatusDisplay(this.const_2094,_loc3_.length,_loc2_);
         if(!this.var_535)
         {
            this.var_535 = new Timer(25);
            this.var_535.addEventListener(TimerEvent.TIMER,this.onPopulationTimer);
         }
         this.var_1208 = 0;
         this.populateList();
         this.var_535.start();
      ...
      {
         var _loc5_:* = null;
         this.updateStatusDisplay(this.const_2093);
         var _loc1_:int = -1;
         var _loc2_:int = -1;
         var _loc3_:String = "";
         var _loc4_:int = 1;
         ...
         if(_loc6_ && _loc6_.selection >= 0 && _loc6_.selection < this.var_792.length)
         {
            _loc4_ = this.var_792[_loc6_.selection];
         }
         ...
         else if(param1.type == WindowEvent.const_109)
         {
            ...
            switch(_loc7_.name)
            {
               ...
               case "max_price_input":
                  _loc8_ = this.const_2367;
                  break;
               case "search_input":
                  _loc8_ = this.const_2368;
                  break;
               default:
                  return;
            }
