package com.sulake.habbo.catalog.viewer
{
   ...
   public class ProductGridItem implements IGridItem
   {
      ...
      private static const const_1080:String = "bg";
       
      
      protected var _view:IWindowContainer;
      
      private var var_227:IItemGrid;
      
      protected var _icon:IBitmapWrapperWindow;
      
      private var _disposed:Boolean = false;
      
      private var var_579:Object;
      ...
      {
         this._view.getChildByName(const_1080).style = HabboWindowStyle.const_29;
      }
      
      public function deActivate() : void
      {
         this._view.getChildByName(const_1080).style = 3;
      }
      ...
      public function setDraggable(param1:Boolean) : void
      {
         ...
         {
            (this._view as IInteractiveWindow).setMouseCursorForState(WindowState.const_88,MouseCursorType.const_840);
            (this._view as IInteractiveWindow).setMouseCursorForState(0 | 0,MouseCursorType.const_840);
         }
      }
      ...
      private function eventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_44)
         {
            ...
            this.var_227.select(this);
            this.var_579 = param2;
         }
         else if(param1.type == WindowMouseEvent.const_25 && this.var_579 != null && this.var_579 == param2)
         {
            _loc3_ = this.var_227.startDragAndDrop(this);
            if(_loc3_)
            {
               this.var_579 = null;
            }
