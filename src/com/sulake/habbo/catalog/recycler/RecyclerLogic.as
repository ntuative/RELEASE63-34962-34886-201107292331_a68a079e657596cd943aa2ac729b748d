package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      private static const const_1125:int = 0;
      ...
      {
         return this.var_717 != const_1125;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_2098 != RecyclerStatusMessageEvent.const_1226;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_717 == const_484;
      }
      ...
      {
         this.var_717 = const_1124;
         this.var_141 = new Array(const_222);
         if(param1 == null)
         {
            return;
         }
      ...
      public function cancel() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < const_222)
         {
            this.releaseSlot(_loc1_);
            _loc1_++;
         }
         this.var_717 = const_1125;
      }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(this.var_2098)
         {
            case RecyclerStatusMessageEvent.const_1932:
               this.var_717 = const_484;
            ...
            case RecyclerStatusMessageEvent.const_1226:
               ...
               this._catalog.setupInventoryForRecycler(false);
               break;
            case RecyclerStatusMessageEvent.const_1962:
               if(this._view == null || this._view.disposed)
               {
                  return;
               }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_1271:
               if(this._view != null)
               {
                  this._view.displayFinishedView();
               }
               break;
            case RecyclerFinishedMessageEvent.const_1772:
      ...
      public function placeObjectAtSlot(param1:int, param2:int, param3:int, param4:int, param5:String) : void
      {
         ...
         if(this.var_141.length > 0)
         {
            ...
            newSlotId = 0;
            while(oldObjectData != null && newSlotId < const_222)
            {
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_141.length < const_222)
         {
            return false;
         }
         var _loc1_:int = 0;
