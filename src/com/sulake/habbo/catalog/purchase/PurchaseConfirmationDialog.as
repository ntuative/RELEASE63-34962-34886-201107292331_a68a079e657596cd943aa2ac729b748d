package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener, IDisposable
   {
      ...
      private const const_2088:uint = 4.294967295E9;
      
      private const const_1659:uint = 4.291613146E9;
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            if(_loc10_ != null)
            {
               _loc10_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.method_8);
            }
            ...
            if(_loc12_ != null)
            {
               _loc12_.addEventListener(WindowEvent.const_340,this.onFreeWrappingSelected);
               _loc12_.addEventListener(WindowEvent.const_644,this.onFreeWrappingUnSelect);
            }
            ...
            this.var_870 = _loc1_.boxTypes;
            this.var_869 = _loc1_.ribbonTypes;
            this.var_1330 = this.var_1817[0];
            this.var_406 = this.var_870[0];
            this.var_405 = this.var_869[0];
            this.initColorGrid();
      ...
      private function updatePreview() : void
      {
         if(this.var_405 < 0)
         {
            this.var_405 = this.var_869.length - 1;
         }
         if(this.var_405 > this.var_869.length - 1)
         {
            this.var_405 = 0;
         }
         if(this.var_406 < 0)
         {
            this.var_406 = this.var_870.length - 1;
         }
         if(this.var_406 > this.var_870.length - 1)
         {
            this.var_406 = 0;
         }
         var _loc1_:int = this.var_870[this.var_406] * 1000 + this.var_869[this.var_405];
         if(this._window == null)
         {
            return;
         }
         ...
         var _loc2_:ImageResult = this._roomEngine.getFurnitureImage(this.var_1330,new Vector3d(180),64,this,0,_loc1_.toString());
         if(_loc2_ == null)
         {
            return;
         }
         this.var_1618 = _loc2_.id;
      ...
      private function initColorGrid() : void
      {
         ...
         {
            _loc4_ = this._catalog.getFurnitureData(_loc3_,ProductTypeEnum.const_73);
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(this.var_1330);
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_870[this.var_406]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_869[this.var_405]);
         this._catalog.purchaseProductAsGift(this.var_1616,this.var_1329,this.var_1617,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      
      private function onBuyButtonClick(param1:WindowEvent) : void
      {
         this._catalog.purchaseProduct(this.var_1616,this.var_1329,this.var_1617);
         this.dispose();
      }
      ...
      private function onNameInputChange(param1:WindowEvent) : void
      {
         ...
         if(this.var_2853 == _loc2_.text)
         {
            return;
         }
         var _loc3_:String = _loc2_.text.toLowerCase();
         var _loc4_:* = [];
         for each(_loc5_ in this.var_251)
         {
            if(_loc5_.toLowerCase().search(_loc3_) != -1)
            {
               _loc4_.push(_loc5_);
            }
            if(_loc4_.length >= this.const_2387)
            {
               break;
            }
         }
         this.updateSuggestions(_loc4_);
         this.var_2853 = _loc2_.text;
      }
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(this.var_871 == null)
         {
            this.var_871 = this.createWindow("suggestion_list_item") as IWindowContainer;
         }
         if(this.var_298 == null || this.var_871 == null)
         {
            return;
         }
         ...
         {
            _loc5_ = this.var_871.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.color = this.const_1659;
         }
      }
      
      private function getColor(param1:int) : uint
      {
         return param1 % 2 == 0 ? uint(this.const_2087) : uint(this.const_2088);
      }
      ...
      {
         this.var_1330 = param1.target.id;
         this.updateColorGrid();
         this.updatePreview();
      }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == this.var_1330;
               }
            }
            _loc4_++;
         }
