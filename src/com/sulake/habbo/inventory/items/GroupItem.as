package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      private static const const_1479:int = 13421772;
      
      private static const const_1480:int = 10275685;
      ...
      protected var var_938:int = 0;
      
      protected var var_754:BitmapData;
      
      protected var var_2716:int;
      
      protected var var_1713:Boolean;
      
      protected var var_2263:Boolean;
      
      protected var var_3060:BitmapData;
      
      private var var_1475:Boolean;
      
      private const const_2091:Number = 1;
      
      private const const_2092:Number = 0.2;
      ...
      public function GroupItem(param1:int, param2:String, param3:int, param4:IWindowContainer, param5:IRoomEngine, param6:BitmapData, param7:Boolean, param8:String = null, param9:Number = NaN, param10:BitmapData = null, param11:Boolean = false)
      {
         ...
         this.var_2428 = this._window.findChildByName("outline");
         this._roomEngine = param5;
         this.var_3060 = param6;
      ...
      public function initImage(param1:Boolean = true) : void
      {
         ...
         if(this.var_2265 == FurniModelCategory.const_38)
         {
            _loc2_ = this._roomEngine.getFurnitureIcon(this._type,this,String(this.var_2109));
         }
         else
         {
            _loc2_ = this._roomEngine.getWallItemIcon(this._type,this,this.var_2264);
         }
         if(_loc2_.id > 0)
         {
            if(param1)
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(this.category == FurniCategory.const_970)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < this._items.length)
      ...
      public function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               this._window.blend = this.const_2092;
               _loc1_.blend = this.const_2092;
            }
            else
            {
               this._window.blend = this.const_2091;
               _loc1_.blend = this.const_2091;
            }
         }
         this.var_1476.color = !!this.var_1475 ? uint(const_1480) : uint(const_1479);
         this.var_2428.visible = this.isSelected;
         ...
         if(_loc5_)
         {
            if(this.var_2263 && this.getRecyclableCount() > 0)
            {
               _loc5_.bitmap = this.var_3060;
               _loc5_.visible = true;
            }
            else
            {
