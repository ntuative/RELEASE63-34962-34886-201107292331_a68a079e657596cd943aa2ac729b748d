package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_2061:uint = 9;
      
      public static const const_225:uint = 0;
      
      public static const const_217:uint = 1;
      
      public static const const_428:uint = 2;
      
      public static const const_342:uint = 3;
      
      public static const const_599:uint = 4;
      
      public static const const_269:uint = 5;
      ...
      public function startTrading(param1:int, param2:String, param3:Boolean, param4:int, param5:String, param6:Boolean) : void
      {
         ...
         this.var_61.updateItemList(this.var_902);
         this.var_61.updateItemList(this.var_1655);
      ...
      public function close() : void
      {
         if(this.var_766)
         {
            if(this._state != const_225 && this._state != const_269)
            {
      ...
      {
         this.var_61.setMinimized(param1 != InventoryCategory.const_70);
         this.var_12.updateSubView();
      }
      
      public function set state(param1:uint) : void
      {
         Logger.log("OLD STATE: " + this._state + " NEW STATE: " + param1 + " OWN: " + this.var_903 + " OTHER: " + this.var_1362);
         ...
         {
            case const_225:
               if(param1 == const_217 || param1 == const_269)
               {
                  this._state = param1;
                  _loc2_ = true;
               }
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            this.var_61.alertPopup(TradingView.const_1337);
         }
         else if(param1 is TradingAcceptEvent)
         {
            Logger.log("TRADING::TradingAcceptEvent");
            if(TradingAcceptEvent(param1).userID == this.var_902)
            {
               this.var_903 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
               this.var_1362 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            this.var_61.updateUserInterface();
         }
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            if(_loc2_.userID != this.var_902)
            {
               this.var_61.alertPopup(TradingView.const_1380);
            }
            this.close();
         }
      ...
      public function requestAddItemToTrading(param1:int, param2:int, param3:int, param4:Boolean, param5:String = "") : Boolean
      {
         ...
         if(this.var_306.length < const_2061)
         {
