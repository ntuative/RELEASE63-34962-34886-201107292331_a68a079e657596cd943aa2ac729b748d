package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_1094:uint = 4284532064;
      
      private static const const_1095:uint = 2577770;
      
      public static const const_1349:int = 0;
      ...
      private var var_676:ItemPopupCtrl;
      ...
      private var var_1037:GroupItem;
      ...
      public function TradingView(param1:TradingModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IRoomEngine, param5:IHabboLocalizationManager, param6:IHabboSoundManager)
      {
         ...
         this.var_676 = new ItemPopupCtrl(_loc9_,this._assetLibrary);
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this.var_223)
            {
               this.var_223.removeEventListener(TimerEvent.TIMER,this.timerEventHandler);
               this.var_223.stop();
               this.var_223 = null;
            }
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         {
            this.var_1948 = this.createMinimizedWindow();
         }
         if(!this.var_1164)
         {
            return this.var_80;
      ...
      public function updateUserInterface() : void
      {
         ...
         if(this.var_80)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_19.ownUserAccepts ? uint(const_1094) : uint(const_1095);
            }
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_19.otherUserAccepts ? uint(const_1094) : uint(const_1095);
            }
         ...
         if(this.var_80)
         {
            ...
            switch(this.var_19.state)
            {
               ...
               case TradingModel.const_342:
                  ...
                  this.showInfoMessage("${inventory.trading.info.confirm}");
                  break;
               case TradingModel.const_599:
                  _loc1_.disable();
                  this.showInfoMessage("${inventory.trading.info.waiting}");
                  break;
               case TradingModel.const_269:
                  _loc1_.disable();
                  _loc1_.caption = "${inventory.trading.accept}";
                  this.showInfoMessage("${inventory.trading.info.confirm}");
                  break;
      ...
      public function startConfirmCountdown() : void
      {
         ...
         {
            this.var_223 = new Timer(1000,3);
            this.var_223.addEventListener(TimerEvent.TIMER,this.timerEventHandler);
         }
         this.var_223.reset();
         this.var_223.repeatCount = 3;
         this.var_223.start();
      ...
      {
         this._windowManager.registerLocalizationParameter("inventory.trading.countdown","counter",String(3 - this.var_223.currentCount));
         if(this.var_223.currentCount == 3)
         {
      ...
      protected function method_18() : IWindowContainer
      {
      ...
      public function removeSelection() : void
      {
         if(this.var_1037)
         {
            this.var_1037.isSelected = false;
            this.var_1037 = null;
         }
      }
      ...
      private function thumbEventProc(param1:WindowEvent, param2:IWindow, param3:Boolean) : void
      {
         ...
         {
            this.var_19.method_12(param2.id);
         }
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc5_.category == FurniCategory.const_1848)
            {
            ...
            this.var_676.updateContent(param2 as IWindowContainer,_loc7_,_loc6_,ItemPopupCtrl.const_492);
            this.var_676.show();
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            this.var_676.hideDelayed();
         }
      }
         ...
         if(this.var_198.length > 0)
         {
            ...
            if(_loc5_.extra == param1.id)
            {
               if(_loc2_ && this.var_19.ownUserItems.getWithIndex(_loc4_) == _loc3_ || !_loc2_ && this.var_19.otherUserItems.getWithIndex(_loc4_) == _loc3_)
               {
                  ...
                  this.var_676.updateContent(_loc8_ as IWindowContainer,_loc6_,_loc7_,ItemPopupCtrl.const_492);
               }
            }
            else
            {
