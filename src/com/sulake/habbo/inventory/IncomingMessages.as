package com.sulake.habbo.inventory
{
   ...
   public class IncomingMessages
   {
      ...
      public function onFurniListUpdate(param1:IMessageEvent) : void
      {
         ...
         this.var_12.setInventoryCategoryInit(InventoryCategory.const_70,false);
      }
      ...
      public function onAvatarEffects(param1:IMessageEvent) : void
      {
         ...
         this.var_12.setInventoryCategoryInit(InventoryCategory.const_168);
         _loc2_.refreshViews();
      ...
      public function onClubStatus(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_12.setClubStatus(_loc2_.periodsSubscribedAhead,_loc2_.daysToPeriodEnd,_loc2_.hasEverBeenMember,_loc2_.isVIP,_loc2_.responseType == ScrSendUserInfoMessageParser.const_1376);
      ...
      public function onBadges(param1:IMessageEvent) : void
      {
         ...
         _loc3_.updateView();
         this.var_12.setInventoryCategoryInit(InventoryCategory.const_249);
      }
      ...
      private function onPets(param1:PetInventoryEvent) : void
      {
         ...
         this.var_12.setInventoryCategoryInit(InventoryCategory.const_127);
      ...
      private function onMarketplaceConfiguration(param1:MarketplaceConfigurationEvent) : void
      {
         ...
         this.var_12.setInventoryCategoryInit(InventoryCategory.const_458);
      ...
      {
         var _loc2_:* = null;
         if(this.var_12.isInventoryCategoryInit(InventoryCategory.const_458))
         {
      ...
      private function onUnseenItems(param1:UnseenItemsEvent) : void
      {
         ...
         this.var_12.furniModel.addUnseenFloorItems(_loc2_.getItemsByCategory(UnseenItemCategoryEnum.const_413));
         this.var_12.furniModel.addUnseenWallItems(_loc2_.getItemsByCategory(UnseenItemCategoryEnum.const_441));
         this.var_12.petsModel.addUnseenPets(_loc2_.getItemsByCategory(UnseenItemCategoryEnum.const_57));
         this.var_12.badgesModel.addUnseenBadges(_loc2_.getItemsByCategory(UnseenItemCategoryEnum.const_1323));
