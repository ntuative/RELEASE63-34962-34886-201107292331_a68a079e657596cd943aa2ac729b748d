package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsGridItem
   {
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowMouseEvent.const_44:
               this.var_1522.setSelectedGridItem(this);
               this.var_1521 = true;
               break;
            ...
            case WindowMouseEvent.const_25:
               ...
               {
                  this.var_1521 = false;
                  this.var_1522.placePetToRoom(this._petData.id,true);
               }
         }
      }
      ...
      public function setSelected(param1:Boolean) : void
      {
         ...
         if(!this._window || !this.var_1476)
         {
            return;
         }
         this.var_1476.color = !!this.var_1493 ? uint(const_1480) : uint(const_1479);
         this.var_2428.visible = param1;
      }
