package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView, IPetImageListener, IGetImageListener
   {
      ...
      private const const_1109:int = 3;
      ...
      private var var_227:IItemGridWindow;
      ...
      private var var_240:PetsGridItem;
      ...
      public function PetsView(param1:PetsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IRoomEngine, param6:IAvatarRenderManager)
      {
         ...
         this.var_227 = this._view.findChildByName("grid") as IItemGridWindow;
      ...
      public function update() : void
      {
         ...
         this.updateGrid();
         this.updatePreview(this.var_240);
      }
      
      public function removePet(param1:int) : void
      {
         var _loc2_:PetsGridItem = this.var_532.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
         this.var_227.removeGridItem(_loc2_.window);
         if(this.var_240 == _loc2_)
         {
            this.var_240 = null;
            this.selectFirst();
         }
      ...
      {
         if(this.var_532 == null || this.var_532.length == 0)
         {
            this.updatePreview();
            return;
         }
         this.setSelectedGridItem(this.var_532.getWithIndex(0));
      }
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(this.var_532.getValue(param1.id) != null)
         {
            return;
         }
         ...
         if(_loc2_ != null)
         {
            this.var_227.addGridItem(_loc2_.window);
            this.var_532.add(param1.id,_loc2_);
      ...
      private function placeButtonClickHandler(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:PetData = this.var_240.pet;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      public function setSelectedGridItem(param1:PetsGridItem) : void
      {
         if(this.var_240 != null)
         {
            this.var_240.setSelected(false);
         }
         this.var_240 = param1;
         if(this.var_240 != null)
         {
            this.var_240.setSelected(true);
         }
      ...
      public function updateState() : void
      {
         ...
         {
            _loc2_ = this.const_1111;
         }
         else
         {
            _loc2_ = this.const_1109;
         }
      ...
      public function updateCategoryButtons() : void
      {
         ...
         _loc1_.visible = this.var_78.furniModel.getUnseenItemCount(UnseenItemCategoryEnum.const_413) > 0;
         _loc1_ = this._view.findChildByTag("unseen_symbol_wall");
         _loc1_.visible = this.var_78.furniModel.getUnseenItemCount(UnseenItemCategoryEnum.const_441) > 0;
