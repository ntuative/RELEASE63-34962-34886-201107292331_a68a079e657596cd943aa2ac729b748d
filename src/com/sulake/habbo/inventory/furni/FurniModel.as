package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel extends FurniModelCategory implements IInventoryModel
   {
      ...
      private static const const_1551:int = 1000;
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboCatalog, param8:IHabboSoundManager)
      {
         ...
         this.var_469 = [];
         this.var_470 = [];
         this.var_664 = new Timer(const_1552,1);
         this.var_664.addEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
         var _loc9_:IAsset = this._assets.getAssetByName("inventory_thumb_xml");
         var _loc10_:XmlAsset = XmlAsset(_loc9_);
         this.var_2593 = XML(_loc10_.content);
         this.clearFurniList();
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._roomEngine != null)
            {
               ...
               {
                  this._roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_145,this.onObjectPlaced);
               }
            ...
            {
               this.var_664.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
               this.var_664.stop();
               this.var_664 = null;
            }
            if(this.var_219 != null)
            {
               this.var_219.removeEventListener(TimerEvent.TIMER_COMPLETE,this.initTimeout);
               this.var_219.stop();
               this.var_219 = null;
            }
      ...
      public function insertFurniList(param1:String, param2:Array, param3:int, param4:int) : void
      {
         ...
         this.var_27.setInventoryCategoryInit(InventoryCategory.const_70);
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         if(this.var_825 == null)
         {
            this.var_825 = this._windowManager.buildFromXML(this.var_2593) as IWindowContainer;
            _loc12_ = this._assets.getAssetByName("thumb_selected_outline_png") as BitmapDataAsset;
            _loc13_ = this.var_825.findChildByName("outline") as IBitmapWrapperWindow;
            _loc13_.bitmap = _loc12_.content as BitmapData;
            _loc13_.disposesBitmap = false;
         }
         var _loc11_:IWindowContainer = this.var_825.clone() as IWindowContainer;
      ...
      public function requestInitialization(param1:int = 0) : void
      {
         if(param1 > 0)
         {
            ...
            this.var_219 = new Timer(param1,1);
            this.var_219.addEventListener(TimerEvent.TIMER_COMPLETE,this.initTimeout);
            this.var_219.start();
         }
         else
         {
      ...
      {
         if(param1 == InventoryCategory.const_70 && this.var_27.isVisible)
         {
            switch(this._view.visibleCategoryId)
            {
               ...
               case const_45:
                  ...
                  break;
               case const_273:
                  this.var_27.toggleInventoryPage(InventoryCategory.const_127);
            }
         }
      }
      ...
      {
         this.var_2594 = getTimer();
         this.switchCategory(const_273);
      }
      ...
      {
         this.var_27.checkCategoryInitilization(InventoryCategory.const_458);
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_663.add(const_38,new Array());
         this.var_663.add(const_45,new Array());
         if(this._view != null)
         {
      ...
      public function addFurniAt(param1:IItem, param2:Boolean = false, param3:int = -1, param4:Boolean = false) : void
      {
         ...
         if(param4)
         {
            if(this._view.visibleCategoryId == const_273)
            {
      ...
      {
         return getTimer() < this.var_2594 + const_1551;
      }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_357 || _loc3_.category == FurniCategory.const_365 || _loc3_.category == FurniCategory.const_375)
         {
            if(param1)
            {
               return false;
      ...
      {
         return this.var_663.getValue(param1);
      }
      ...
      public function getAllStripIds(param1:String, param2:Array) : void
      {
         ...
         var _loc5_:int = 0;
         var _loc6_:int = 0;
         var _loc3_:Array = this.var_663.getValue(param1) as Array;
         if(_loc3_ != null)
         {
            for each(_loc4_ in _loc3_)
            {
               _loc5_ = _loc4_.getTotalCount();
               if(_loc4_.category == FurniCategory.const_970)
               {
                  _loc5_ = 1;
               }
               _loc6_ = 0;
      ...
      public function getUnseenItemCount(param1:int = 0) : int
      {
         switch(param1)
         {
            case UnseenItemCategoryEnum.const_413:
               return this.var_469.length;
            case UnseenItemCategoryEnum.const_441:
               return this.var_470.length;
            default:
               return this.var_469.length + this.var_470.length;
         }
      }
      ...
      public function resetUnseenItems(param1:String = null) : void
      {
         ...
         switch(param1)
         {
            case const_45:
               ...
               {
                  _loc2_.send(new ResetUnseenItemsComposer(UnseenItemCategoryEnum.const_441));
                  this.var_470 = [];
            ...
            case const_38:
               ...
               {
                  _loc2_.send(new ResetUnseenItemsComposer(UnseenItemCategoryEnum.const_413));
                  this.var_469 = [];
                  _loc3_ = this.getCategoryContent(param1);
               }
         }
