package com.sulake.habbo.sound.music
{
   ...
   public class SoundMachinePlayListController implements IPlayListController
   {
      ...
      public function SoundMachinePlayListController(param1:HabboSoundManagerFlash10, param2:HabboMusicController, param3:IEventDispatcher, param4:IEventDispatcher, param5:IConnection)
      {
         ...
         this.var_244 = param2;
         this.var_769 = [];
         this.var_769.push(new PlayListMessageEvent(this.onPlayListMessage));
         this.var_769.push(new PlayListSongAddedMessageEvent(this.onPlayListSongAddedMessage));
         for each(_loc6_ in this.var_769)
         {
         ...
         this.var_95.addEventListener(RoomEngineSoundMachineEvent.const_736,this.onSoundMachinePlayEvent);
         this.var_95.addEventListener(RoomEngineSoundMachineEvent.const_818,this.onSoundMachineStopEvent);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this.var_95)
            {
               this.var_95.removeEventListener(RoomEngineSoundMachineEvent.const_736,this.onSoundMachinePlayEvent);
               this.var_95.removeEventListener(RoomEngineSoundMachineEvent.const_818,this.onSoundMachineStopEvent);
               this.var_95 = null;
            }
            this._disposed = true;
         }
      ...
      {
         var _loc2_:* = null;
         if(this.var_460 == param1)
         {
            this.playCurrentSongAndNotify(this.var_460);
      ...
      public function stopPlaying() : void
      {
         this.var_460 = -1;
         this.var_646 = false;
         this.var_244.stop(HabboMusicPrioritiesEnum.const_138);
      }
      ...
      private function playCurrentSongAndNotify(param1:int) : void
      {
         ...
         if(this.var_244.playSong(param1,HabboMusicPrioritiesEnum.const_138,_loc3_,0,0,0))
         {
