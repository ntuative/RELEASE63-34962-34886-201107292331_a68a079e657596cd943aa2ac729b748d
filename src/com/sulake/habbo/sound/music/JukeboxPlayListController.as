package com.sulake.habbo.sound.music
{
   ...
   public class JukeboxPlayListController implements IPlayListController
   {
      ...
      public function JukeboxPlayListController(param1:HabboSoundManagerFlash10, param2:HabboMusicController, param3:IEventDispatcher, param4:IConnection)
      {
         ...
         this.var_769 = [];
         this.var_769.push(new NowPlayingMessageEvent(this.onNowPlayingMessage));
         this.var_769.push(new JukeboxSongDisksMessageEvent(this.onJukeboxSongDisksMessage));
         this.var_769.push(new JukeboxPlayListFullMessageEvent(this.onJukeboxPlayListFullMessage));
      ...
      private function onNowPlayingMessage(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_244.playSong(_loc3_.currentSongId,HabboMusicPrioritiesEnum.const_138,_loc3_.syncCount / 1000,0,1,1);
            this.var_460 = _loc3_.currentSongId;
         }
         else
         {
            this.stopPlaying();
         ...
         this._soundManager.events.dispatchEvent(new NowPlayingEvent(NowPlayingEvent.const_105,HabboMusicPrioritiesEnum.const_138,_loc3_.currentSongId,_loc3_.currentPosition));
      }
