package com.sulake.habbo.sound.music
{
   ...
   public class HabboMusicController implements IHabboMusicController, IDisposable
   {
      ...
      private static const const_1563:int = HabboMusicPrioritiesEnum.const_138;
      ...
      private var var_555:IPlayListController = null;
      ...
      public function HabboMusicController(param1:HabboSoundManagerFlash10, param2:IEventDispatcher, param3:IEventDispatcher, param4:IConnection)
      {
         ...
         this.var_769.push(new TraxSongInfoMessageEvent(this.onSongInfoMessage));
         this.var_769.push(new UserSongDisksInventoryMessageEvent(this.onSongDiskInventoryMessage));
         for each(_loc5_ in this.var_769)
         {
            this._connection.addMessageEvent(_loc5_);
         }
         this.var_95.addEventListener(RoomEngineSoundMachineEvent.const_766,this.onJukeboxInit);
         this.var_95.addEventListener(RoomEngineSoundMachineEvent.const_258,this.onJukeboxDispose);
         this.var_95.addEventListener(RoomEngineSoundMachineEvent.const_857,this.onSoundMachineInit);
         this.var_95.addEventListener(RoomEngineSoundMachineEvent.const_787,this.onSoundMachineDispose);
         this.var_1261 = new Timer(1000);
         this.var_1261.start();
         this.var_1261.addEventListener(TimerEvent.TIMER,this.sendNextSongRequestMessage);
         this._events.addEventListener(SoundCompleteEvent.TRAX_SONG_COMPLETE,this.onSongFinishedPlayingEvent);
         _loc6_ = 0;
         while(_loc6_ < HabboMusicPrioritiesEnum.const_253)
         {
            this.var_339[_loc6_] = null;
            this.var_829[_loc6_] = 0;
            _loc6_++;
         }
      }
      ...
      protected function onSongFinishedPlayingEvent(param1:SoundCompleteEvent) : void
      {
         ...
         {
            if(this.getTopRequestPriority() == this._priorityPlaying && this.getSongRequestCountAtPriority(this._priorityPlaying) == this.var_1930)
            {
               this.resetSongStartRequest(this._priorityPlaying);
            }
            _loc2_ = this._priorityPlaying;
            this.playSongWithHighestPriority();
            if(_loc2_ >= HabboMusicPrioritiesEnum.const_410)
            {
               this._events.dispatchEvent(new NowPlayingEvent(NowPlayingEvent.const_139,_loc2_,param1.id,-1));
            }
         }
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this._connection)
            {
               for each(_loc1_ in this.var_769)
               {
            ...
            if(this.var_282)
            {
               ...
               {
                  _loc3_ = this.var_282.getWithIndex(_loc2_) as SongDataEntry;
            ...
            if(this.var_95)
            {
               this.var_95.removeEventListener(RoomEngineSoundMachineEvent.const_766,this.onJukeboxInit);
               this.var_95.removeEventListener(RoomEngineSoundMachineEvent.const_258,this.onJukeboxDispose);
               this.var_95.removeEventListener(RoomEngineSoundMachineEvent.const_857,this.onSoundMachineInit);
               this.var_95.removeEventListener(RoomEngineSoundMachineEvent.const_787,this.onSoundMachineDispose);
            }
      ...
      {
         if(param1 < 0 || param1 >= HabboMusicPrioritiesEnum.const_253)
         {
            return false;
         }
         var _loc7_:SongStartRequestData = new SongStartRequestData(param2,param3,param4,param5,param6);
         this.var_339[param1] = _loc7_;
         this.var_829[param1] += 1;
         return true;
      }
      ...
      private function getSongIdRequestedAtPriority(param1:int) : int
      {
         ...
         var _loc2_:SongStartRequestData = this.var_339[param1];
      ...
      private function getSongRequestCountAtPriority(param1:int) : int
      {
         ...
         return this.var_829[param1];
      }
      
      private function getTopRequestPriority() : int
      {
         var _loc1_:int = this.var_339.length - 1;
         while(_loc1_ >= 0)
         {
            if(this.var_339[_loc1_] != null)
            {
               return _loc1_;
            }
            _loc1_--;
      ...
      private function getSongDataEntry(param1:int) : SongDataEntry
      {
         ...
         {
            _loc2_ = this.var_282.getValue(param1) as SongDataEntry;
         }
         return _loc2_;
      }
      ...
      public function updateVolume(param1:Number) : void
      {
         ...
         var _loc4_:* = null;
         var _loc2_:int = 0;
         while(_loc2_ < HabboMusicPrioritiesEnum.const_253)
         {
      ...
      private function requestSong(param1:int, param2:Boolean) : void
      {
         ...
         {
            this.var_670.add(param1,param2);
      ...
      {
         return this.var_392.length;
      }
      
      public function getSongDiskInventoryDiskId(param1:int) : int
      {
         if(param1 >= 0 && param1 < this.var_392.length)
         {
            return this.var_392.getKey(param1);
         }
         return -1;
      }
      ...
      public function getSongDiskInventorySongId(param1:int) : int
      {
         if(param1 >= 0 && param1 < this.var_392.length)
         {
            return this.var_392.getWithIndex(param1);
         }
         return -1;
      }
      ...
      public function samplesUnloaded(param1:Array) : void
      {
         ...
         while(_loc2_ < this.var_282.length)
         {
            ...
            if(_loc3_.id != this.var_1549 && _loc4_ != null && _loc4_.ready)
            {
      ...
      public function get samplesIdsInUse() : Array
      {
         ...
         {
            if(this.var_339[_loc2_] != null)
            {
               _loc3_ = this.var_339[_loc2_];
               _loc4_ = this.var_282.getValue(_loc3_.songId);
               if(_loc4_ != null)
               {
      ...
      private function sendNextSongRequestMessage(param1:TimerEvent) : void
      {
         ...
         this._connection.send(new GetSongInfoMessageComposer(this.var_828));
         Logger.log("Requested song info\'s : " + this.var_828);
         this.var_828 = new Array();
      }
      ...
      private function onSongInfoMessage(param1:IMessageEvent) : void
      {
         ...
         while(_loc5_ < _loc4_.length)
         {
            ...
            if(_loc7_)
            {
               ...
               this.var_282.add(_loc6_.id,_loc10_);
               ...
               while(this.var_827.indexOf(_loc6_.id) != -1)
               {
                  this.var_827.splice(this.var_827.indexOf(_loc6_.id),1);
                  if(this.var_827.length == 0)
                  {
      ...
      {
         if(param2 == -1 || param1 < 0 || param1 >= HabboMusicPrioritiesEnum.const_253)
         {
            return false;
         }
         ...
         this.var_1930 = this.getSongRequestCountAtPriority(param1);
         this.var_1549 = param2;
         if(this._priorityPlaying <= const_1563)
         {
      ...
      private function notifySongPlaying(param1:SongDataEntry) : void
      {
         ...
         if(param1.length >= 8000 && (this.var_2617 != param1.id || _loc3_ > this.var_2618 + 8000))
         {
            this._soundManager.notifyPlayedSong(param1.name,param1.creator);
            this.var_2617 = param1.id;
      ...
      private function onSongDiskInventoryMessage(param1:IMessageEvent) : void
      {
         ...
         while(_loc4_ < _loc3_.songDiskCount)
         {
            ...
            this.var_392.add(_loc5_,_loc6_);
            if(this.var_282.getValue(_loc6_) == null)
            {
               this.var_827.push(_loc6_);
      ...
      private function onSoundMachineInit(param1:Event) : void
      {
         ...
         this.var_555 = new SoundMachinePlayListController(this._soundManager,this,this._events,this.var_95,this._connection) as IPlayListController;
      }
      ...
      {
         this.disposeRoomPlaylist();
         this.var_555 = new JukeboxPlayListController(this._soundManager,this,this._events,this._connection) as IPlayListController;
