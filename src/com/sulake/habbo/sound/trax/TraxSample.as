package com.sulake.habbo.sound.trax
{
   ...
   public class TraxSample implements IDisposable
   {
      ...
      public static const const_1891:String = "sample_44khz";
      
      public static const const_1820:String = "sample_22khz";
      
      public static const const_2006:String = "sample_11khz";
      
      public static const const_1852:String = "sample_16bit";
      
      public static const const_1858:String = "sample_8bit";
      ...
      public function TraxSample(param1:ByteArray, param2:int, param3:String = "sample_44khz", param4:String = "sample_16bit")
      {
         ...
         var _loc6_:int = this.var_178 * this.var_85;
         ...
         while(_loc11_ < _loc10_)
         {
            ...
            _loc9_ *= _loc5_;
            _loc9_ += _loc14_;
            if(_loc11_ % this.var_178 == this.var_178 - 1)
            {
               this.var_136[int(_loc11_ / this.var_178)] = _loc9_;
               _loc9_ = 0;
            }
            _loc11_++;
         }
      ...
      {
         return this.var_136.length * this.var_178 * this.var_85;
      }
      
      public function get usageCount() : int
      {
         return this.var_672.length;
      }
      ...
      public function setSample(param1:Vector.<int>, param2:int, param3:int, param4:int) : int
      {
         ...
         var _loc5_:int = this.var_178 * this.var_85;
         param4 /= _loc5_;
         if(param2 < 0)
         {
            param3 += param2;
      ...
      public function setUsageFromSong(param1:int, param2:uint) : void
      {
         ...
         if(this.var_672.indexOf(param1) == -1)
         {
      ...
      public function isUsedFromSong(param1:int) : Boolean
      {
         ...
         return this.var_672.indexOf(param1) != -1;
      }
   }
}
