package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeSlot implements IOutfit, IAvatarImageListener
   {
      ...
      public function updateView() : void
      {
         ...
         if(this.var_666 && this.var_1542)
         {
            _loc5_ = this.var_27.manager.avatarRenderManager.createAvatarImage(this.figure,AvatarScaleType.const_117,this.var_1028,this);
            if(_loc5_)
            {
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            case "set_button":
               this.var_666 = this.var_27.figureData.getFigureString();
               this.var_1028 = this.var_27.gender;
               this.var_27.handler.saveWardrobeOutfit(this.var_1921,this);
               this.updateView();
               break;
            case "get_button":
               if(this.var_666)
               {
                  this.var_27.loadAvatarInEditor(this.var_666,this.var_1028,this.var_27.clubMemberLevel);
               }
         }
      }
