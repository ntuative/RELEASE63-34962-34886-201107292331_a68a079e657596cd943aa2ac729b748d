package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private const const_2389:String = "hd-99999-99999";
      ...
      private var var_348:PetDataManager;
      
      private var var_880:PaletteManager;
      
      private var var_749:String;
      
      private var var_349:Map;
      
      private var var_257:AvatarAssetDownloadManager;
      
      private var var_2107:AvatarFigureContainer;
      
      private var var_2875:Boolean = false;
      
      private var var_2877:Boolean = false;
      ...
      public function AvatarRenderManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_749 = RenderMode.const_1818;
         ...
         this.var_124.add(AvatarType.const_122,_loc4_);
         ...
         this.var_124.add(AvatarType.const_57,_loc4_);
         this._aliasCollection = new AssetAliasCollection(this,param1.assets as AssetLibraryCollection);
         this.var_348 = new PetDataManager(this,param1.assets as AssetLibraryCollection);
         this.var_880 = new PaletteManager(param1.assets as AssetLibraryCollection);
         var _loc5_:XML = param3.getAssetByName("HabboAvatarPetFigure").content as XML;
         this.var_348.populateFigureData(_loc5_);
      ...
      override public function dispose() : void
      {
         ...
         {
            for each(_loc1_ in this.var_124.getValues())
            {
               _loc1_.dispose();
            }
         ...
         if(this.var_257)
         {
            this.var_257.removeEventListener(Event.COMPLETE,this.onAvatarAssetsDownloadManagerReady);
      ...
      private function onAllModulesReadyAndRunning(param1:Event) : void
      {
         ...
         this.var_348.init();
         this.var_880.init();
         _loc2_ = this.var_124.getValue(AvatarType.const_122) as AvatarStructure;
         if(_loc2_)
         {
         ...
         _loc2_ = this.var_124.getValue(AvatarType.const_57) as AvatarStructure;
         if(_loc2_)
         {
            _loc2_.resetPartOffsets(context.assets);
         }
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            _loc3_ = this.var_124.getValue(AvatarType.const_122) as AvatarStructure;
            if(_loc3_ != null)
            {
               _loc4_ = this.var_159.getKey("external.figurepartlist.txt","figure.xml");
               ...
               if(this.var_257 == null)
               {
                  ...
                  _loc6_ = this.var_159.getKey("flash.dynamic.avatar.download.configuration","figuremap.xml");
                  _loc7_ = this.var_159.getKey("flash.dynamic.avatar.download.url","");
                  this.var_257 = new AvatarAssetDownloadManager(context.assets,_loc6_,_loc7_,_loc3_);
                  this.var_257.addEventListener(Event.COMPLETE,this.onAvatarAssetsDownloadManagerReady);
               }
            }
         }
      }
      ...
      private function checkIfReady() : void
      {
         if(!this.var_1070)
         {
            if(this.var_2875 && this.var_2877 && this.var_2876)
            {
               this.var_1070 = true;
      ...
      public function isFigureReady(param1:IAvatarFigureContainer) : Boolean
      {
         ...
         return this.var_257.isReady(param1);
      }
      ...
      public function downloadFigure(param1:IAvatarFigureContainer, param2:IAvatarImageListener) : void
      {
         ...
         this.var_257.loadFigureSetData(param1,param2);
      }
      ...
      {
         var _loc5_:AvatarStructure = this.var_124.getValue(AvatarType.const_122) as AvatarStructure;
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         if(this.var_257.isReady(_loc6_))
         {
            return new AvatarImage(_loc5_,this._aliasCollection,_loc6_,param2);
         }
         if(!this.var_2107)
         {
            this.var_2107 = new AvatarFigureContainer(this.const_2389);
         }
         this.var_257.loadFigureSetData(_loc6_,param4);
         return new PlaceholderAvatarImage(_loc5_,this._aliasCollection,this.var_2107,param2);
      }
      ...
      public function removePetImageListener(param1:IPetImageListener) : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:int = 0;
         if(param1 == null || this.var_349 == null)
         {
            return;
         }
         for each(_loc2_ in this.var_349.getKeys())
         {
      ...
      public function getPetFigureString(param1:String) : String
      {
         ...
         return this.var_348.createPetFigureString(_loc3_,_loc4_,_loc5_);
      }
      ...
      public function createPetImage(param1:int, param2:int, param3:uint, param4:String, param5:IPetImageListener = null) : IAvatarImage
      {
         var _loc9_:* = null;
         var _loc6_:* = false;
         if(this.mode != RenderMode.const_1898)
         {
            _loc6_ = !this.var_348.assetsReady(param1,param4);
         }
         var _loc7_:String = this.var_348.createPetFigureString(param1,param2,param3);
         var _loc8_:AvatarStructure = this.var_124.getValue(AvatarType.const_57) as AvatarStructure;
         if(_loc8_ == null)
         {
            return null;
         }
         ...
         if(param5 != null)
         {
            ...
            this.var_349.add(_loc7_,_loc9_);
         }
      ...
      public function resetPetData() : void
      {
         ...
         this.var_348.populateFigureData(_loc1_);
         var _loc2_:AvatarStructure = this.var_124.getValue(AvatarType.const_57);
         _loc2_.initFigureData(_loc1_);
         _loc2_.resetPartOffsets(context.assets);
         var _loc5_:Array = this.var_349.getKeys();
         for each(_loc6_ in _loc5_)
         {
            _loc4_ = this.var_349.getValue(_loc6_);
            if(_loc4_)
            {
      ...
      {
         var _loc2_:AvatarStructure = this.var_124.getValue(param1) as AvatarStructure;
         if(_loc2_ != null)
         {
      ...
      {
         var _loc3_:AvatarStructure = this.var_124.getValue(AvatarType.const_122) as AvatarStructure;
      ...
      {
         return this.var_348 as IPetDataManager;
      }
      ...
      public function injectFigureData(param1:String, param2:XML) : void
      {
         ...
         switch(param1)
         {
            ...
            case AvatarType.const_57:
               _loc3_ = this.var_124.getValue(AvatarType.const_57) as AvatarStructure;
               break;
            default:
