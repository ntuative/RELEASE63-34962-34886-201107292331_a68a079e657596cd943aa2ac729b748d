package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1600:String = "Default";
      
      private static const const_1601:int = 2;
      
      private static const const_1599:String = AvatarSetType.const_42;
      ...
      protected var var_779:Array;
      
      protected var _assets:AssetAliasCollection;
      
      protected var var_301:AvatarImageCache;
      
      protected var var_666:AvatarFigureContainer;
      
      protected var var_613:IAvatarDataContainer;
      
      protected var var_366:Array;
      
      protected var var_49:BitmapData;
      
      private var var_1089:IActiveActionData;
      ...
      protected var var_1429:Boolean = false;
      ...
      private var var_2754:String = null;
      
      private var var_2756:String = null;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:AvatarFigureContainer, param4:String)
      {
         ...
         this.var_666 = param3;
         this.var_301 = new AvatarImageCache(this._structure,this,this._assets,this._scale);
         this.setDirection(const_1599,const_1601);
         this.var_366 = new Array();
         this.var_1089 = new ActiveActionData(AvatarAction.const_459);
         this.var_1089.definition = this._structure.getActionDefinition(const_1600);
         this.resetActions();
      ...
      public function dispose() : void
      {
         ...
         if(!this.var_1157)
         {
            ...
            if(this.var_848)
            {
               for each(_loc2_ in this.var_848)
               {
                  _loc2_.dispose();
               }
      ...
      {
         return this._structure.getPartColor(this.var_666,param1);
      }
      
      public function setDirection(param1:String, param2:int) : void
      {
         param2 += this.var_2026;
         if(param2 < AvatarDirectionAngle.const_1220)
         {
            param2 = AvatarDirectionAngle.const_321 + (param2 + 1);
         }
         if(param2 > AvatarDirectionAngle.const_321)
         {
            param2 -= NaN;
         }
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_292.length == 1 && this.var_103 == this.var_2150)
         {
            return this.var_103 + this.var_573 + this.var_699 % 4;
         }
         if(this.var_292.length == 2)
         {
            for each(_loc1_ in this.var_292)
            {
               ...
               {
                  return this.var_103 + this.var_573 + 0;
               }
               if(_loc1_.actionType == "fx" && (_loc1_.actionParameter == "38" || _loc1_.actionParameter == "39"))
               {
                  _loc2_ = this.var_699 % 11;
                  return this.var_103 + "_" + this.var_2150 + this.var_573 + _loc2_;
               }
            }
         }
         return null;
      ...
      {
         if(param3 != this.var_2755 || param2 != this.var_2754 || param1 != this.var_2756)
         {
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         if(this.var_1429 || this.var_49 == null || (this.var_49.width != _loc5_.width || this.var_49.height != _loc5_.height))
         {
            if(this.var_49 != null && !this.var_1429)
            {
               this.var_49.dispose();
            }
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc9_ = _loc4_.getImageContainer(_loc8_,this.var_699);
         ...
         {
            if(this.var_613.paletteIsGrayscale)
            {
               ...
               this.var_49 = _loc13_;
               this.var_49.paletteMap(this.var_49,this.var_49.rect,new Point(0,0),this.var_613.reds,[],[]);
            }
            else
            {
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc8_ = _loc2_.getImageContainer(_loc7_,this.var_699);
            if(_loc8_ != null)
            {
               _loc9_ = _loc8_.image;
               if(_loc9_ == null)
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         var _loc4_:int = 0;
         while(_loc4_ < this.var_366.length)
         {
            _loc3_ = this.var_366[_loc4_];
         ...
         this.var_366.push(new ActiveActionData(param1,param2,this.var_699));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.var_317 = this.var_1089;
         this.var_317.definition = this.var_1089.definition;
         this.resetBodyPartCache(this.var_1089);
         return true;
      }
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_573 = "";
         this.var_292 = this._structure.sortActions(this.var_366);
         if(this.var_292 == null)
         {
            this.var_779 = new Array(0,0,0);
            if(this.var_1308 != "")
            {
               _loc1_ = true;
               this.var_1308 = "";
         ...
         {
            this.var_779 = this._structure.getCanvasOffsets(this.var_292,this._scale,this.var_103);
            for each(_loc4_ in this.var_292)
            {
               this.var_573 += _loc4_.actionType + _loc4_.actionParameter;
               if(_loc4_.actionType == AvatarAction.const_353)
               {
                  _loc5_ = parseInt(_loc4_.actionParameter);
                  if(this.var_1591 != _loc5_)
                  {
                     _loc2_ = true;
                  }
                  this.var_1591 = _loc5_;
                  _loc3_ = true;
               }
            }
            if(!_loc3_)
            ...
            if(this.var_1308 != this.var_573)
            {
               _loc1_ = true;
               this.var_1308 = this.var_573;
            }
         }
         this.var_1592 = true;
         return _loc1_;
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_292)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               {
                  this.var_1025 = _loc1_.definition.isAnimated(_loc1_.actionParameter);
                  _loc2_ = this._structure.getAnimation(_loc1_.definition.state + "." + _loc1_.actionParameter);
                  if(_loc2_ != null)
                  {
                     ...
                     {
                        this.var_2026 = _loc2_.directionData.offset;
                     }
                     if(_loc2_.hasAvatarData())
                     {
                        this.var_613 = _loc2_.avatarData;
                     }
                  }
               }
               if(_loc1_.actionType == AvatarAction.const_355 || _loc1_.actionType == AvatarAction.const_301 || _loc1_.actionType == AvatarAction.const_462)
               {
                  this.var_1025 = true;
               }
            }
