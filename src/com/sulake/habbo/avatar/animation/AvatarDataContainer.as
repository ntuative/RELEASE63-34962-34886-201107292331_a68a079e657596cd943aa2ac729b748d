package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_2172:Number = 1.0;
      
      private var var_2171:Number = 1.0;
      
      private var _alphaMultiplier:Number = 1.0;
      
      private var var_1387:Map;
      
      private var var_2973:Boolean = true;
      
      public function AvatarDataContainer(param1:XML)
      {
         super();
         this.var_2164 = parseInt(param1.@ink);
         var _loc2_:String = String(param1.@foreground);
         _loc2_ = _loc2_.replace("#","");
         var _loc3_:String = String(param1.@background);
         _loc3_ = _loc3_.replace("#","");
         this.var_2974 = parseInt(_loc2_,16);
         this.var_2975 = parseInt(_loc3_,16);
         ...
         this.var_854 = new ColorTransform(this.var_2170,this.var_2172,this.var_2171,this._alphaMultiplier);
         this.var_1387 = this.generatePaletteMapForGrayscale(this.var_2975,this.var_2974);
      }
      ...
      {
         return this.var_1387.getValue("reds") as Array;
      }
      
      public function get greens() : Array
      {
         return this.var_1387.getValue("greens") as Array;
      }
      
      public function get blues() : Array
      {
         return this.var_1387.getValue("blues") as Array;
      }
      
      public function get alphas() : Array
      {
         return this.var_1387.getValue("alphas") as Array;
      }
