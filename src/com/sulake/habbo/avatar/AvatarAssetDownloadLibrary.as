package com.sulake.habbo.avatar
{
   ...
   public class AvatarAssetDownloadLibrary extends EventDispatcher
   {
      ...
      private static var var_1871:int = 1;
      ...
      public function AvatarAssetDownloadLibrary(param1:String, param2:String, param3:String, param4:IAssetLibrary)
      {
         ...
         this._state = name_4;
         this._assets = param4;
         this.var_810 = String(param1);
         this._revision = String(param2);
         this.var_1238 = param3 + this.var_810 + ".swf";
         this.var_1238 = this.var_1238.replace("%revision%",this._revision);
         var _loc5_:AssetLibraryCollection = this._assets as AssetLibraryCollection;
         var _loc6_:IAssetLibrary = _loc5_.getAssetLibraryByUrl(this.var_810 + ".swf");
         if(_loc6_ != null)
         {
            Logger.log("[AvatarAssetDownloadLibrary] Already Downloaded by Core: " + this.var_810);
            this._state = name_5;
         }
      }
      ...
      {
         this._state = var_1871;
         var _loc1_:URLRequest = new URLRequest(this.var_1238);
      ...
      {
         Core.error("Could not load avatar asset library " + this.var_810 + " from URL " + this.var_1238,false,Core.const_1255);
      }
      ...
      {
         var _loc1_:String = this.var_810;
