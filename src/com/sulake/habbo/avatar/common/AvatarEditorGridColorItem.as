package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridColorItem
   {
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.bitmap = new BitmapData(this.var_720.width,this.var_720.height,true,0);
            _loc1_.bitmap.copyPixels(this.var_720,this.var_720.rect,new Point(0,0));
         }
         var _loc2_:IBitmapWrapperWindow = this._window.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
         if(_loc2_ != null)
         {
            _loc2_.bitmap = new BitmapData(this.var_1094.width,this.var_1094.height,true,0);
            _loc5_ = this.var_1094.clone();
         ...
         if(_loc3_ != null)
         {
            if(this._isSelected)
            {
               _loc3_.bitmap = new BitmapData(this.var_991.width,this.var_991.height,true,16777215);
               _loc3_.bitmap.copyPixels(this.var_991,this.var_991.rect,new Point(0,0),null,null,true);
               _loc3_.visible = true;
            }
            else
            {
            ...
            if(this.var_990)
            {
               switch(this.var_990.clubLevel)
               {
                  ...
                  case HabboClubLevelEnum.const_34:
                     _loc4_.style = HabboIconType.const_928;
                     _loc4_.visible = true;
                     break;
