package com.sulake.habbo.avatar
{
   ...
   public class PetImage implements IAvatarImage, IDisposable
   {
      ...
      private var var_301:AvatarImageCache;
      
      private var var_699:int = 0;
      
      private var var_2026:int = 0;
      
      private var var_666:AvatarFigureContainer;
      
      private var var_698:Boolean;
      
      private var var_218:Array;
      
      private var var_613:IAvatarDataContainer;
      ...
      public function PetImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:String, param4:String)
      {
         ...
         this.var_666 = new AvatarFigureContainer(param3);
         var _loc5_:int = this.var_666.getPartSetId("pbd");
         this.solvePetAvatarTypeAndBreed(_loc5_);
         this.var_1623 = this.var_1301;
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         while(_loc7_ >= 0)
         {
            ...
            if(_loc9_ && _loc9_.image && _loc9_.regPoint)
            {
               ...
               _loc15_ = this._structure.getParts(_loc8_,this.var_666,_loc13_,"pet",_loc12_.getDirection(),[]);
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc7_ >= 0)
         {
            ...
            if(_loc10_ != null)
            {
               ...
               _loc16_ = this._structure.getParts(_loc9_,this.var_666,_loc14_,"pet",_loc13_.getDirection(),[]);
               _loc17_ = 32;
               if(this._scale == AvatarScaleType.const_117)
               {
                  _loc17_ = 6;
      ...
      public function appendAction(param1:String, ... rest) : Boolean
      {
         ...
         this.var_573 = this.var_573 + param1 + _loc3_;
         switch(param1)
         {
            case AvatarAction.const_430:
               switch(_loc3_)
               {
                  ...
                  case AvatarAction.const_1807:
                  case AvatarAction.const_1933:
                  case AvatarAction.const_1923:
                  case AvatarAction.const_1388:
                  case AvatarAction.const_1225:
                  case AvatarAction.const_1786:
                  case AvatarAction.const_1839:
      ...
      private function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_366.push(new ActiveActionData(param1,param2));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.setActionToParts(this.var_1089);
         this.getCache().resetBodyPartCache(this.var_1089);
         return true;
      }
      ...
      private function sortActions() : void
      {
         ...
         this.var_1624 = this._structure.sortActions(this.var_366);
         ...
         {
            this.var_779 = this._structure.getCanvasOffsets(this.var_1624,this._scale,this.var_103);
         }
      }
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_1624)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               if(_loc1_.actionType == AvatarAction.const_355)
               {
                  this.var_1025 = true;
               }
            }
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != null)
            {
               for each(_loc4_ in _loc3_.parts)
               {
                  if(_loc4_.type == "pbd")
                  {
                     this.var_1301 = _loc4_.id;
                     this.var_1932 = _loc4_.breed;
                     break;
                  }
               }
            }
