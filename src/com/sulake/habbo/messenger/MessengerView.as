package com.sulake.habbo.messenger
{
   ...
   public class MessengerView implements IDisposable
   {
      ...
      private var var_1000:ConversationsTabView;
      ...
      {
         this.var_16 = IFrameWindow(this.var_154.getXmlWindow("main_window"));
         ...
         this.var_1000 = new ConversationsTabView(this.var_154,this.var_16);
         this.var_1000.refresh();
         this.var_999 = ITextFieldWindow(this.var_16.findChildByName("message_input"));
         this.var_999.addEventListener(WindowKeyboardEvent.const_194,this.onMessageInput);
         this.var_1501 = new ConversationView(this.var_154,this.var_16);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_880,false);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1264,true);
         this.var_16.center();
      }
      ...
      private function onMessageInput(param1:WindowKeyboardEvent) : void
      {
         ...
         {
            _loc2_ = 120;
            _loc3_ = this.var_999.text;
            if(_loc3_.length > _loc2_)
            {
               this.var_999.text = _loc3_.substring(0,_loc2_);
            }
         }
      }
      ...
      {
         var _loc1_:String = this.var_999.text;
         ...
         this.var_999.text = "";
         this.var_154.conversations.addMessageAndUpdateView(new Message(Message.const_802,_loc2_.id,_loc1_,Util.getFormattedNow()));
      }
      
      public function getTabCount() : int
      {
         return this.var_1000 == null ? 7 : int(this.var_1000.getTabCount());
      }
   }
}
