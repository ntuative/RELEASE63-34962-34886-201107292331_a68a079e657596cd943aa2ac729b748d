package com.sulake.habbo.messenger
{
   ...
   public class HabboMessenger extends Component implements IHabboMessenger, IAvatarImageListener
   {
      ...
      private var var_507:Conversations;
      
      private var var_211:MessengerView;
      ...
      {
         if(this._windowManager && this._communication && this.var_159 && this._localization && this._friendList && this.var_616 && this._soundManager)
         {
            unlock();
      ...
      {
         this.var_507 = new Conversations(new ConversationsDeps(this));
         this.var_211 = new MessengerView(this);
      ...
      {
         var _loc2_:Conversation = this.var_507.addConversation(param1);
         if(_loc2_ == null)
         {
         ...
         {
            this.var_507.setSelected(_loc2_);
            this.var_211.openMessenger();
      ...
      {
         return !!this.var_507 ? this.var_507.findSelectedConversation() : null;
      }
      
      public function setFollowingAllowed(param1:int, param2:Boolean) : void
      {
         this.var_507.setFollowingAllowedAndUpdateView(param1,param2);
      }
      
      public function setOnlineStatus(param1:int, param2:Boolean) : void
      {
         this.var_507.setOnlineStatusAndUpdateView(param1,param2);
      }
      ...
      {
         return this.var_211 && this.var_211.isMessengerOpen();
      }
      ...
      public function toggleMessenger() : void
      {
         if(this.var_211)
         {
            if(this.var_211.isMessengerOpen())
            {
               this.var_211.close();
            }
            else
      ...
      private function getPageParam(param1:String) : String
      {
         ...
         if(param1 == "url.prefix")
         {
            ...
            _loc2_ = this.var_159.getKey("url.prefix",_loc2_);
      ...
      private function onRoomInvite(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_1328,_loc2_.senderId,this.getText("messenger.invitation") + " " + _loc2_.messageText,Util.getFormattedNow());
         this.addMsg(_loc3_);
      }
      
      private function addMsg(param1:Message) : void
      {
         this.var_507.addMessageAndUpdateView(param1);
         if(!this.var_211.isMessengerOpen())
         {
            if(this._soundManager != null)
            {
      ...
      private function onInstantMessageError(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_1203,_loc2_.userId,this.getInstantMessageErrorText(_loc2_.errorCode),Util.getFormattedNow());
         this.var_507.addMessageAndUpdateView(_loc3_);
      }
