package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_487:uint = 3;
      
      private static const const_1650:uint = 1;
      ...
      private var var_2114:ProfilerOutput;
      
      private var var_1635:ProfilerAgentTask;
      
      private var var_1636:ProfilerAgentTask;
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_234 = new Array(const_487);
         ...
         var _loc6_:int = 0;
         while(_loc6_ < const_487)
         {
            this.var_234[_loc6_] = new WindowContext("layer_" + _loc6_,this._windowRenderer,this,this._localization,context.displayObjectContainer,_loc5_,this);
            _loc6_++;
         }
         this.var_654 = this.var_234[const_1650];
         unlock();
      ...
      private function method_17(param1:WindowMouseEvent) : void
      {
         Logger.log("CRASH!");
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(_loc3_ != null)
         {
            if(!this.var_2114)
            {
               this.var_2114 = new ProfilerOutput(context,this,this._windowRenderer);
            }
            this.var_2114.profiler = _loc3_;
            this.var_1635 = new ProfilerAgentTask("Update","Event processing");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1635);
            this.var_1636 = new ProfilerAgentTask("Redraw","Window rasterizer");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1636);
            this.var_1351 = true;
         }
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_234)
            {
               ...
               {
                  IDisposable(this.var_234.pop()).dispose();
               }
            }
            this.var_234 = null;
            if(this.var_302)
      ...
      {
         return this.var_654.create(param1,param7,param2,param3,param4,param5,param6,param10,param8,param11,param9);
      }
      ...
      {
         return this.var_654.getWindowParser().windowToXMLString(param1);
      }
      
      public function getLayoutByTypeAndStyle(param1:uint, param2:uint) : XML
      {
         var _loc3_:Dictionary = this.var_302[param2] as Dictionary;
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:XML = _loc3_[param1] as XML;
         return _loc4_ == null ? this.var_302[0][param1] as XML : _loc4_;
      }
      ...
      {
         return this.var_234[param9].create(param1,param2,param3,param4,param5,param6,param7,null,param8,null,null);
      }
      
      public function removeWindow(param1:String, param2:uint = 1) : void
      {
         var _loc3_:IDesktopWindow = this.var_234[param2].getDesktopWindow();
      ...
      {
         return this.var_234[param2].getDesktopWindow().getChildByName(param1);
      }
      
      public function getActiveWindow(param1:uint = 1) : IWindow
      {
         return this.var_234[param1].getDesktopWindow().getChildAt(this.var_654.getDesktopWindow().numChildren - 1);
      }
      ...
      {
         var _loc2_:IWindowContext = this.var_234[param1];
      ...
      public function update(param1:uint) : void
      {
         ...
         if(WindowContext.var_432.length > 0)
         {
            ...
            while(_loc2_ >= 0)
            {
               this.var_234[_loc2_].update(param1);
               _loc2_--;
            }
         }
         if(this.var_1351)
         ...
         _loc2_ = 0;
         while(_loc2_ < const_487)
         {
            this.var_234[_loc2_].render(param1);
            _loc2_++;
         }
         if(this.var_1351)
         {
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_2058,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1908,param2.name + ": " + param2.toString());
            }
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1774,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1935,param2.name + ": " + param2.toString());
            }
         }
      }
