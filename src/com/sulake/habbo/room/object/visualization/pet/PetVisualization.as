package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class PetVisualization extends RoomObjectSpriteVisualization implements IPetImageListener
   {
      ...
      private var var_643:PetVisualizationData = null;
      ...
      private const const_1494:int = 3;
      ...
      {
         this.var_643 = param1 as PetVisualizationData;
         createSprites(this.const_1494);
         var _loc2_:BitmapData = (this.var_643.getAvatarRendererAsset("pet_experience_bubble_png") as BitmapDataAsset).content as BitmapData;
         this.var_422 = new ExperienceData(_loc2_.clone());
         return true;
      }
      ...
      private function updateModel(param1:IRoomObjectModel, param2:Number) : Boolean
      {
         ...
         {
            this.var_1835 = param1.getNumber(RoomObjectVariableEnum.const_278) > 0;
            this.var_1497 = param1.getString(RoomObjectVariableEnum.const_161);
            this.var_279 = param1.getString(RoomObjectVariableEnum.const_295);
            this.var_1496 = param1.getString(RoomObjectVariableEnum.const_988);
            this.var_1834 = param1.getNumber(RoomObjectVariableEnum.const_213);
            this.var_1527 = param1.getNumber(RoomObjectVariableEnum.AVATAR_EXPERIENCE_TIMESTAMP);
            this.var_2507 = param1.getNumber(RoomObjectVariableEnum.const_429);
      ...
      private function updateObject(param1:IRoomObject, param2:IRoomGeometry, param3:Boolean = false) : Boolean
      {
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         if(param3 || var_514 != param1.getUpdateID() || this.var_1823 != param2.updateId)
         {
            ...
            if(_loc4_ != this.var_1830 || param3)
            {
               this.var_1830 = _loc4_;
               _loc4_ -= 112.5;
      ...
      private function getAvatarImage(param1:Number) : IAvatarImage
      {
         ...
         if(_loc3_ == null)
         {
            _loc3_ = this.var_643.getAvatar(this.var_666,param1,this);
            if(_loc3_ != null)
            {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         var _loc12_:Boolean = this.var_1025 || this.var_1247 > 0 || this.var_1899;
         this.var_422.alpha = 0;
         if(this.var_1527 > 0)
         {
            _loc13_ = param2 - this.var_1527;
            if(_loc13_ < AvatarAction.const_1153)
            {
               this.var_422.alpha = int(Math.sin(_loc13_ / 0 * 0) * 255);
               this.var_422.setExperience(this.var_2507);
               this.var_1247 = this.const_2371;
            }
            else
            {
               this.var_1527 = 0;
            ...
            if(_loc14_ != null)
            {
               ...
               {
                  _loc14_.asset = this.var_422.image;
                  _loc14_.offsetX = -20;
                  _loc14_.offsetY = -80;
                  _loc14_.alpha = this.var_422.alpha;
         ...
         if(_loc11_ || _loc12_)
         {
            ...
            _loc14_ = getSprite(this.const_1070);
            if(_loc14_)
            {
      ...
      private function updateActions(param1:IAvatarImage) : void
      {
         ...
         if(this.var_1497 != null && this.var_1497 != "")
         {
            param1.appendAction(AvatarAction.const_346,this.var_1497);
         }
         ...
         var _loc2_:int = param1.getSprites().length + this.const_1494;
