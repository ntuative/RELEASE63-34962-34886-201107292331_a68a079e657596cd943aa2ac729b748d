package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class AnimatedPetVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1673:String = "head";
      
      private static const const_722:int = 1;
      
      private static const const_1153:int = 1000;
      
      private static const const_1674:String = "pet_experience_bubble_png";
      
      private static const const_1672:int = 0;
      
      private static const const_1675:int = 1;
      ...
      private var var_422:ExperienceData;
      ...
      override public function initialize(param1:IRoomObjectVisualizationData) : Boolean
      {
         ...
         {
            _loc3_ = this._animationData.commonAssets.getAssetByName(const_1674) as BitmapDataAsset;
            if(_loc3_ != null)
            {
               _loc2_ = (_loc3_.content as BitmapData).clone();
               this.var_422 = new ExperienceData(_loc2_);
            }
         }
      ...
      override protected function updateAnimation(param1:Number) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != this.var_2939)
            {
               this.var_2939 = _loc3_;
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         if(_loc3_.getUpdateID() != var_148)
         {
            _loc4_ = _loc3_.getString(RoomObjectVariableEnum.const_295);
            _loc5_ = _loc3_.getString(RoomObjectVariableEnum.const_161);
            _loc6_ = _loc3_.getNumber(RoomObjectVariableEnum.const_295);
            if(!isNaN(_loc6_))
            {
            ...
            this.var_1835 = _loc3_.getNumber(RoomObjectVariableEnum.const_278) > 0;
            _loc8_ = _loc3_.getNumber(RoomObjectVariableEnum.const_213);
            if(!isNaN(_loc8_))
            {
               this.var_2150 = _loc8_;
            }
            else
            {
               this.var_2150 = direction;
            }
            this.var_1527 = _loc3_.getNumber(RoomObjectVariableEnum.AVATAR_EXPERIENCE_TIMESTAMP);
            this.var_2507 = _loc3_.getNumber(RoomObjectVariableEnum.const_429);
            _loc9_ = _loc3_.getNumber(RoomObjectVariableEnum.const_969);
            if(_loc9_ != this.var_2151)
            {
               this.var_2151 = _loc9_;
               this.var_2940 = this.var_2151.toString();
            }
      ...
      private function updateExperienceBubble(param1:int) : void
      {
         ...
         {
            this.var_422.alpha = 0;
            if(this.var_1527 > 0)
            {
               _loc2_ = param1 - this.var_1527;
               if(_loc2_ < const_1153)
               {
                  this.var_422.alpha = int(Math.sin(_loc2_ / const_1153 * 0) * 255);
                  this.var_422.setExperience(this.var_2507);
               }
               else
               {
                  this.var_1527 = 0;
               ...
               if(_loc3_ != null)
               {
                  if(this.var_422.alpha > 0)
                  {
                     _loc3_.asset = this.var_422.image;
                     _loc3_.offsetX = -20;
                     _loc3_.offsetY = -80;
                     _loc3_.alpha = this.var_422.alpha;
                     _loc3_.visible = true;
                  }
                  else
                  {
      ...
      {
         return super.getAdditionalSpriteCount() + const_722;
      }
      ...
      override protected function getAsset(param1:String) : IGraphicAsset
      {
         ...
         {
            return assetCollection.getAssetWithPalette(param1,this.var_2940);
         }
         return null;
      }
      ...
      override protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         if(param2 < _loc3_ - const_722)
         {
            _loc4_ = getSize(param1);
            if(param2 < _loc3_ - (1 + const_722))
            {
               if(param2 >= FurnitureVisualizationData.const_564.length)
               {
                  return null;
               }
               _loc5_ = FurnitureVisualizationData.const_564[param2];
               if(_loc4_ == 1)
               {
      ...
      private function getDirection(param1:int, param2:int) : int
      {
         ...
         {
            return this._animationData.getDirectionValue(param1,this.var_2150);
         }
         return direction;
      }
      ...
      private function isHeadSprite(param1:int) : Boolean
      {
         ...
         {
            if(this._animationData.getTag(var_102,DirectionData.USE_DEFAULT_DIRECTION,param1) == const_1673)
            {
               this.var_1125[param1] = true;
            }
            else
            {
               this.var_1125[param1] = false;
            }
         }
         return this.var_1125[param1];
      }
   }
}
