   ...
   public class PlaneMask
   {
      ...
      public function dispose() : void
      {
         ...
         if(this.var_576 != null)
         {
            ...
            {
               _loc1_ = this.var_576.getWithIndex(_loc2_) as PlaneMaskVisualization;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      {
         if(this.var_576.getValue(String(param1)) != null)
         {
            return null;
         }
         var _loc2_:PlaneMaskVisualization = new PlaneMaskVisualization();
         this.var_576.add(String(param1),_loc2_);
      ...
      protected function getMaskVisualization(param1:int) : PlaneMaskVisualization
      {
         ...
         {
            this.var_1311 = this.var_576.getValue(String(this._sizes[_loc2_])) as PlaneMaskVisualization;
         }
         else
         {
            this.var_1311 = null;
