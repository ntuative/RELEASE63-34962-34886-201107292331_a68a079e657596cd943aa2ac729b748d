package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      public static const const_2323:int = 1;
      
      public static const const_2190:int = 16777216;
      ...
      private var var_1840:int = 16777216;
      
      private var var_3092:int = 69069;
      
      private var var_3093:int = 5;
      ...
      {
         var _loc1_:int = this.var_3092 * this.var_1841 + this.var_3093;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
         _loc1_ %= this.var_1840;
         this.var_1841 = _loc1_;
         return _loc1_;
      }
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / this.var_1840 * param2);
      }
   }
}
