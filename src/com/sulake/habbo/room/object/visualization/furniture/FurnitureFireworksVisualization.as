package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureFireworksVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private var var_252:FurnitureParticleSystem;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_701)
         {
            for each(_loc1_ in this.var_701)
            {
               _loc1_.dispose();
            }
            this.var_701 = null;
      ...
      override protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(super.updateObject(param1,param2))
         {
            ...
            {
               this.readDefinition();
               this.var_252 = this.var_701[param1];
               _loc3_ = true;
            }
      ...
      override protected function setAnimation(param1:int) : void
      {
         if(this.var_252)
         {
            this.var_252.setAnimation(param1);
         }
      ...
      {
         if(this.var_252 && this.var_252.controlsSprite(param3))
         {
            return this.var_252.getSpriteYOffset(param1,param2,param3);
         }
      ...
      private function readDefinition() : Boolean
      {
         ...
         var _loc3_:String = _loc2_.getString(RoomObjectVariableEnum.const_1404);
         if(_loc3_.length == 0)
         {
