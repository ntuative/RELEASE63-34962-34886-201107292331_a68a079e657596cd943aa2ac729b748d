package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureRoomBrandingVisualization extends FurnitureVisualization
   {
      ...
      private static const const_1594:String = "branded_image";
      
      private static const const_1595:int = 0;
      
      private static const const_1597:int = 1;
      
      private static const const_1596:int = 2;
      
      private static const const_1598:int = 3;
      ...
      protected var var_1720:int;
      
      protected var var_1721:int;
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         if(_loc2_)
         {
            ...
            if(_loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  this.var_1720 = _loc4_.getNumber(RoomObjectVariableEnum.const_554);
                  this.var_1721 = _loc4_.getNumber(RoomObjectVariableEnum.const_605);
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     _loc4_ = _loc2_.getNumber(RoomObjectVariableEnum.const_626);
                     if(_loc4_ == 1)
                     {
      ...
      override protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         if(this._imageUrl != null && _loc6_ == const_1594)
         {
