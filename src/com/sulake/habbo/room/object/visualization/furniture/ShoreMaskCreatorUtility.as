package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class ShoreMaskCreatorUtility
   {
      ...
      public static const const_177:int = 0;
      
      public static const const_81:int = 1;
      
      public static const const_76:int = 2;
      
      private static const const_1620:int = 3;
      ...
      public static function method_13(param1:int, param2:int) : BitmapData
      {
      ...
      {
         return param1 + param2 * const_1620;
      }
            ...
            if(param2.getAsset(_loc4_) == null)
            {
               if(param3 != null)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     ...
                     _loc7_ = [const_177,const_81,const_76,const_177,const_81,const_76];
                     _loc8_ = [const_81,const_81,const_81,const_76,const_76,const_76];
                     _loc9_ = null;
                     _loc10_ = 0;
                     if(_loc6_ != null)
                     {
