package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureWaterAreaVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1605:String = "shore";
      ...
      override public function dispose() : void
      {
         ...
         {
            for each(_loc1_ in this.var_1312)
            {
      ...
      {
         if(this.var_2788 == param1 && this.var_2787 == direction)
         {
         ...
         while(_loc2_ >= 0)
         {
            if(getSpriteTag(param1,direction,_loc2_) == const_1605)
            {
               this.var_2050 = _loc2_;
               this.var_2788 = param1;
               this.var_2787 = direction;
               return this.var_2050;
            }
            _loc2_--;
         }
      ...
      private function getInstanceMask(param1:int) : IGraphicAsset
      {
         ...
         if(_loc3_ != null)
         {
            if(this.var_1312.indexOf(_loc2_) < 0)
            {
               this.var_1312.push(_loc2_);
            }
         }
         return _loc3_;
      }
      ...
      private function updateBorderData() : void
      {
         ...
         this.var_2049 = false;
         _loc5_ = 0;
         while(_loc5_ < this.var_491.length)
         {
            if(this.var_491[_loc5_] == true)
            {
               this.var_2049 = true;
            }
            _loc5_++;
      ...
      private function updateTopBorder(param1:Array, param2:int) : int
      {
         ...
         while(_loc8_ < _loc3_ - 1)
         {
            if(_loc4_[_loc8_] == false)
            {
               ...
               this.var_707[param2] = ShoreMaskCreatorUtility.getBorderType(_loc6_,_loc7_);
            }
            param2++;
            _loc8_++;
         }
      ...
      private function updateRightBorder(param1:Array, param2:int) : int
      {
         ...
         while(_loc10_ < _loc4_ - 1)
         {
            ...
            if(_loc7_[_loc3_ - 1] == false)
            {
               ...
               this.var_707[param2] = ShoreMaskCreatorUtility.getBorderType(_loc5_,_loc6_);
            }
            param2++;
            _loc10_++;
         }
      ...
      {
         var _loc2_:* = null;
         if(this.var_582 == 0 || this.var_708 == 0)
         {
            ...
            this.var_582 = _loc2_.getNumber(RoomObjectVariableEnum.const_296);
            this.var_708 = _loc2_.getNumber(RoomObjectVariableEnum.const_349);
         }
         this.var_491 = [];
         this.var_707 = [];
         var _loc1_:int = 0;
         while(_loc1_ < this.var_582 * 2 + this.var_708 * 2)
         {
            this.var_491.push(false);
            this.var_707.push(ShoreMaskCreatorUtility.const_81);
            _loc1_++;
         }
      }
      ...
      private function createShoreMask(param1:int, param2:int, param3:Number) : BitmapData
      {
         if(this.var_81 == null || this.var_81.width < param1 || this.var_81.height < param2)
         {
            ...
            this.var_81 = ShoreMaskCreatorUtility.method_13(param1,param2);
         }
         return ShoreMaskCreatorUtility.createShoreMask2x2(this.var_81,getSize(param3),this.var_491,this.var_707,assetCollection);
      }
