package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected static const const_2080:Number = Math.sqrt(0.5);
       
      
      private var _direction:int;
      
      private var var_2903:Number = NaN;
      ...
      private var var_2905:Number = 0.0;
      
      private var var_2904:int = -1;
      ...
      private var var_2900:Number = 0.0;
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(param4)
         {
            this.var_1637 |= this.updateAnimation(_loc6_);
         }
         else
         {
            _loc7_ = this.updateAnimation(_loc6_) | this.var_1637;
            this.var_1637 = 0;
         }
         if(_loc5_ || _loc7_ != 0)
         {
      ...
      protected function updateSprites(param1:int, param2:Boolean, param3:int) : void
      {
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         if(this.var_631 != spriteCount)
         {
            createSprites(this.var_631);
         }
         if(param2)
         {
      ...
      private function updateSprite(param1:int, param2:int) : void
      {
         ...
         if(_loc4_ != null && _loc3_ != null)
         {
            ...
            if(_loc5_ != null && _loc5_.asset != null)
            {
               ...
               _loc4_.clickHandling = this.var_2358;
            }
            else
            {
      ...
      protected function getBlendMode(param1:int) : String
      {
         ...
         switch(param1)
         {
            case LayerData.const_434:
               break;
            case LayerData.const_1422:
               _loc2_ = "null";
               break;
            case LayerData.INK_DARKEN:
               _loc2_ = "null";
               break;
            case LayerData.const_1373:
               _loc2_ = "null";
         }
         return _loc2_;
      }
      ...
      protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(var_514 != _loc3_.getUpdateID() || param1 != var_102 || param2 != this.var_2903)
         {
      ...
      protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            this.var_2902 = _loc3_.getNumber(RoomObjectVariableEnum.const_290);
            _loc4_ = Number(_loc3_.getNumber(RoomObjectVariableEnum.const_351));
            if(isNaN(_loc4_))
            {
               _loc4_ = 1;
            }
            ...
            this.var_1352 = this.getAdClickUrl(_loc3_);
            if(this.var_1352 == null || this.var_1352.indexOf("http") != 0)
            {
               this.var_1352 = null;
            }
            this.var_2358 = this.var_1352 != null;
            this.var_2900 = _loc3_.getNumber(RoomObjectVariableEnum.const_986);
      ...
      {
         if(this.var_2901 != param2 || this.var_2905 != param1)
         {
            this.var_1102 = [];
            this.var_1103 = [];
            this.var_892 = [];
            ...
            this.var_2904 = this.getSize(param1);
      ...
      {
         this.var_631 = param1;
         this.var_1638 = this.var_631 - this.getAdditionalSpriteCount();
      }
      ...
      protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         var _loc5_:int = 0;
         var _loc6_:* = null;
         if(this._data == null || param2 >= FurnitureVisualizationData.const_564.length)
         {
            return "";
         }
         var _loc3_:String = this.var_1102[param2];
         var _loc4_:Boolean = this.var_1103[param2];
         if(_loc3_ == null || _loc3_.length == 0)
         {
            _loc5_ = this.var_2904;
            _loc3_ = this._type;
            _loc6_ = "";
            if(param2 != this.var_1638)
            {
               _loc6_ = FurnitureVisualizationData.const_564[param2];
            }
            else
            {
               _loc6_ = "sd";
      ...
      {
         if(this.var_889[param3] != null && !this.var_2116)
         {
      ...
      {
         if(this.var_887[param2] != null)
         {
            return this.var_887[param2];
         }
         if(this._data == null)
         {
      ...
      protected function getSpriteYOffset(param1:int, param2:int, param3:int) : int
      {
         ...
         return Math.ceil(this.var_2900 * (param1 / 2));
      }
