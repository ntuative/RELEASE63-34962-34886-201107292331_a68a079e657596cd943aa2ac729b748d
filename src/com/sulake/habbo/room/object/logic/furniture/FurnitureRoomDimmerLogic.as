package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureRoomDimmerLogic extends FurnitureLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectWidgetRequestEvent.const_164,RoomObjectWidgetRequestEvent.const_116,RoomObjectDimmerStateUpdateEvent.const_67];
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_1994)
         {
            if(eventDispatcher != null && object != null)
            {
               ...
               eventDispatcher.dispatchEvent(_loc3_);
               _loc7_ = new RoomObjectWidgetRequestEvent(RoomObjectWidgetRequestEvent.const_116,_loc1_,_loc2_);
