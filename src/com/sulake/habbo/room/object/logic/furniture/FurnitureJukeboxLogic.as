package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureJukeboxLogic extends FurnitureMultiStateLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectFurnitureActionEvent.const_534,RoomObjectFurnitureActionEvent.const_588,RoomObjectFurnitureActionEvent.const_509,RoomObjectFurnitureActionEvent.const_630,RoomObjectWidgetRequestEvent.const_146];
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(object.getModelController().getNumber(RoomObjectVariableEnum.const_918) == 1)
         {
            object.getModelController().setString(RoomWidgetInfostandExtraParamEnum.const_436,RoomWidgetInfostandExtraParamEnum.const_533);
      ...
      private function requestDispose() : void
      {
         ...
         var _loc1_:RoomObjectFurnitureActionEvent = new RoomObjectFurnitureActionEvent(RoomObjectFurnitureActionEvent.const_509,object.getId(),object.getType());
         eventDispatcher.dispatchEvent(_loc1_);
      }
   }
}
