package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurniturePushableLogic extends FurnitureMultiStateLogic
   {
      ...
      private static const const_1171:int = 0;
      
      private static const const_2126:int = 1;
      
      private static const const_1172:int = 10;
      ...
      {
         super();
         moveUpdateInterval = const_996;
         this.var_2205 = new Vector3d();
      }
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            if(_loc3_.state > 0)
            {
               moveUpdateInterval = const_996 / this.getUpdateIntervalValue(_loc3_.state);
            }
            else
            {
      ...
      override public function update(param1:int) : void
      {
         if(object != null)
         {
            this.var_2205.assign(object.getLocation());
            super.update(param1);
            if(Vector3d.dif(object.getLocation(),this.var_2205).length == 0)
            {
               if(object.getState(0) != const_1171)
               {
                  object.setState(const_1171,0);
               }
            }
         }
      }
