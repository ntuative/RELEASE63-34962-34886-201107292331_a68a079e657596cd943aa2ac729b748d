package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1888:int = 255;
      
      private var var_1556:uint = 16777215;
      
      private var var_1951:int = 255;
      
      private var var_1273:uint = 16777215;
      
      private var var_1952:int = 255;
      
      private var var_1272:int = 0;
      
      private var var_1950:int = 1500;
      ...
      {
         var _loc1_:Array = [RoomObjectMouseEvent.const_636,RoomObjectMouseEvent.const_170];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_849,param1.toString());
            _loc2_.setNumber(RoomObjectVariableEnum.const_843,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_768,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_784,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_814,1);
         }
      }
         ...
         if(this.var_1555)
         {
            if(object != null)
            {
               ...
               if(_loc2_ != null)
               {
                  ...
                  _loc2_.setString(RoomObjectVariableEnum.const_849,_loc3_.toString());
                  _loc2_.setNumber(RoomObjectVariableEnum.const_1218,param1);
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1272)
         {
            _loc2_ = param1;
            _loc3_ = this._color;
            _loc4_ = this.var_1888;
            if(_loc2_ - this.var_1272 >= this.var_1950)
            {
               _loc3_ = this.var_1273;
               _loc4_ = this.var_1952;
               this.var_1272 = 0;
            }
            else
            {
               _loc7_ = this.var_1556 >> 16 & 255;
               _loc8_ = this.var_1556 >> 8 & 255;
               _loc9_ = this.var_1556 & 255;
               _loc10_ = this.var_1273 >> 16 & 255;
               _loc11_ = this.var_1273 >> 8 & 255;
               _loc12_ = this.var_1273 & 255;
               _loc13_ = (_loc2_ - this.var_1272) / this.var_1950;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_1951 + (this.var_1952 - this.var_1951) * _loc13_;
               this._color = _loc3_;
               this.var_1888 = _loc4_;
            }
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_843,_loc3_);
         }
      }
      ...
      private function updatePlaneTypes(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_810:
               param2.setString(RoomObjectVariableEnum.const_231,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_740:
               param2.setString(RoomObjectVariableEnum.const_230,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_748:
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_522:
               _loc5_ = "null";
               if(param1.maskCategory == RoomObjectRoomMaskUpdateMessage.const_310)
               {
                  _loc5_ = "null";
               }
               ...
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_759:
         ...
         if(_loc4_)
         {
            ...
            param2.setString(RoomObjectVariableEnum.const_1272,_loc7_);
         }
      }
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1185:
               param2.setNumber(RoomObjectVariableEnum.const_768,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1308:
               param2.setNumber(RoomObjectVariableEnum.const_784,_loc3_);
               param2.setNumber(RoomObjectVariableEnum.const_814,_loc3_);
         }
      }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomPlanePropertyUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomPlanePropertyUpdateMessage.const_688:
               param2.setNumber(RoomObjectVariableEnum.const_1305,param1.value);
               break;
            case RoomObjectRoomPlanePropertyUpdateMessage.const_1348:
               param2.setNumber(RoomObjectVariableEnum.const_1374,param1.value);
         }
      }
      ...
      private function updateFloorHoles(param1:RoomObjectRoomFloorHoleUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomFloorHoleUpdateMessage.const_158:
               this._planeParser.addFloorHole(param1.id,param1.x,param1.y,param1.width,param1.height);
               this.var_1555 = true;
               break;
            case RoomObjectRoomFloorHoleUpdateMessage.const_171:
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_1370,int(param1.bgOnly));
         this.var_1556 = this._color;
         this.var_1951 = this.var_1888;
         this.var_1273 = _loc3_;
         this.var_1952 = _loc4_;
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > this._planeParser.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_651,0);
            }
            return;
         }
         _loc5_--;
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1895,_loc19_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1834,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1993,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_651,_loc5_ + 1);
            var _loc22_:String = "";
            var _loc23_:int = 0;
            var _loc24_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc12_ == RoomPlaneData.const_259 || _loc12_ == RoomPlaneData.const_423)
                     {
                        _loc26_ = 90;
                        if(_loc11_ != null)
                        {
