package com.sulake.habbo.room.object.logic
{
   ...
   public class PetLogic extends MovingObjectLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectMouseEvent.const_170,RoomObjectMoveEvent.const_444];
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(!this.var_2906)
         {
            ...
            if(param1 is RoomObjectAvatarChatUpdateMessage)
            {
               ...
               this.var_1640 = getTimer() + _loc5_.numberOfWords * 1000;
               return;
            }
            ...
            if(param1 is RoomObjectAvatarSleepUpdateMessage)
            {
               ...
               _loc2_.setNumber(RoomObjectVariableEnum.const_278,Number(_loc7_.isSleeping));
               return;
            }
         }
         ...
         if(param1 is RoomObjectAvatarExperienceUpdateMessage)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_429,Number(_loc9_.gainedExperience));
            return;
         }
         if(param1 is RoomObjectAvatarFigureUpdateMessage)
         {
            ...
            _loc2_.setString(RoomObjectVariableEnum.const_1940,_loc10_.race);
            _loc2_.setNumber(RoomObjectVariableEnum.const_969,this.getPaletteIndex(_loc10_.figure));
            return;
         }
      }
      ...
      private function debugMouseEvent(param1:RoomSpriteMouseEvent) : void
      {
         ...
         if(!param1.altKey && !param1.ctrlKey)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_213,_loc3_ + this.var_1104);
         }
         else if(param1.altKey && !param1.ctrlKey)
         {
            ++this.var_2120;
            _loc2_.setNumber(RoomObjectVariableEnum.const_295,this.var_2120);
            _loc2_.setNumber(RoomObjectVariableEnum.const_161,NaN);
         }
         else if(param1.ctrlKey && !param1.altKey)
         {
            ++this.var_2121;
            _loc2_.setNumber(RoomObjectVariableEnum.const_161,this.var_2121);
         }
         else
         {
            this.var_1104 += 45;
