   ...
   public class RoomSessionManager extends Component implements IRoomSessionManager, IRoomHandlerListener
   {
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_253)
         {
            ...
            {
               _loc1_ = this.var_253.getKey(0) as String;
               _loc2_ = this.var_253.remove(_loc1_) as RoomSession;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
         ...
         {
            _loc3_ = 0;
            while(_loc3_ < this.var_87.length)
            {
               _loc4_ = this.var_87[_loc3_] as IDisposable;
               if(_loc4_)
               {
                  _loc4_.dispose();
               }
      ...
      private function createHandlers() : void
      {
         ...
         this.var_87.push(new RoomSessionHandler(this._connection,this));
         this.var_87.push(new RoomChatHandler(this._connection,this));
         this.var_87.push(new RoomUsersHandler(this._connection,this));
         this.var_87.push(new RoomPermissionsHandler(this._connection,this));
         this.var_87.push(new AvatarEffectsHandler(this._connection,this));
         this.var_87.push(new RoomDataHandler(this._connection,this));
         this.var_87.push(new PresentHandler(this._connection,this));
         this.var_87.push(new PlaceObjectErrorHandler(this._connection,this));
         this.var_87.push(new TeleportErrorHandler(this._connection,this));
         this.var_87.push(new GenericErrorHandler(this._connection,this));
         this.var_87.push(new PollHandler(this._connection,this));
         this.var_87.push(new VoteHandler(this._connection,this));
         this.var_87.push(new LidoHandler(this._connection,this));
         this.var_87.push(new RoomDimmerPresetsHandler(this._connection,this));
         this.var_87.push(new ViralFurniHandler(this._connection,this));
         this.var_87.push(new UserNotificationHandler(this._connection,this));
         this.var_87.push(new PetPackageHandler(this._connection,this));
      }
      ...
      private function initializeManager() : void
      {
         ...
         if(this.initialized && this.var_2047)
         {
            this.gotoRoom(this.var_2783,this.var_2784,this.var_2048);
            this.var_2047 = false;
            this.var_2048 = "";
         }
      }
      ...
      public function gotoRoom(param1:Boolean, param2:int, param3:String = "", param4:String = "") : Boolean
      {
         ...
         this.var_253.add(_loc6_,_loc7_);
         events.dispatchEvent(new RoomSessionEvent(RoomSessionEvent.const_293,_loc7_));
         return true;
      }
      ...
      public function sessionReinitialize(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         var _loc6_:RoomSession = this.var_253.remove(_loc5_) as RoomSession;
         if(_loc6_ != null)
         {
            param4 = param2;
            _loc6_.reset(param3,param4);
            _loc5_ = this.getRoomIdentifier(param3,param4);
            _loc7_ = this.var_253.remove(_loc5_);
            if(_loc7_ != null)
            {
            }
            this.var_253.add(_loc5_,_loc6_);
      ...
      public function getSession(param1:int, param2:int) : IRoomSession
      {
         ...
         return this.var_253.getValue(_loc3_) as IRoomSession;
      }
      
      public function disposeSession(param1:int, param2:int) : void
      {
         var _loc3_:String = this.getRoomIdentifier(param1,param2);
         var _loc4_:RoomSession = this.var_253.remove(_loc3_) as RoomSession;
         if(_loc4_ != null)
         {
            events.dispatchEvent(new RoomSessionEvent(RoomSessionEvent.const_85,_loc4_));
            _loc4_.dispose();
         }
      }
      ...
      private function updateHandlers(param1:IRoomSession) : void
      {
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(param1 != null && this.var_87 != null)
         {
            _loc2_ = 0;
            while(_loc2_ < this.var_87.length)
            {
               _loc3_ = this.var_87[_loc2_] as BaseHandler;
               if(_loc3_ != null)
               {
