package com.sulake.habbo.session.facebook
{
   ...
   public class FaceBookSession implements IDisposable
   {
      ...
      private static const const_1143:String = "FlashExternalInterface.authenticateFacebook";
      
      private static const const_1652:String = "sendAccessTokenToServer";
      
      private static const const_1651:String = "fbKLogOut";
      ...
      private function onAuthenticate(param1:FaceBookAuthenticateEvent) : void
      {
         ...
         if(false)
         {
            ExternalInterface.addCallback(const_1652,this.jsFaceBookLogInCallback);
            ExternalInterface.addCallback(const_1651,this.jsFaceBookLogOutCallback);
            Logger.log("-- -- ADDED JAVASCRIPT CALLBACK HOOKS!");
            ExternalInterface.call(const_1143);
            Logger.log("-- -- CALLED JAVASCRIPT METHOD " + const_1143);
         }
      }
