package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_1197:Number = 32;
      ...
      private var var_455:Number = 1.0;
      ...
      private var var_1795:Number = 1.0;
      
      private var var_105:Vector3d;
      
      private var var_457:Vector3d;
      
      private var var_3088:Number = -500.0;
      
      private var var_3089:Number = 500.0;
      
      private var var_530:Map = null;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         this.x_scale = 1;
         this.y_scale = 1;
         this.var_1795 = Math.sqrt(0.5) / Math.sqrt(0.75);
         this.z_scale = 1;
      ...
      {
         this.var_453.assign(this.var_105);
         this.var_453.x *= this.var_455;
         this.var_453.y *= this.var_456;
         this.var_453.z *= this.var_454;
         return this.var_453;
      }
      ...
      {
         if(this.var_455 != param1 * this.var_1793)
         {
            this.var_455 = param1 * this.var_1793;
            ++this.var_172;
         }
      }
      ...
      {
         if(this.var_456 != param1 * this.var_1794)
         {
            this.var_456 = param1 * this.var_1794;
            ++this.var_172;
         }
      }
      ...
      {
         if(this.var_454 != param1 * this.var_1795)
         {
            this.var_454 = param1 * this.var_1795;
            ++this.var_172;
         }
      }
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         this.var_105.x /= this.var_455;
         this.var_105.y /= this.var_456;
         this.var_105.z /= this.var_454;
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         var _loc2_:Number = this.var_457.x;
         var _loc3_:Number = this.var_457.y;
         var _loc4_:Number = this.var_457.z;
         this.var_457.assign(param1);
         this._direction.assign(param1);
         if(this.var_457.x != _loc2_ || this.var_457.y != _loc3_ || this.var_457.z != _loc4_)
         {
            ++this.var_172;
         }
         ...
         if(_loc10_ != 0)
         {
            ...
            this.var_188.assign(_loc25_);
            this.var_1190.assign(this.var_188);
         }
         else
         {
            this._x.assign(_loc18_);
            this.var_187.assign(_loc19_);
            this.var_188.assign(_loc20_);
            this.var_1190.assign(this.var_188);
         }
      }
      ...
      public function setDisplacement(param1:IVector3d, param2:IVector3d) : void
      {
         ...
         if(this.var_530 != null)
         {
            ...
            this.var_530.remove(_loc3_);
            _loc4_ = new Vector3d();
            _loc4_.assign(param2);
            this.var_530.add(_loc3_,_loc4_);
            ++this.var_172;
         }
      }
      ...
      private function getDisplacenent(param1:IVector3d) : IVector3d
      {
         ...
         if(this.var_530 != null)
         {
            ...
            return this.var_530.getValue(_loc2_);
         }
         return null;
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            this.var_1189.assign(_loc22_);
         }
         else
         {
            this.var_1189.assign(_loc17_);
         }
         ++this.var_172;
      }
      ...
      {
         if(param1 == null || this.var_188 == null)
         {
            return;
         }
         var _loc3_:Vector3d = Vector3d.product(this.var_188,-param2);
      ...
      public function getCoordinatePosition(param1:IVector3d) : IVector3d
      {
         ...
         var _loc4_:Number = Vector3d.scalarProjection(param1,this.var_188);
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.x *= this.var_455;
         _loc2_.y *= this.var_456;
         _loc2_.z *= this.var_454;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,this.var_1189);
         if(_loc3_ < this.var_3088 || _loc3_ > this.var_3089)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= this.var_456;
            _loc2_.z *= this.var_454;
            _loc3_ = Vector3d.scalarProjection(_loc2_,this.var_1189);
         }
         _loc2_.x = _loc4_;
         _loc2_.y = _loc5_;
         _loc2_.z = _loc3_;
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(this.var_105.x * this.var_455,this.var_105.y * this.var_456,this.var_105.z * this.var_454);
         _loc8_.add(_loc7_);
         var _loc9_:IVector3d = this.var_188;
         var _loc10_:Vector3d = new Vector3d(param2.x * this.var_455,param2.y * this.var_456,param2.z * this.var_454);
         var _loc11_:Vector3d = new Vector3d(param3.x * this.var_455,param3.y * this.var_456,param3.z * this.var_454);
         var _loc12_:Vector3d = new Vector3d(param4.x * this.var_455,param4.y * this.var_456,param4.z * this.var_454);
      ...
      public function performZoom() : void
      {
         if(this.isZoomedIn())
         {
            this.scale = const_1197;
         }
         else
         {
            this.scale = const_536;
         }
      }
      
      public function isZoomedIn() : Boolean
      {
         return this.scale == const_536;
      }
