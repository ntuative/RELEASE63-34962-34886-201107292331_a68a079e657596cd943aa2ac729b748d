package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      public static const const_1831:int = 0;
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         events.addEventListener(RoomContentLoadedEvent.const_411,this.onContentLoaded);
         events.addEventListener(RoomContentLoadedEvent.const_621,this.onContentLoaded);
         events.addEventListener(RoomContentLoadedEvent.const_1022,this.onContentLoaded);
      }
      ...
      private function objectFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_635 = param2 as IRoomObjectFactory;
      ...
      {
         var _loc1_:* = null;
         if(this.var_635 == null || this.var_533 == null)
         {
            return;
         }
      ...
      public function createRoomObject(param1:String, param2:int, param3:String, param4:int) : IRoomObject
      {
         ...
         var _loc19_:IRoomObjectEventHandler = this.var_635.createRoomObjectLogic(_loc11_);
      ...
      public function createRoomObjectManager() : IRoomObjectManager
      {
         if(this.var_635 != null)
         {
            return this.var_635.createRoomObjectManager();
         }
         return null;
      }
      ...
      private function processInitialContentLoad(param1:String) : void
      {
         ...
         if(this._state == const_845)
         {
            return;
         }
         if(this.var_58 == null)
         {
            this._state = const_845;
            return;
         }
         if(this.var_58.getGraphicAssetCollection(param1) != null)
         {
      ...
      private function onContentLoaded(param1:RoomContentLoadedEvent) : void
      {
         ...
         if(this.var_989.indexOf(_loc2_) < 0)
         {
            this.var_989.push(_loc2_);
         }
      }
      ...
      private function processLoadedContentTypes() : void
      {
         ...
         while(this.var_989.length > 0)
         {
            _loc2_ = this.var_989[0];
            this.var_989.splice(0,1);
            ...
            _loc5_ = getTimer();
            if(_loc5_ - _loc1_ >= CONTENT_PROCESSING_TIME_LIMIT_MILLISECONDS && this.var_2444)
            {
               this.var_1816 = true;
               break;
            }
                     ...
                     if(_loc15_ != null)
                     {
                        ...
                        if(_loc16_ != null)
                        {
                           ...
                           else
                           {
                              ...
                              _loc17_ = this.var_635.createRoomObjectLogic(_loc6_);
