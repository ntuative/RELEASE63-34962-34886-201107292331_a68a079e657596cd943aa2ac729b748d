package com.sulake.room.object
{
   ...
   public class RoomObject implements IRoomObjectController
   {
      ...
      public function RoomObject(param1:int, param2:int, param3:String)
      {
         ...
         this.var_2021 = new Vector3d();
         this.var_2022 = new Vector3d();
         this.var_696 = new Array(param2);
         var _loc4_:Number = param2 - 1;
         while(_loc4_ >= 0)
         {
            this.var_696[_loc4_] = 0;
            _loc4_--;
         }
         this._type = param3;
      ...
      {
         this.var_2021.assign(this.var_105);
         return this.var_2021;
      }
      
      public function getDirection() : IVector3d
      {
         this.var_2022.assign(this.var_457);
      ...
      {
         if(param1 >= 0 && param1 < this.var_696.length)
         {
      ...
      public function setDirection(param1:IVector3d) : void
      {
         ...
         if(this.var_457.x != param1.x || this.var_457.y != param1.y || this.var_457.z != param1.z)
         {
            this.var_457.x = (param1.x % 360 + 360) % 360;
            this.var_457.y = (param1.y % 360 + 360) % 360;
            this.var_457.z = (param1.z % 360 + 360) % 360;
            ++this._updateID;
         }
      }
      ...
      {
         if(param2 >= 0 && param2 < this.var_696.length)
         {
            if(this.var_696[param2] != param1)
            {
               this.var_696[param2] = param1;
               ++this._updateID;
            }
            return true;
         }
