package com.sulake.room.object.visualization
{
   ...
   public class RoomObjectSpriteVisualization implements IRoomObjectSpriteVisualization
   {
      ...
      private var var_398:IRoomObject;
      
      private var var_811:IGraphicAssetCollection;
      
      protected var var_514:int = -1;
      
      protected var var_148:int = -1;
      ...
      public function set assetCollection(param1:IGraphicAssetCollection) : void
      {
         ...
         {
            this.var_811.removeReference();
         }
         this.var_811 = param1;
         if(this.var_811 != null)
         {
            this.var_811.addReference();
         }
      }
      ...
      {
         this.var_514 = 4294967295;
         this.var_148 = 4294967295;
         this.var_102 = -1;
      }
