package com.sulake.room.renderer.cache
{
   ...
   public class BitmapDataCache
   {
      ...
      public function BitmapDataCache(param1:int, param2:int, param3:int = 1)
      {
         ...
         this.var_1006 = param1 * 1024 * 1024;
         this.var_1863 = param2 * 1024 * 1024;
         this.var_1508 = param3 * 1024 * 1024;
         if(this.var_1508 < 0)
         {
            this.var_1508 = 0;
         }
      ...
      {
         this.var_1006 += this.var_1508;
         if(this.var_1006 > this.var_1863)
         {
            this.var_1006 = this.var_1863;
         }
      }
      ...
      public function addBitmapData(param1:String, param2:ExtendedBitmapData) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc4_ != null)
            {
               this.var_808 -= _loc4_.width * _loc4_.height * 4;
            }
         ...
         this.var_808 += param2.width * param2.height * 4;
      }
   }
}
