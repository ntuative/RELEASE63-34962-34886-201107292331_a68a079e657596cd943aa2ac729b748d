package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      public static const const_233:String = "regular";
      ...
      private static const const_1663:String = "/*";
      
      private static const const_1662:String = "*/";
      ...
      public static function setStyles(param1:Array, param2:Boolean = false) : void
      {
         ...
         if(param2)
         {
            _loc5_ = [var_100[const_233],var_100[ITALIC],var_100[BOLD]];
            var_100.reset();
            var_100[const_233] = _loc5_[0];
      ...
      private static function parseStyleNamesFromCSS(param1:String) : Array
      {
         ...
         if(countSubStrings(param1,const_717) != countSubStrings(param1,const_718))
         {
            throw new Error("Mismatching amount of \"" + const_717 + "\" versus \"" + const_718 + "\", please check the CSS!");
         }
         for each(_loc5_ in _loc4_)
         {
            while(_loc5_.indexOf(const_1663) == 0)
            {
               _loc5_ = _loc5_.substring(_loc5_.indexOf(const_1662) + 2,_loc5_.length);
            }
