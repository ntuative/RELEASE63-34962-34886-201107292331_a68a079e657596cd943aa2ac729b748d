package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_2337:String = "_INCLUDE";
      
      public static const const_2342:String = "_TEMP";
      
      private static const const_1637:String = "layout";
      ...
      private static const const_1644:String = "style";
      
      private static const const_711:String = "params";
      
      private static const const_1642:String = "tags";
      ...
      private static const const_1636:String = "visible";
      
      private static const const_1634:String = "caption";
      
      private static const ID:String = "id";
      
      private static const const_4:String = "background";
      
      private static const const_1223:String = "blend";
      
      private static const const_1640:String = "clipping";
      
      private static const COLOR:String = "color";
      
      private static const const_1646:String = "treshold";
      
      private static const const_1639:String = "children";
      
      private static const const_1633:String = "width_min";
      
      private static const WIDTH_MAX:String = "width_max";
      
      private static const const_1635:String = "height_min";
      
      private static const const_1645:String = "height_max";
      
      private static const const_712:String = "true";
      
      private static const const_189:String = "0";
      
      private static const const_1647:String = "$";
      
      private static const const_1641:String = ",";
      
      private static const const_51:String = "";
      
      private static const const_1643:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1638:RegExp = /(\s|\n|\r|\t|\v)*$/;
       
      
      protected var var_1433:Dictionary;
      
      protected var var_1432:Dictionary;
      
      protected var var_1159:Dictionary;
      
      protected var var_1723:Dictionary;
      
      protected var var_2284:Map;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         this.var_1433 = new Dictionary();
         this.var_1432 = new Dictionary();
         TypeCodeTable.fillTables(this.var_1433,this.var_1432);
         this.var_1159 = new Dictionary();
         this.var_1723 = new Dictionary();
         ParamCodeTable.fillTables(this.var_1159,this.var_1723);
         this.var_2284 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1638,const_51);
         return param1.replace(const_1643,const_51);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            for(_loc1_ in this.var_1433)
            {
               delete this.var_1433[_loc1_];
            }
            for(_loc1_ in this.var_1432)
            {
               delete this.var_1432[_loc1_];
            }
            for(_loc1_ in this.var_1159)
            {
               delete this.var_1159[_loc1_];
            }
            for(_loc1_ in this.var_1723)
            {
               delete this.var_1723[_loc1_];
            }
            this.var_2284.dispose();
            this.var_2284 = null;
            this._context = null;
            this._disposed = true;
         }
      ...
      public function parseAndConstruct(param1:XML, param2:IWindow, param3:Map) : IWindow
      {
         ...
         var _loc12_:* = null;
         var _loc13_:int = 0;
         if(param1.localName() == const_1637)
         {
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         var id:int = 0;
         type = this.var_1433[xml.localName()];
         name = unescape(String(this.parseAttribute(xml,const_701,variables,"")));
         style = uint(this.parseAttribute(xml,const_1644,variables,style));
         params = uint(this.parseAttribute(xml,const_711,variables,params));
         tag = unescape(String(this.parseAttribute(xml,const_1642,variables,tag)));
         rect = new Rectangle();
         ...
         visible = this.parseAttribute(xml,const_1636,variables,visible.toString()) == const_712;
         ...
         if(xml.child(const_711).length() > 0)
         {
            ...
            {
               node = list[i];
               param = this.parseAttribute(node,const_701,variables,"") as String;
               if(this.var_1159[param] == null)
               {
                  throw new Error("Unknown window parameter \"" + String(node.attribute(const_701)) + "\"!");
               }
               params |= this.var_1159[param];
               i++;
            }
         }
         caption = !!(params & 0) ? (!!parent ? parent.caption : const_51) : const_51;
         caption = unescape(String(this.parseAttribute(xml,const_1634,variables,caption)));
         if(tag != const_51)
         {
            tags = tag.split(const_1641);
            length = tags.length;
            i = 0;
            while(i < length)
            {
         ...
         window.limits.minWidth = int(this.parseAttribute(xml,const_1633,variables,window.limits.minWidth));
         ...
         window.limits.maxHeight = int(this.parseAttribute(xml,const_1645,variables,window.limits.maxHeight));
         background = this.parseAttribute(xml,const_4,variables,window.background.toString()) == const_712;
         blend = Number(this.parseAttribute(xml,const_1223,variables,window.blend.toString()));
         clipping = this.parseAttribute(xml,const_1640,variables,window.clipping.toString()) == const_712;
         color = String(this.parseAttribute(xml,COLOR,variables,window.color.toString()));
         treshold = uint(this.parseAttribute(xml,const_1646,variables,window.mouseThreshold.toString()));
         ...
         if(window != null)
         {
            if(parent != null)
            {
               if(parent is IIterable)
               {
                  ...
                  {
                     if((params & 0) == WindowParam.const_228)
                     {
                        window.x = rect.x;
                     }
      ...
      public function windowToXMLString(param1:IWindow) : String
      {
         ...
         var _loc2_:* = const_51;
         var _loc3_:String = this.var_1432[param1.type];
