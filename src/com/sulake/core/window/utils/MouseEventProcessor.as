package com.sulake.core.window.utils
{
   ...
   public class MouseEventProcessor implements IEventProcessor, IDisposable
   {
      ...
      protected static var var_369:Array;
      ...
      protected var var_949:IWindowContextStateListener;
      ...
      public function MouseEventProcessor()
      {
         ...
         {
            var_369 = new Array();
            var_369[0] = MouseCursorType.const_332;
            var_369[1] = MouseCursorType.const_29;
            var_369[2] = MouseCursorType.const_332;
            var_369[3] = MouseCursorType.const_332;
            var_369[4] = MouseCursorType.const_332;
            var_369[5] = MouseCursorType.const_29;
            var_369[6] = MouseCursorType.const_332;
         }
         if(var_320 == null)
         {
            var_320 = new Array();
            var_320[0] = WindowState.const_93;
            var_320[1] = WindowState.const_87;
            var_320[2] = WindowState.const_88;
            var_320[3] = WindowState.const_68;
            var_320[4] = WindowState.const_55;
            var_320[5] = WindowState.const_96;
            var_320[6] = WindowState.const_94;
         }
      }
      ...
      public function process(param1:EventProcessorState, param2:IEventQueue) : void
      {
         ...
         this.var_193 = state.var_1417 as WindowController;
         this.var_182 = state.renderer;
         this.var_949 = state.var_1418;
         eventQueue.begin();
         this.var_765.x = -1;
         this.var_765.y = -1;
         ...
         while(true)
         {
            ...
            if(event.stageX != this.var_765.x || event.stageY != this.var_765.y)
            {
               this.var_765.x = event.stageX;
               this.var_765.y = event.stageY;
               array = new Array();
               this.var_96.groupParameterFilteredChildrenUnderPoint(this.var_765,array,WindowParam.const_30);
               ...
               if(child != null && child.visible)
               {
                  ...
                  else if(event.type == MouseEvent.MOUSE_UP || event.type == MouseEvent.CLICK)
                  {
                     if(this.var_71 && !this.var_71.disposed)
                     {
                        ...
                        {
                           this.var_949.mouseEventReceived(event.type,this.var_71);
                        }
                     }
                  }
                  temp = child.parent;
         ...
         state.var_1417 = this.var_193;
         state.renderer = this.var_182;
         state.var_1418 = this.var_949;
      }
