package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow, ITouchAwareWindow
   {
      ...
      private static const const_1511:String = "increment";
      
      private static const const_1510:String = "decrement";
      
      private static const const_1077:String = "slider_track";
      
      private static const const_692:String = "slider_bar";
       
      
      protected var _offset:Number = 0;
      
      protected var var_756:Number = 0.1;
      ...
      public function ScrollbarController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0, param12:IScrollableWindow = null)
      {
         ...
         var_192 = false;
         this.var_18 = param12;
         this._horizontal = param2 == WindowType.const_583;
      ...
      public function set scrollable(param1:IScrollableWindow) : void
      {
         if(this.var_18 != null && !this.var_18.disposed)
         {
            ...
            this.var_18.removeEventListener(WindowEvent.const_523,this.onScrollableScrolled);
         }
         this.var_18 = param1;
         if(this.var_18 != null && !this.var_18.disposed)
         {
            this.var_18.addEventListener(WindowEvent.const_41,this.onScrollableResized);
            this.var_18.addEventListener(WindowEvent.const_523,this.onScrollableScrolled);
            this.updateLiftSizeAndPosition();
         }
      }
      ...
      {
         return findChildByName(const_1077) as WindowController;
      }
      
      protected function get lift() : WindowController
      {
         return this.track.findChildByName(const_692) as WindowController;
      }
      ...
      override public function update(param1:WindowController, param2:WindowEvent) : Boolean
      {
         switch(param1.name)
         {
            case ScrollbarController.const_692:
         ...
         if(param2.type == WindowEvent.const_625)
         {
            if(this.var_18 == null)
            {
         ...
         if(param1 == this)
         {
            ...
            else if(param2.type == WindowMouseEvent.const_348)
            {
               if(WindowMouseEvent(param2).delta > 0)
               {
                  if(this._horizontal)
                  {
                     this.scrollH -= this.var_756;
                  }
                  else
                  {
                     this.scrollV -= this.var_756;
                  }
               }
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_44 || param1.type == WindowTouchEvent.const_773)
         {
            ...
            else if(param2.name == const_1510)
            {
               if(this.var_18)
               {
                  this.var_1229 = true;
            ...
            else if(param2.name == const_1077)
            {
               ...
               _loc6_ = WindowController(param2).getChildByName(ScrollbarController.const_692).rectangle;
               if(this._horizontal)
               {
                  if(_loc4_ < _loc6_.x)
                  {
         ...
         if(param1.type == WindowMouseEvent.const_348)
         {
