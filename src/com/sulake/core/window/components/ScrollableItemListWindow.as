package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_1285:IItemListWindow;
      
      private var var_477:IScrollbarWindow;
      ...
      override public function dispose() : void
      {
         if(this.var_477)
         {
            this.var_477.removeEventListener(WindowEvent.const_288,this.scrollBarEventProc);
            this.var_477.removeEventListener(WindowEvent.const_283,this.scrollBarEventProc);
            this.var_477 = null;
         }
         if(this.var_1285)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_1285)
         {
            this.var_1285 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_477)
         {
            this.var_477 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(this.var_477)
            {
               this.var_477.addEventListener(WindowEvent.const_288,this.scrollBarEventProc);
               this.var_477.addEventListener(WindowEvent.const_283,this.scrollBarEventProc);
            }
         }
         return this.var_477;
      }
