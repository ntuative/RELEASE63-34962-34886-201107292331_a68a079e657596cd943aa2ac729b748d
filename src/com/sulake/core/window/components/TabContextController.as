package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1573:String = "_SELECTOR";
      
      private static const const_1572:String = "_CONTENT";
       
      
      protected var var_1155:ITabSelectorWindow;
      
      protected var var_2277:IWindowContainer;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_1155 = findChildByTag(const_1573) as ITabSelectorWindow;
            if(this.var_1155 != null)
            {
               this.var_1155.procedure = this.selectorEventProc;
            }
         }
      ...
      public function get container() : IWindowContainer
      {
         ...
         {
            this.var_2277 = findChildByTag(const_1572) as IWindowContainer;
         }
      ...
      {
         return !!this.var_841 ? this.selector.iterator : null;
      }
      
      public function get numTabItems() : uint
      {
         return this.var_1155.numSelectables;
      }
