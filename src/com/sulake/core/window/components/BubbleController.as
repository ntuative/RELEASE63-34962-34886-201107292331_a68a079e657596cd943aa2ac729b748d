package com.sulake.core.window.components
{
   ...
   public class BubbleController extends FrameController implements IBubbleWindow
   {
      ...
      private static const const_2131:String = "_POINTER_UP";
      
      private static const const_2128:String = "_POINTER_DOWN";
      
      private static const const_2130:String = "_POINTER_LEFT";
      
      private static const const_2129:String = "_POINTER_RIGHT";
      ...
      public function set direction(param1:String) : void
      {
         ...
         if(param1 != this._direction)
         {
            ...
            this.pointerOffset = this.var_932;
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_839,this._direction,PropertyStruct.const_53,true));
         }
         else
         {
         ...
         if(this.var_932 != 0)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_913,this.var_932,PropertyStruct.const_36,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1871);
         }
         return _loc1_;
      }
