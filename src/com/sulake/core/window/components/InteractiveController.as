package com.sulake.core.window.components
{
   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      {
         this.var_1719 = PropertyDefaults.const_860;
         this.var_1427 = PropertyDefaults.const_399;
         param4 |= 0;
      ...
      {
         if(param1.toolTipCaption != PropertyDefaults.const_399)
         {
      ...
      public static function writeInteractiveWindowProperties(param1:IInteractiveWindow, param2:Array) : Array
      {
         if(param1.toolTipCaption != PropertyDefaults.const_399)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_881,param1.toolTipCaption,PropertyStruct.const_53,true));
         }
         else
         {
            param2.push(PropertyDefaults.const_2034);
         }
         if(param1.toolTipDelay != PropertyDefaults.const_860)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_821,param1.toolTipDelay,PropertyStruct.const_265,true));
         }
         else
         {
      ...
      {
         this.var_1427 = param1 == null ? "null" : param1;
      }
