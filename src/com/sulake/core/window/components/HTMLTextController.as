package com.sulake.core.window.components
{
   ...
   public class HTMLTextController extends TextFieldController implements IHTMLTextWindow
   {
      ...
      private static var var_1061:String = PropertyDefaults.HTML_LINK_TARGET_VALUE;
       
      
      private var var_1062:String = "default";
      
      private var var_1300:String = null;
      
      private var var_2001:StyleSheet = null;
      ...
      private static function setHtmlStyleSheetString(param1:HTMLTextController, param2:String) : void
      {
         ...
         if(param1.var_1300 == param2)
         {
            return;
         }
         param1.var_1300 = param2;
         param1.var_2001 = null;
         if(param1.var_1300 != null)
         {
            _loc3_ = new StyleSheet();
            _loc3_.parseCSS(param1.var_1300);
            param1.var_2001 = _loc3_;
         }
      }
      ...
      {
         if(PropertyDefaults.const_940.indexOf(param1) > -1)
         {
      ...
      {
         return this.var_1062 == LinkTarget.const_29 ? defaultLinkTarget : this.var_1062;
      }
      ...
      override public function set htmlText(param1:String) : void
      {
         ...
         {
            _field.htmlText = convertLinksToEvents(var_17);
            _field.styleSheet = this.var_2001;
            refreshTextImage();
         }
      }
      ...
      override protected function immediateClickHandler(param1:Event) : void
      {
         ...
         if(param1 is TextEvent)
         {
            ...
            if(!_loc2_.isWindowOperationPrevented() && this.linkTarget != LinkTarget.const_1418)
            {
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_1062 != PropertyDefaults.HTML_LINK_TARGET_VALUE)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_901,this.var_1062,PropertyStruct.const_53,true,PropertyDefaults.const_940));
         }
         else
         {
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_901)
            {
               this.var_1062 = _loc2_.value as String;
               break;
            }
