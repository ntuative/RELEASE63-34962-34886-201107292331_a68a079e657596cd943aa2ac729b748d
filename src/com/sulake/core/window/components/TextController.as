package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static const const_1426:Dictionary = createPropertySetterTable();
       
      
      protected var _field:TextField;
      
      protected var var_941:Number;
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         if(!_loc4_)
         {
            _loc4_ = TextStyleManager.getStyle(TextStyleManager.const_233);
         }
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_905 ? true : null;
         }
      ...
      {
         this.var_941 = param1;
         this._field.scrollH = this.var_941 * Number(this._field.maxScrollH);
      ...
      {
         return new Rectangle(this.var_941 * this.maxScrollH,this.var_610 * this.maxScrollV,width,height);
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_1004,this._field.antiAliasType,PropertyStruct.const_53,this._field.antiAliasType != _loc2_.antiAliasType,PropertyDefaults.const_1345));
         _loc1_.push(this._autoSize != PropertyDefaults.const_1295 ? new PropertyStruct(PropertyDefaults.const_1007,this._autoSize,PropertyStruct.const_53,true,PropertyDefaults.const_1233) : PropertyDefaults.const_1880);
         ...
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_1263 ? new PropertyStruct(PropertyDefaults.const_1202,this._field.gridFitType,PropertyStruct.const_53,true,PropertyDefaults.const_1340) : PropertyDefaults.const_1883);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_1023) ? new PropertyStruct(PropertyDefaults.const_397,this._field.textColor,PropertyStruct.const_172,true) : PropertyDefaults.const_1322);
         _loc1_.push(this.var_462 != TextStyleManager.const_233 ? new PropertyStruct(PropertyDefaults.const_406,this.var_462,PropertyStruct.const_53,true,PropertyDefaults.const_917) : PropertyDefaults.const_1212);
         _loc1_.push(this.var_42.left != PropertyDefaults.const_1024 ? new PropertyStruct(PropertyDefaults.const_267,this.var_42.left,PropertyStruct.const_36,true) : PropertyDefaults.const_785);
         _loc1_.push(this.var_42.top != PropertyDefaults.const_746 ? new PropertyStruct(PropertyDefaults.const_271,this.var_42.top,PropertyStruct.const_36,true) : PropertyDefaults.const_902);
         _loc1_.push(this.var_42.right != PropertyDefaults.const_852 ? new PropertyStruct(PropertyDefaults.const_289,this.var_42.right,PropertyStruct.const_36,true) : PropertyDefaults.const_888);
         _loc1_.push(this.var_42.bottom != PropertyDefaults.const_868 ? new PropertyStruct(PropertyDefaults.const_260,this.var_42.bottom,PropertyStruct.const_36,true) : PropertyDefaults.const_946);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_1405 ? new PropertyStruct(PropertyDefaults.const_898,this._field.mouseWheelEnabled,PropertyStruct.const_39,true) : PropertyDefaults.const_2026);
