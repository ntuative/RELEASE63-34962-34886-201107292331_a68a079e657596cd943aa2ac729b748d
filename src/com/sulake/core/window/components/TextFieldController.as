package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      protected var var_1719:uint = 500;
      
      protected var var_1427:String = "";
      
      protected var var_1425:Boolean = false;
      
      protected var var_841:Boolean = false;
      ...
      {
         this.var_1427 = param1 == null ? "" : param1;
      }
      ...
      override public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_21)
         {
            var_21 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_1275,var_10);
         }
         return var_21;
      }
      ...
      protected function refreshAutoSize() : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_841 && autoSize != TextFieldAutoSize.NONE)
         {
            if(false)
            {
      ...
      private function onKeyDownEvent(param1:KeyboardEvent) : void
      {
         ...
         {
            _context.handleError(WindowContext.const_453,e);
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(true ? new PropertyStruct(PropertyDefaults.const_884,false,PropertyStruct.const_39,true) : PropertyDefaults.const_1963);
         _loc1_.push(this.var_1425 != PropertyDefaults.const_1408 ? new PropertyStruct(PropertyDefaults.const_1001,this.var_1425,PropertyStruct.const_39,true) : PropertyDefaults.const_1792);
         _loc1_.push(_field.selectable != PropertyDefaults.const_1306 ? new PropertyStruct(PropertyDefaults.const_948,_field.selectable,PropertyStruct.const_39,true) : PropertyDefaults.const_1959);
         _loc1_.push(_field.displayAsPassword != PropertyDefaults.const_1252 ? new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_39,true) : PropertyDefaults.const_1899);
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case PropertyDefaults.const_884:
                  ...
                  break;
               case PropertyDefaults.const_1235:
