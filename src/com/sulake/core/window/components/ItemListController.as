package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow, IInputProcessorRoot
   {
      ...
      protected var var_2270:Boolean = false;
      ...
      {
         this._spacing = PropertyDefaults.const_591;
         this.var_943 = PropertyDefaults.const_1014;
         this.var_435 = PropertyDefaults.const_889;
         this.var_1154 = PropertyDefaults.const_744;
         this.var_762 = 0;
         this.var_760 = 0;
         this.var_126 = 0;
         this.var_108 = 0;
         ...
         var_192 = var_512 || !testParamFlag(WindowParam.const_32);
         this._container = _context.create("_CONTAINER","",WindowType.const_445,WindowStyle.const_104,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[TAG_INTERNAL,TAG_EXCLUDE]) as IWindowContainer;
         this._container.addEventListener(WindowEvent.const_41,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_412,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_153,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_208,this.containerEventHandler);
         this._container.clipping = clipping;
         this.resizeOnItemUpdate = this.var_1154;
      }
      ...
      {
         return new Rectangle(this.var_762 * this.maxScrollH,this.var_760 * this.maxScrollV,width,height);
      }
      ...
      public function set scrollH(param1:Number) : void
      {
         ...
         {
            this.var_762 = param1;
            this._container.x = -this.var_762 * this.maxScrollH;
      ...
      public function set scrollV(param1:Number) : void
      {
         ...
         {
            this.var_760 = param1;
            this._container.y = -this.var_760 * this.maxScrollV;
            _loc2_ = WindowEvent.allocate(WindowEvent.const_523,this,null);
            _events.dispatchEvent(_loc2_);
            _loc2_.recycle();
         }
      ...
      override public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            this._container.removeEventListener(WindowEvent.const_412,this.containerEventHandler);
            this._container.removeEventListener(WindowEvent.const_153,this.containerEventHandler);
      ...
      public function process(param1:WindowEvent) : Boolean
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_181:
               if(this.var_1424)
               {
                  this.var_1423 = this.var_2271 - _loc3_;
                  this.var_1422 = this.var_2269 - _loc4_;
                  if(this._horizontal)
                  {
                     if(this.var_1423 != 0 && this.var_126 != 0)
                     {
                        this.scrollH += this.var_1423 / this.var_126;
                     }
                  }
                  else if(this.var_1422 != 0 && this.var_108 != 0)
                  {
                     this.scrollV += this.var_1422 / this.var_108;
                  }
                  this.var_2271 = _loc3_;
                  this.var_2269 = _loc4_;
                  _loc2_ = true;
            ...
            case WindowMouseEvent.const_303:
               if(this.var_1424)
               {
                  ...
                  {
                     _context.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,0,-this.var_1422);
                  }
                  this.var_1424 = false;
                  _loc2_ = true;
               }
      ...
      protected function updateScrollAreaRegion() : void
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         if(this.var_943 && !this.var_612 && this._container)
         {
            this.var_612 = true;
      ...
      override public function get properties() : Array
      {
         ...
         if(this._spacing != PropertyDefaults.const_591)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_414,this._spacing,PropertyStruct.const_36,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1195);
         }
         if(this.var_943 != PropertyDefaults.const_1014)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_763,this.var_943,PropertyStruct.const_39,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1873);
         }
         if(this.var_435 != PropertyDefaults.const_889)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_867,this.var_435,PropertyStruct.const_39,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1868);
         }
         if(this.var_1154 != PropertyDefaults.const_744)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_833,this.var_1154,PropertyStruct.const_39,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1754);
         }
         if(this.var_759 != PropertyDefaults.const_1268)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_972,this.var_759,PropertyStruct.const_128,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1928);
         }
         if(this.var_761 != PropertyDefaults.const_1231)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_799,this.var_761,PropertyStruct.const_128,true));
         }
         else
         {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_414:
                  ...
                  break;
               case PropertyDefaults.const_867:
