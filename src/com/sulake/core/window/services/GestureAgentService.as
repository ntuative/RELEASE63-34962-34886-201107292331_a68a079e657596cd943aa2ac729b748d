package com.sulake.core.window.services
{
   ...
   public class GestureAgentService implements IGestureAgentService, IDisposable
   {
      ...
      protected var var_1586:uint = 0;
      
      protected var var_319:Function;
      
      protected var var_1431:int;
      
      protected var var_1430:int;
      ...
      protected function operate(param1:TimerEvent) : void
      {
         this.var_1431 *= 0.75;
         this.var_1430 *= 0.75;
         if(Math.abs(this.var_1431) <= 1 && Math.abs(this.var_1430) <= 1)
         {
            this.end(this._window);
         }
         else if(this.var_319 != null)
         {
            this.var_319(this.var_1431,this.var_1430);
         }
      }
