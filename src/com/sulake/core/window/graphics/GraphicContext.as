package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_1994:uint = 0;
      
      public static const const_987:uint = 1;
      
      public static const const_1275:uint = 2;
      
      public static const const_801:uint = 4;
      
      public static const const_2048:uint = 8;
      
      public static const const_1779:uint = 16;
      
      public static const const_2294:uint = 64;
      
      public static const const_2197:uint = 128;
      
      public static const const_1232:uint = 256;
      
      protected static var var_617:uint = 0;
      
      protected static var var_368:uint = 0;
         ...
         if(this.var_942)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap != null)
               {
                  ...
                  {
                     var_368 -= bitmap.width * bitmap.height * 4;
                     bitmap.dispose();
                     bitmap = null;
                  }
               }
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new TrackedBitmapData(this,width,height,this.var_2268,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new TrackedBitmapData(this,1,1,var_2268,16777215);
                  }
                  var_368 += bitmap.width * bitmap.height * 4;
               }
      ...
      protected function releaseDrawBuffer() : void
      {
         ...
         if(this.var_942)
         {
            ...
            if(_loc1_ is Bitmap)
            {
               ...
               if(_loc2_ != null)
               {
                  var_368 -= _loc2_.width * _loc2_.height * 4;
                  _loc2_.dispose();
               }
            }
         }
