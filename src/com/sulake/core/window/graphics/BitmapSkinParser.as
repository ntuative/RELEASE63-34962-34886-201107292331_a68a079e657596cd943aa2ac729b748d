   ...
   public class BitmapSkinParser
   {
      ...
      protected static function parseLayoutEntity(param1:XML, param2:Map) : SkinLayoutEntity
      {
         ...
         if(_loc8_.length() > 0)
         {
            ...
            {
               case "fixed":
                  _loc5_.var_361 = SkinLayoutEntity.const_498;
                  break;
               case "move":
                  _loc5_.var_361 = SkinLayoutEntity.const_329;
                  break;
               case "strech":
                  _loc5_.var_361 = SkinLayoutEntity.const_618;
                  break;
               case "tiled":
                  _loc5_.var_361 = SkinLayoutEntity.const_370;
                  break;
               case "center":
                  _loc5_.var_361 = SkinLayoutEntity.const_578;
            }
            ...
            {
               case "fixed":
                  _loc5_.var_360 = SkinLayoutEntity.const_498;
                  break;
               case "move":
                  _loc5_.var_360 = SkinLayoutEntity.const_329;
                  break;
               case "strech":
                  _loc5_.var_360 = SkinLayoutEntity.const_618;
                  break;
               case "tiled":
                  _loc5_.var_360 = SkinLayoutEntity.const_370;
                  break;
               case "center":
                  _loc5_.var_360 = SkinLayoutEntity.const_578;
            }
         }
