package com.sulake.core.assets
{
   ...
   public class BitmapDataAsset implements ILazyAsset
   {
      ...
      protected static var var_546:uint = 0;
       
      
      private var _disposed:Boolean = false;
      
      private var var_123:Object;
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._bitmap)
            {
               try
               {
                  var_546 -= this._bitmap.width * this._bitmap.height * 4;
      ...
      public function prepareLazyContent() : void
      {
         ...
         if(this.var_123 is Class)
         {
            _loc1_ = new this.var_123() as Bitmap;
            if(_loc1_ != null)
            {
            ...
            this._bitmap = new this.var_123() as BitmapData;
            if(this._bitmap != null)
            {
               this.var_123 = null;
               return;
         ...
         if(this.var_123 is Bitmap)
         {
            this._bitmap = Bitmap(this.var_123).bitmapData;
            if(this._bitmap == null)
            {
         ...
         if(this.var_123 is BitmapData)
         {
            this._bitmap = this.var_123 as BitmapData;
            if(this._bitmap != null)
            {
               this.var_123 = null;
               return;
         ...
         if(this.var_123 is BitmapDataAsset)
         {
            this._bitmap = BitmapDataAsset(this.var_123)._bitmap;
            this._offset = BitmapDataAsset(this.var_123)._offset;
            this.var_1613 = BitmapDataAsset(this.var_123).var_1613;
            this.var_1614 = BitmapDataAsset(this.var_123).var_1614;
            if(this._bitmap != null)
            {
               this.var_123 = null;
               return;
         ...
         while(_loc2_ < param1.length())
         {
            ...
            switch(_loc3_)
            {
               case "offset":
                  ...
                  break;
               case "flipH":
                  this.var_1613 = _loc4_ == "1" || _loc4_ == "true";
                  break;
               case "flipV":
                  this.var_1614 = _loc4_ == "1" || _loc4_ == "true";
                  break;
            }
            _loc2_++;
         }
