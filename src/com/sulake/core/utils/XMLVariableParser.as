package com.sulake.core.utils
{
   ...
   public class XMLVariableParser
   {
      ...
      public static const const_1803:String = "float";
      
      public static const const_39:String = "Boolean";
      
      public static const const_1906:String = "bool";
      ...
      private static const const_720:String = "value";
      
      private static const const_712:String = "true";
      
      private static const const_2111:String = "com.sulake.habbo.communication.messages.incoming.inventory.furni";
      ...
      private static function parseVariableToken(param1:XML, param2:Map, param3:Array = null) : void
      {
         ...
         _loc7_ = param1.attribute(const_720);
         if(_loc7_.length() > 0)
         {
            _loc6_ = String(param1.attribute(const_720));
         }
         if(_loc6_ != null)
         {
         ...
         {
            _loc8_ = param1.child(const_720)[0];
            if(_loc8_ != null)
            {
            ...
            else if(_loc5_ == const_305 || _loc5_ == const_176)
            {
      ...
      public static function castStringToType(param1:String, param2:String) : Object
      {
         switch(param2)
         {
            ...
            case const_172:
               return uint(param1);
            case const_176:
               return param1.split(const_1641);
            default:
