package com.sulake.core.runtime
{
   ...
   public final class CoreComponentContext extends ComponentContext implements ICore
   {
      ...
      private static const const_1591:String = "asset-libraries";
      
      private static const const_1592:String = "library";
      
      private static const const_1589:String = "service-libraries";
      
      private static const const_1588:String = "library";
      
      private static const const_1586:String = "component-libraries";
      
      private static const const_1590:String = "library";
      
      private static const const_1585:String = "error_data";
      
      private static const const_1587:String = "error_cat";
      
      private static const const_1593:String = "error_desc";
       
      
      private var var_401:LibraryLoaderQueue;
      
      private var var_843:IEventDispatcher;
      
      private var var_570:uint;
      
      private var var_400:Function;
      
      private var var_225:Profiler;
      ...
      public function CoreComponentContext(param1:DisplayObjectContainer, param2:uint)
      {
         ...
         switch(param2 & 0)
         {
            case Core.const_1256:
               ...
               this.var_400 = this.simpleFrameUpdateHandler;
               break;
            case Core.const_976:
               debug("Core; using complex frame update handler");
               this.var_400 = this.complexFrameUpdateHandler;
               break;
            case Core.const_915:
               debug("Core; using profiler frame update handler");
               this.var_400 = this.profilerFrameUpdateHandler;
               this.var_225 = new Profiler(this);
               attachComponent(this.var_225,[new IIDProfiler()]);
               var_433.addChild(new ProfilerViewer(this.var_225));
               break;
            case Core.const_516:
               debug("Core; using experimental frame update handler");
               this.var_400 = this.experimentalFrameUpdateHandler;
               break;
            case Core.CORE_SETUP_DEBUG:
               debug("Core; using debug frame update handler");
               this.var_400 = this.debugFrameUpdateHandler;
         }
      }
      ...
      {
         return this.var_570 - this.getNumberOfFilesPending();
      }
      ...
      override public function dispose() : void
      {
         ...
         if(!disposed)
         {
            ...
            try
            {
               ...
               {
                  receivers = this.var_290[i] as Array;
      ...
      override public function error(param1:String, param2:Boolean, param3:int = -1, param4:Error = null) : void
      {
         if(param4)
         {
            ErrorReportStorage.setParameter(const_1585,String(param4.getStackTrace()));
         }
         ErrorReportStorage.setParameter(const_1587,String(param3));
         ErrorReportStorage.setParameter(const_1593,param1);
      ...
      public function readConfigDocument(param1:XML, param2:IEventDispatcher = null) : void
      {
         ...
         this.var_843 = loadingEventDelegate;
         if(this.var_401 == null)
         {
         ...
         try
         {
            node = config.child(const_1591)[0];
            if(node != null)
            {
               list = node.child(const_1592);
         ...
         {
            error("Failed to parse asset libraries from config xml!",true,Core.const_223,e);
         }
         try
         {
         ...
         {
            error("Failed to parse interfaces from config xml!",true,Core.const_223,e);
         }
         try
         {
         ...
         {
            error("Failed to parse components from config xml!",true,Core.const_223,e);
         }
         if(!disposed)
         {
      ...
      private function errorInLoadingProcess(param1:LibraryLoaderEvent = null) : void
      {
         ...
         this.error("Failed to download library \"" + _loc2_.url + "\" HTTP status " + param1.status + ": " + _loc2_.getLastErrorMessage(),true,Core.const_1255);
         if(!disposed)
         {
      ...
      private function finalizeLoadingEventDelegate() : void
      {
         if(this.var_843)
         {
            this.var_843.dispatchEvent(new Event(Event.COMPLETE));
         }
      }
      ...
      private function updateLoadingProgress(param1:LibraryLoaderEvent = null) : void
      {
         ...
         if(this.var_843)
         {
            ...
            this.var_843.dispatchEvent(new LibraryProgressEvent(_loc2_.url,param1.bytesLoaded,param1.bytesTotal,_loc2_.elapsedTime));
         }
      }
         ...
         if(param1 != null)
         {
            if(param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE || param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_ERROR)
            {
               ...
               if(!disposed)
               {
                  if(this.var_843)
                  {
                     this.var_843.dispatchEvent(new LibraryProgressEvent(_loc2_.url,this.var_570 - this.var_401.length,this.var_570,_loc2_.elapsedTime));
                  }
               }
            }
         }
      ...
      override public function registerUpdateReceiver(param1:IUpdateReceiver, param2:uint) : void
      {
         ...
         var _loc3_:int = !!this.var_225 ? 0 : this.var_1586 & 0;
         if(_loc3_ == Core.const_516)
         {
            this.var_290[param2].push(new UpdateDelegate(param1,this,param2));
         }
         else
         {
            this.var_290[param2].push(param1);
         }
      }
      ...
      override public function removeUpdateReceiver(param1:IUpdateReceiver) : void
      {
         ...
         var _loc4_:int = !!this.var_225 ? 0 : this.var_1586 & 0;
         var _loc5_:int = 0;
         while(_loc5_ < CoreComponentContext.const_107)
         {
            _loc3_ = this.var_290[_loc5_] as Array;
      ...
      private function onEnterFrame(param1:Event) : void
      {
         ...
         this.var_400(_loc2_,_loc2_ - this._lastUpdateTimeMs);
      ...
      private function simpleFrameUpdateHandler(param1:uint, param2:uint) : void
      {
         ...
         {
            this.var_693[priority] = 0;
            receivers = this.var_290[priority];
            index = 0;
            length = receivers.length;
            while(index != length)
            {
      ...
      private function complexFrameUpdateHandler(param1:uint, param2:uint) : void
      {
         ...
         while(priority < CoreComponentContext.const_107)
         {
            ...
            {
               if(this.var_693[priority] < priority)
               {
                  ++this.var_693[priority];
                  skip = true;
               }
            }
            if(!skip)
         ...
         while(priority < CoreComponentContext.const_107)
         {
            ...
            while(index != length)
            {
               ...
               else
               {
                  try
                  {
                     this.var_225.update(receiver,msSinceLastUpdate);
                  }
                  catch(e:Error)
                  {
                     error("Error in update receiver \"" + getQualifiedClassName(receiver) + "\": " + e.message,true,e.errorID,e);
      ...
      public function setProfilerMode(param1:Boolean) : void
      {
         ...
         else
         {
            if(this.var_225)
            {
               detachComponent(this.var_225);
               this.var_225.dispose();
               this.var_225 = null;
            }
            switch(this.var_1586 & 0)
            {
               case Core.const_1256:
                  this.var_400 = this.simpleFrameUpdateHandler;
                  break;
