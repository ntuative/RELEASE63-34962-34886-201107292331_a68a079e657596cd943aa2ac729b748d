package com.sulake.core.localization
{
   ...
   public class CoreLocalizationManager extends Component implements ICoreLocalizationManager
   {
      ...
      {
         return this.getLocalizationDefinition(this.var_2985);
      }
      ...
      protected function onLocalizationFailed(param1:AssetLoaderEvent) : void
      {
         ...
         Core.error("Failed to download localization",true,Core.const_2010);
      }
      ...
      public function updateKey(param1:String, param2:String) : void
      {
         ...
         {
            _loc3_.registerParameter("predefined",this.var_2175);
         }
      }
      ...
      public function printNonExistingKeys() : void
      {
         var _loc2_:* = null;
         var _loc1_:String = "";
         for each(_loc2_ in this.var_1388)
         {
            _loc1_ += _loc2_ + "\n";
         }
         Logger.log(_loc1_);
      ...
      protected function setPredefinedUrl(param1:String) : void
      {
         ...
         for each(_loc2_ in this.var_73)
         {
            ...
            {
               _loc2_.registerParameter("predefined",this.var_2175);
            }
         }
      }
   }
