package com.sulake.core.communication.connection
{
   ...
   public class SocketConnection extends EventDispatcher implements IConnection, IDisposable
   {
      ...
      public static const const_1755:int = 10000;
      ...
      private var var_1222:IEncryption;
      
      private var var_802:IProtocol;
      
      private var _id:String;
      
      private var var_1221:IMessageClassManager;
      
      private var var_283:ICoreCommunicationManager;
      
      private var var_540:IConnectionStateListener;
      ...
      public function SocketConnection(param1:String, param2:ICoreCommunicationManager, param3:IConnectionStateListener)
      {
         ...
         this.var_1221 = new MessageClassManager();
         this.var_83 = new Socket();
         this.var_217 = new Timer(const_1755,1);
         this.var_217.addEventListener(TimerEvent.TIMER,this.onTimeOutTimer);
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_217.stop();
            this.var_217.removeEventListener(TimerEvent.TIMER,this.onTimeOutTimer);
         }
         this.var_217 = null;
         this.var_539 = null;
         this.var_540 = null;
      ...
      public function init(param1:String, param2:uint = 0) : Boolean
      {
         ...
         if(this.var_540)
         {
            this.var_540.connectionInit(param1,param2);
         }
         Security.loadPolicyFile("xmlsocket://" + param1 + ":" + param2);
         this.var_217.start();
         this.var_803 = getTimer();
      ...
      public function removeMessageEvent(param1:IMessageEvent) : void
      {
         ...
         this.var_283.removeConnectionMessageEvent(this._id,param1);
      }
      ...
      public function send(param1:IMessageComposer, param2:int = -1) : Boolean
      {
         ...
         var _loc4_:int = this.var_1221.getMessageComposerID(param1);
         if(_loc4_ < 0)
         {
         ...
         var _loc6_:ByteArray = this.var_802.encoder.encode(_loc4_,_loc5_,param2);
         if(this.var_540)
         {
            this.var_540.messageSent(String(_loc4_),_loc6_.toString());
         }
         if(this.var_1222 != null)
         {
            _loc3_ = this.var_1222.encipher(_loc6_);
         }
         else
         {
            _loc3_ = _loc6_;
      ...
      {
         this.var_1221.registerMessages(param1);
      }
      ...
      override public function toString() : String
      {
         ...
         _loc1_ += "Protocol Encoder: " + this.var_802.encoder + "\n";
         _loc1_ += "Protocol Decoder: " + this.var_802.decoder + "\n";
         return _loc1_ + ("Encryption: " + this.var_1222 + "\n");
      }
      ...
      public function processReceivedData() : void
      {
         ...
         var offset:uint = this.var_802.getMessages(this.var_539,receivedMessages);
         try
         {
            for each(message in receivedMessages)
            {
               ...
               if(this.var_540)
               {
                  this.var_540.messageReceived(String(id),data.toString());
               }
               eventClasses = this.var_1221.getMessageEventClasses(id);
               events = new Array();
      ...
      private function onRead(param1:ProgressEvent) : void
      {
         ...
         {
            this.var_539.writeByte(this.var_83.readUnsignedByte());
         }
      }
      ...
      private function onConnect(param1:Event) : void
      {
         ...
         this.var_217.stop();
         this.var_1851 = true;
         ErrorReportStorage.addDebugData("ConnectionTimer","Connected in " + (getTimer() - this.var_803));
      ...
      private function onClose(param1:Event) : void
      {
         ...
         this.var_1851 = false;
         ErrorReportStorage.addDebugData("ConnectionTimer","Closed in " + (getTimer() - this.var_803));
         dispatchEvent(param1);
      }
      ...
      private function onComplete(param1:Event) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","Completed in " + (getTimer() - this.var_803));
         dispatchEvent(param1);
      }
      ...
      private function onSecurityError(param1:SecurityErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","SecurityError in " + (getTimer() - this.var_803));
         dispatchEvent(param1);
      }
      ...
      private function onIOError(param1:IOErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","IOError in " + (getTimer() - this.var_803));
         switch(param1.type)
         {
      ...
      private function onTimeOutTimer(param1:TimerEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","TimeOut in " + (getTimer() - this.var_803));
         var _loc2_:IOErrorEvent = new IOErrorEvent(IOErrorEvent.IO_ERROR);
         _loc2_.text = "Socket Timeout (" + this.var_217.delay + " ms). Possible Firewall.";
